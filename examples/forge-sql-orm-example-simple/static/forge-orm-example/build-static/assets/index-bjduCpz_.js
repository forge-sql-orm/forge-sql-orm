...
import { g as Qt, a as kv, r as Xt, b as Pt, s as Ke } from "./client-core-vendor-DRqApKWs.js";
import { r as eb } from "./lodash-vendor-ChTj_7HQ.js";
function tb(e, t) {
...
function tp() {
  if (Pu) return Pn;
  ((Pu = 1), Object.defineProperty(Pn, "__esModule", { value: !0 }), (Pn.events = void 0));
  const e = de(),
    t = xb(),
    r = (0, e.getCallBridge)(),
    n = async (o, i) => {
  ...
  return ((Pn.events = { emit: n, on: a }), Pn);
}
var Cu;
function Rb() {
  if (Cu) return Rn;
  ((Cu = 1), Object.defineProperty(Rn, "__esModule", { value: !0 }), (Rn.emitReadyEvent = void 0));
  const e = tp(),
    t = op(),
    r = de(),
    n = me(),
...
function Db() {
  if (Uu) return Dn;
  ((Uu = 1), Object.defineProperty(Dn, "__esModule", { value: !0 }), (Dn.default = void 0));
  var e = r(ap()),
    t = r(jb());
  function r(o) {
...
function Mb() {
  if (Bu) return Ln;
  ((Bu = 1), Object.defineProperty(Ln, "__esModule", { value: !0 }), (Ln.default = void 0));
  var t = {
...
function Nb() {
  if (Vu) return Bn;
  ((Vu = 1), Object.defineProperty(Bn, "__esModule", { value: !0 }), (Bn.default = void 0));
...
function qb() {
  ...
  ((Wu = 1),
    ...
    (Cn.createAdfRendererIframeProps = void 0));
  const e = Bb(),
    t = async (r, n) => {
      const a = await ke(
  ...
  return ((Cn.createAdfRendererIframeProps = t), Cn);
}
var Ku;
function op() {
  if (Ku) return gn;
  ...
  return he(e, [
    {
      ...
      value: function (r) {
        return (
          ...
          Re(r) === "object" && (this.payload = Zi(Zi({}, this.payload), r)),
          this
        );
      },
    },
      ...
      he(t, [
        {
          key: "update",
          value: function (n) {
            return this.hasFired ? this : U_(t, "update", this, 3)([n]);
          },
        },
      ])
    );
      ...
      return (
        ...
        E.createElement(
          "span",
          {
            ...
            className: P([oo.wrapperStyles, oo.rotateStyles]),
          },
          E.createElement(
            "svg",
            {
...
var Rp = y.createContext(!1),
  ...
  hy = { medium: "_11c82smr", UNSAFE_small: "_11c8dcr7", large: "_11c81ixg", small: "_11c81o8v" },
  gy = { bold: "_k48pmoej", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  by = {
                ...
                (function (O, x, A) {
                  var I,
                    ...
                    J = {
                      ...
                      f: H.bind(n, 4),
                      d: function (B, q) {
                        return ((I = B), (R = 0), (j = n), (J.n = q), u);
                      },
                    };
                  function H(W, B) {
                    for (R = W, j = B, a = 0; !N && U && !q && a < z.length; a++) {
                      var q,
                        V = z[a],
                        ae = J.p,
                        ie = V[2];
                  ...
                  return function (W, B, q) {
                    if (U > 1) throw TypeError("Generator is already running");
                    for (N && B === 1 && H(B, q), R = B, j = q; (a = R < 2 ? n : j) || !N; ) {
    ...
    return he(e, [
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return o == null
            ? null
            : De(De({}, r), {}, { value: o, details: De(De({}, r.details), {}, { reason: ps }) });
        },
      },
      {
          ...
          return o == null
            ...
            : De(
                ...
                {},
                {
                  ...
                  details: De(De({}, r.details), {}, { reason: ps }),
                },
              );
        },
      },
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new Cd(r, {}, "", { time: Date.now(), reason: gc.Error })
            );
          }
        },
      },
...
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = K;
    ...
    var Ud =
      ((uo = Bs) === null || uo === void 0 || (hs = uo.getPackageVersion) === null || hs === void 0
        ? void 0
...
var Fr,
  ...
  Up = typeof process < "u" && typeof bc < "u",
  C0 = Up ? bc.ENABLE_PLATFORM_FF === "true" : !1,
  A0 = Up ? bc.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  I0 = C0 || A0,
...
var M0 = ["light", "dark", "auto"],
  ...
  ti = "data-color-mode",
  Bp = "data-contrast-mode",
  ri = "data-custom-theme",
  U0 = ["light", "dark", "spacing", "typography", "shape"],
...
var $0 = function (t) {
  ...
  _c = function () {
    ...
    var t = document.documentElement,
      r = t.getAttribute(ti) || "",
      n = t.getAttribute(kr) || "";
    return qd(qd({}, B0(n)), $0(r) && { colorMode: r });
  },
  Vp = function (t) {
...
function ew(e) {
  var t = document.documentElement;
  t.setAttribute(Bp, e.matches ? "more" : "no-preference");
}
var Ur = Q0 && window.matchMedia(J0),
  tw = (function () {
    function e() {
      ...
      },
      {
        ...
        value: function () {
          Ur &&
            ...
            (this.unbindContrastChangeListener = wr.bind(Ur, { type: "change", listener: ew }));
        },
      },
      {
        key: "unbind",
...
function nP(e) {
  var t = Se(Array.from(document.head.querySelectorAll("style[".concat(ri, "][").concat(kr, "]"))));
  t.length < e ||
          ...
          function (B) {
            for (;;)
              switch ((B.prev = B.next)) {
                                  ...
                                  switch ((ce.prev = ce.next)) {
                                    case 0:
                                      return (
                                        (ce.next = 2),
                                        ke(
                                          () => import("./custom-theme-CySWIEwB.js"),
                ...
                case 11:
                  ((j = ow()), (U = iw(j)), (B.prev = 13), U.s());
                case 15:
                  if ((z = U.n()).done) {
                    B.next = 21;
                    break;
                  }
                  return ((N = z.value), (B.next = 19), x(N));
                case 19:
                  B.next = 15;
                  break;
                case 21:
                ...
                case 29:
                  return ((J = rw(w)), B.abrupt("return", J));
                case 31:
                case "end":
                  return B.stop();
              }
                  ...
                  for (;;)
                    switch ((N.prev = N.next)) {
                      case 0:
                        return ((N.next = 2), A());
                      case 2:
                        ((U = cw(bt(bt({}, f), {}, { colorMode: d }))), (m.current = U));
                      case 4:
                      case "end":
                        return N.stop();
                    }
        ...
        E.createElement(
          ...
          E.createElement(
            ...
            le("platform_dst_subtree_theming")
              ? E.createElement("div", ne({}, x, { className: P([mw.body]) }), t)
              : t,
          ),
        ),
      ),
...
function Hw() {
  return ((_e = Le > 0 ? Oe(tn, --Le) : 0), Kr--, _e === 10 && ((Kr = 1), ai--), _e);
}
function ze() {
  return ((_e = Le < oh ? Oe(tn, Le++) : 0), Kr++, _e === 10 && ((Kr = 1), ai++), _e);
}
function Ot() {
  return Oe(tn, Le);
}
...
function Qd(e, t, r, n, a, o, i, s, c, u, l) {
  for (var d = a - 1, p = a === 0 ? o : [""], v = Oc(p), g = 0, f = 0, h = 0; g < n; ++g)
    for (var b = 0, _ = Fa(e, d + 1, (d = Bw((f = i[g])))), m = e; b < v; ++b)
...
function ch(e, t) {
  switch ($w(e, t)) {
    ...
    case 4968:
      return (
        te(
          te(e, /(.+:)(flex-)?(.*)/, ee + "box-pack:$3" + Ee + "flex-pack:$3"),
          /s.+-b[^;]+/,
          "justify",
        ) +
        ee +
          ...
          case 102:
            return (
              te(
                e,
                /(.+:)(.+)-([^]+)/,
                "$1" + ee + "$2-$3$1" + Fo + (Oe(e, t + 3) == 108 ? "$3" : "$2-$3"),
              ) + e
            );
          case 115:
    ...
    case 6444:
      switch (Oe(e, mt(e) - 3 - (~$s(e, "!important") && 10))) {
        case 107:
          return te(e, ":", ":" + ee) + e;
        case 101:
          return (
...
var P1 = function (t) {
  ...
  C1 = ph(function (e, t) {
    ...
    return y.createElement(
      y.Fragment,
      null,
      y.createElement(P1, { cache: t, serializedArr: r }),
      i,
    );
  });
function A1(e, t) {
...
var Jt = 8,
  ...
  U1 = { compact: "0 ".concat(Jt / 4, "px"), default: "0 ".concat(Jt / 4, "px"), none: "0" },
...
var Q1 = {
  ...
  ok = E.forwardRef(function (t, r) {
    ...
    var ie = y.useContext(pc),
      ce = y.useCallback(
        function (ve, Ue) {
          (ie && ie.tracePress(h, ve.timeStamp), x(ve, Ue));
        },
        [x, ie, h],
      ),
      we = Da({
...
function ck(e) {
  return E.createElement(Pc, ne({}, e, { appearance: "subtle" }));
}
...
var wa = { none: 0, small: 100, medium: 350, large: 700 },
  ws = 0.5,
  Uk = { none: wa.none, small: wa.small * ws, medium: wa.medium * ws, large: wa.large * ws },
  Bk = function () {
...
var tO = function (t) {
  ...
  xh = [].concat(Wa, [Cc]).reduce(function (e, t) {
...
function ii(e) {
  return Ct(e) === "html" ? e : e.assignedSlot || e.parentNode || (Ac(e) ? e.host : null) || er(e);
}
function Pf(e) {
...
function yO(e) {
  ...
  var a = ii(e);
  for (Ac(a) && (a = a.host); tt(a) && ["html", "body"].indexOf(Ct(a)) < 0; ) {
    var o = zt(a);
    if (
      o.transform !== "none" ||
      o.perspective !== "none" ||
...
function Ka(e) {
  for (var t = Ve(e), r = Pf(e); r && mO(r) && zt(r).position === "static"; ) r = Pf(r);
...
const CO = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: PO, data: {} };
var po = { passive: !0 };
function AO(e) {
  var t = e.state,
    r = e.instance,
...
function UO(e, t) {
  ...
  var v = p.reduce(function (g, f) {
    return ((g[f] = Ba(e, { placement: f, boundary: a, rootBoundary: o, padding: i })[Et(f)]), g);
  }, {});
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      ...
      var j = k[R],
        ...
        N = [Te, rt].indexOf(U) >= 0,
        J = N ? "width" : "height",
        H = Ba(t, { placement: j, boundary: l, rootBoundary: d, altBoundary: p, padding: u }),
        W = N ? (z ? nt : Fe) : z ? rt : Te;
      w[J] > O[J] && (W = Eo(W));
      var B = Eo(W),
        q = [];
...
function XO(e) {
  var t = e.state,
    ...
    g = r.tetherOffset,
    f = g === void 0 ? 0 : g,
    h = Ba(t, { boundary: c, rootBoundary: u, padding: d, altBoundary: l }),
    b = Et(t.placement),
    _ = Zr(t.placement),
    m = !_,
    k = jc(b),
  ...
  if (O) {
    if (o) {
      var z,
        ...
        on = Ue ? (k === "y" ? Ue.clientTop || 0 : Ue.clientLeft || 0) : 0,
        Rr = (z = j?.[k]) != null ? z : 0,
        vt = W + Ce - Rr - on,
        Ae = W + ve - Rr,
        pt = xa(v ? Lo(B, vt) : B, W, v ? fr(q, Ae) : q);
      ((O[k] = pt), (U[k] = pt - W));
    }
    if (s) {
      var Gt,
        ...
        rr = (Gt = j?.[w]) != null ? Gt : 0,
        eo = gt ? Pe : Be - x[Ie] - A[Ie] - rr + R.altAxis,
        to = gt ? Be + x[Ie] + A[Ie] - rr - R.altAxis : je,
        ro = v && gt ? wO(eo, Be, to) : xa(v ? eo : Pe, Be, v ? to : je);
      ((O[w] = ro), (U[w] = ro - Be));
    }
    t.modifiersData[n] = U;
  }
...
var cE = [IO, JO, CO, _O, WO, $O, ZO, SO, VO],
...
var Bh = typeof window < "u" ? y.useLayoutEffect : y.useEffect;
function AE(e) {
  var t = e.zIndex,
    r = e.children,
    n = y.useState(null),
...
var IE = function (t) {
    var r = y.useState(!1),
      ...
      i = y.useState(function () {
        return t === "layoutEffect" ? Bh : y.useEffect;
      }),
      s = G(i, 1),
      c = s[0];
    return (
...
function BE(e) {
  ...
  function d() {
    ...
    ((t = "waiting-to-show"), Bf(f, e.delay));
  }
  d();
  var p = {
    keep: i,
...
var qf = {
  ...
  $E = function (t) {
    ...
    return y.createElement(
      "div",
      { className: P([qf.shortcutSegmentsContainer]) },
      r.map(function (n, a) {
        return y.createElement(
          "kbd",
          { key: "".concat(n, "-").concat(a), className: P([qf.shortcutSegment]) },
          n,
        );
      }),
    );
  ...
  $h = y.forwardRef(function (t, r) {
    ...
    return y.createElement(
      qh,
      {
        ref: r,
        style: n,
        className: P([$f.base, i && $f.truncate, a]),
        placement: s,
        testId: c,
        id: d,
        onMouseOut: u,
...
var VE = Aw.tooltip(),
  Gf = { componentName: "tooltip", packageName: "@atlaskit/tooltip", packageVersion: "20.13.0" },
...
function WE(e) {
  var t = e.children,
    ...
    Ue = y.useRef(null),
    on = function (oe) {
      ((Ue.current = oe), (ve.current = oe ? oe.firstElementChild : null));
    },
...
var KE = function (t) {
  ...
  Hf = { headCellContainer: "_1e0c1txw _4cvr1h6o", text: "_11c81o8v _syazazsu _k48pmoej" },
  zh = function (t) {
    var r = t.content,
      n = t.inlineStyles,
      a = t.testId;
    ...
    var o = t.innerRef,
      ...
      q = E.createElement(
        ei,
        { xcss: Hf.headCellContainer, onMouseEnter: W, onMouseLeave: B, onFocus: J, onBlur: H },
        E.createElement(
          WE,
          { content: s === pr ? p : g },
          E.createElement(
            ...
            E.createElement(
              ...
              E.createElement("span", { className: P([Hf.text]) }, r),
            ),
            N &&
              E.createElement(
                To,
...
var iS = function (t) {
    ...
    var fe = function (Pe) {
        return function () {
          ...
          if (je) {
            ...
            var gt = je !== i ? pr : oS(s);
            ye && ye({ key: je, item: Pe, sortOrder: gt });
          }
        };
      },
      Ce = function (Pe, je) {
      ...
      on = function () {
        return B || (dp(o || [], A, _).length > 2 ? Mo : K_);
      },
      Rr = function () {
    ...
    return E.createElement(
      ...
      !ot &&
        Be &&
        E.createElement(kp, { isLoading: g, spinnerSize: Mo, testId: l, loadingLabel: c }, Be),
    );
  },
  sS = y.lazy(function () {
    return ke(
      () => import("./body-CxR4C0tH.js"),
...
var Uo = { structural: kS, default: OS };
function _r(e, t, r) {
  return Pg(e)
    ? e
    : Array.isArray(e)
...
function Xa(e, t) {
  return { annotationType_: e, options_: t, make_: PS, extend_: CS, decorate_20223_: AS };
}
function PS(e, t, r, n) {
  var a;
...
function ag(e, t, r, n, a) {
  var o, i, s, c, u, l, d;
  (a === void 0 && (a = C.safeDescriptors), IS(e, t, r, n));
  var p = n.value;
...
function ig(e, t, r, n, a, o) {
  (o === void 0 && (o = C.safeDescriptors), TS(e, t, r, n));
  var i = n.value;
  if ((za(i) || (i = en(i)), a)) {
    var s;
...
function vi(e, t) {
  return { annotationType_: e, options_: t, make_: BS, extend_: qS, decorate_20223_: $S };
}
function BS(e, t, r) {
  return this.extend_(e, t, r, !1) === null ? 0 : 1;
}
...
var ax = {
    ...
    array: function (t, r) {
      var n = go(r);
      return (C.useProxies === !1 || n.proxy === !1 ? rR : Hx)(t, bo(n), n.name);
    },
    map: function (t, r) {
      var n = go(r);
    ...
    object: function (t, r, n) {
      return xr(function () {
        return Fx(C.useProxies === !1 || n?.proxy === !1 ? an({}, n) : zx({}, n), t, r);
      });
    },
    ref: xt(QS),
    shallow: xt(ex),
  ...
  dt = (function () {
    function e(r) {
      ((this.dependenciesState_ = Z.NOT_TRACKING_),
        ...
        (this.equals_ = r.equals || (r.compareStructural || r.struct ? Uo.structural : Uo.default)),
...
function rc(e) {
  switch (e.dependenciesState_) {
    ...
    case Z.POSSIBLY_STALE_: {
      for (var t = Uc(!0), r = Er(), n = e.observing_, a = n.length, o = 0; o < a; o++) {
        var i = n[o];
        if (bi(i)) {
...
function fg(e, t, r) {
  ...
  return (C.inBatch--, (C.trackingDerivation = a), vx(e), Aa(n), o);
}
function vx(e) {
  for (
    var t = e.observing_,
...
function px() {
  if (((C.pendingReactions.length || C.inBatch || C.isRunningReactions) && Y(36), (hg = !0), Ro)) {
    var e = si();
    (--e.__mobxInstanceCount === 0 && (e.__mobxGlobals = void 0), (C = new xo()));
  }
}
function hx(e, t) {
  (e.observers_.add(t),
...
function _g(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && C.inBatch > 0 && bg(e), !1);
}
function mg(e) {
...
var At = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), C.pendingReactions.push(this), yg());
    }),
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        (Ze(), (this.isScheduled = !1));
        var n = C.trackingContext;
        if (((C.trackingContext = this), rc(this))) {
...
function yg() {
  C.inBatch > 0 || C.isRunningReactions || ac(mx);
}
function mx() {
...
function Tx(e) {
  ...
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (C.useProxies = t === _o ? !0 : t === Dx ? !1 : typeof Proxy < "u"),
    t === "ifavailable" && (C.verifyProxies = !0),
    r !== void 0)
  ) {
    var n = r === _o ? _o : r === Mx;
    ((C.enforceActions = n), (C.allowStateChanges = !(n === !0 || n === _o)));
  }
  ([
...
if (!Bc) throw new Error("mobx-react-lite@3 requires mobx at least version 6 to be available");
function iR(e) {
  e();
}
function sR(e) {
  ...
  bR =
    (Cs =
      (Ps = Object.getOwnPropertyDescriptor(function () {}, "name")) === null || Ps === void 0
        ? void 0
        : Ps.configurable) !== null && Cs !== void 0
      ? Cs
      : !1,
  dv = Lg
...
function OR(e, t, r) {
  ...
  if (!(a && a[Ng])) {
    var o = e[t],
      i = Ug(e, t, a ? a.enumerable : void 0, n, o);
...
var CR = Object.defineProperty,
  ...
  Vt = (e, t, r, n) => {
    ...
    return (n && a && CR(t, r, a), a);
  };
class jt {
  constructor() {
    ((this.isLoading = !0), Bc(this));
  }
  saveUsers(t) {
                        ...
                        children: L.jsx("button", {
                          onClick: async () => {
                            try {
                              ...
                              const s = await Bt.invoke("fetch", { sortType: e.sort });
                              e.saveUsers(s);
                            } finally {
                              e.stopLoading();
                            }
...
const qR = yi(BR),
  ...
  zR = Qg.createRoot($R),
  wv = () => {
    zR.render(L.jsx(Bg, { ...$g, children: L.jsx(qR, {}) }));
  };
Bt.view.theme
  .enable()
  .then(() => {
