...
var Fu = [`isFixedSize`, `hasDataRow`, `children`, `testId`, `isLoading`],
  Iu = (0, x.forwardRef)(function (e, t) {
    var n = e.isFixedSize,
      r = e.hasDataRow,
      i = e.children,
      a = e.testId,
  ...
  Vu = [`rows`, `head`, `sortKey`, `sortOrder`, `rowsPerPage`, `page`, `forwardedRef`];
function Hu(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var r = Object.getOwnPropertySymbols(e);
...
function Wu(e, t, n) {
  return ((t = _(t)), u(e, Gu() ? Reflect.construct(t, n || [], _(e).constructor) : t.apply(e, n)));
}
function Gu() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
function Ju(e) {
  var t = (function (t) {
    function n() {
      ...
      d(this, n);
      var t = [...arguments];
      return ((e = Wu(this, n, [].concat(t))), l(e, `state`, { pageRows: [] }), e);
    }
    return (
      h(n, t),
      p(
        ...
        [
          {
            ...
            value: function (e, t) {
              ...
              var l, u;
              return (
                c ? ((l = n), (u = n)) : ((l = qu(r, n, i, a) || []), (u = ic(l, o, s))),
                Uu(Uu({}, t), {}, { pageRows: u })
              );
            },
          },
...
var Yu = `--local-dynamic-table-width`,
  Xu = function (e) {
    var t = e.width;
    return t === void 0 ? void 0 : l({}, Yu, `${t}%`);
  },
  Zu = [`width`, `isFixedSize`, `shouldTruncate`, `innerRef`],
  Qu = function (e) {
    var t = e.width,
      n = e.isFixedSize,
      r = e.shouldTruncate,
  ...
  $u = [`isHighlighted`, `children`, `style`, `testId`, `className`],
  ed = (0, x.forwardRef)(function (e, t) {
...
var od = (function (e) {
  ...
  sd = Ju(
    x.forwardRef(function (e, t) {
      return x.createElement(od, V({}, e, { forwardedRef: t }));
    }),
  );
function cd(e, t, n) {
...
var ud = (function (e) {
    function t(e) {
      var n;
      return (d(this, t), (n = cd(this, t, [e])), (n.state = { hasError: !1 }), n);
    }
    return (
      h(t, e),
      p(
  ...
  dd = (0, x.createContext)(null),
  fd = `#FFFFFF`,
  pd = `#42526E`,
  md = { xsmall: 12, small: 16, medium: 24, large: 48, xlarge: 96 };
function hd(e) {
  return e === `inherit` ? `var(--ds-icon-subtle, ${pd})` : `var(--ds-icon-inverse, ${fd})`;
}
var gd = {
...
function Ld(e) {
  ...
  for (let n of e) {
    ...
    let e = n.split(` `);
    for (let n of e) {
      let e = n.startsWith(`_`) ? n.slice(0, Rd) : n;
      t[e] = n;
    }
  }
  let n = ``;
...
var Ef = [
  ...
  Of = function (e) {
    var t = e.children;
    return x.createElement(`span`, { className: q([Df.separator]) }, t);
  },
  kf = (0, x.memo)(
    (0, x.forwardRef)(function (e, t) {
      var n = e.as,
        ...
        _ = e.children,
        v = g(e, Ef),
        y = typeof f == `string` ? x.createElement(Of, null, f) : f,
        b = y
...
var Nf = (0, x.createContext)(!1),
  Pf = function () {
    return (0, x.useContext)(Nf);
  },
  Ff = Nf.Provider,
  If = [`span`, `p`, `strong`, `em`],
  Lf = function (e, t) {
  ...
  Uf = (0, x.forwardRef)(function (e, t) {
    ...
    return p ? h : x.createElement(Ff, { value: !0 }, h);
  });
function Wf() {
...
var Gf = [`as`, `children`, `isInset`, `testId`, `style`, `xcss`],
  Kf = [`className`],
  ...
  Yf = [`className`],
  Xf = { root: `_19itglyw _vchhusvi _r06hglyw _80omtlke`, disabled: `_80om13gf` },
  Zf = (0, x.forwardRef)(function (e, t) {
    ...
    return x.createElement(
      qf,
      V({ as: `button`, tabIndex: m ?? (Wf() && !r ? 0 : void 0), style: d }, y, {
        type: a,
        onClick: v,
        disabled: r,
        xcss: pf(Xf.root, r && Xf.disabled, p),
        testId: f,
        ref: t,
      }),
      n,
  ...
  ep = (0, x.createContext)(!1),
  tp = function () {
    return (0, x.useContext)(ep);
  },
  np = i((e) => {
...
var Bp = `light`,
  ...
  Hp = function () {
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      t = e.colorMode,
      n = t === void 0 ? J.colorMode : t,
      r = e.dark,
      i = r === void 0 ? J.dark : r,
      a = e.light,
      o = a === void 0 ? J.light : a,
      s = e.contrastMode,
      c = s === void 0 ? J.contrastMode : s,
      u = e.motion,
      d = u === void 0 ? J.motion() : u,
      f = e.shape,
      p = f === void 0 ? J.shape() : f,
      m = e.spacing,
      h = m === void 0 ? J.spacing : m,
      g = e.typography,
      _ = g === void 0 ? J.typography : g,
      v = e.UNSAFE_themeOptions,
      y = v === void 0 ? J.UNSAFE_themeOptions : v,
      b = l(
...
function tm(e) {
  ...
  return (
    ...
    function () {
      (Xp.unbind(), K(`platform_increased-contrast-themes`) && em.unbind());
    }
  );
}
function nm(e, t) {
...
function am(e) {
  return Object.entries(sp).find(function (t) {
              ...
              switch ((e.prev = e.next)) {
                case 0:
                  return (
                      ...
                      typeof t == `function`
                        ? t(
                            fm(
                              fm({}, J),
                              {},
                              { typography: J.typography, shape: J.shape(), motion: J.motion() },
                              wp(),
                            ),
                          )
                        : t),
                    (i = r.colorMode),
                    (a = i === void 0 ? J.colorMode : i),
                    (o = r.contrastMode),
                    (s = o === void 0 ? J.contrastMode : o),
                    (c = r.dark),
                    (l = c === void 0 ? J.dark : c),
                    (u = r.light),
                    (d = u === void 0 ? J.light : u),
                    (f = r.shape),
                    (p = f === void 0 ? J.shape() : f),
                    (m = r.spacing),
                    (h = m === void 0 ? J.spacing : m),
                    ...
                    (_ = g === void 0 ? J.typography : g),
                    (v = r.motion),
                    (y = v === void 0 ? J.motion() : v),
                    (b = r.UNSAFE_themeOptions),
                    (x = b === void 0 ? J.UNSAFE_themeOptions : b),
                    K(`platform_increased-contrast-themes`) ||
                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        at(
                                          () => import(`./custom-theme-DpvRqGrK.js`),
...
function Nm(e) {
  ...
  var T = Om(Om({}, Hp(Om(Om({}, m), {}, { colorMode: u }))), {}, l({}, up, !0));
  return x.createElement(
    _m.Provider,
    { value: !0 },
    x.createElement(
        ...
        x.createElement(
          ...
          x.createElement(
            ...
            !w && K(`platform_dst_subtree_theming`)
              ? x.createElement(`div`, V({}, T, { className: q([Mm.body]) }), t)
              : t,
          ),
        ),
      ),
...
var Fm = function () {
  ...
  Gm = x.useId ?? void 0;
function Km() {
  return Gm && K(`platform-dst-react-18-use-id`)
...
function qm() {
  if (Gm && K(`platform-dst-react-18-use-id`)) {
    var e = Km();
    return function (t) {
      return `${e}-${t.toString()}`;
    };
...
var Qm = (function () {
    function e(e) {
      ...
      ((this._insertTag = function (e) {
        ...
        (this.isSpeedy = e.speedy === void 0 ? !Ym : e.speedy),
        (this.tags = []),
        (this.ctr = 0),
        (this.nonce = e.nonce),
        (this.key = e.key),
...
function uh(e, t) {
  return mh(e, 0) ^ 45
    ? (((((((t << 2) ^ mh(e, 0)) << 2) ^ mh(e, 1)) << 2) ^ mh(e, 2)) << 2) ^ mh(e, 3)
    : 0;
}
function dh(e) {
  return e.trim();
...
function Eh(e, t) {
  return lh(Th(``, null, null, ``, null, null, 0), e, { length: -e.length }, t);
}
function Dh() {
  return Z;
}
function Oh() {
  return ((Z = Ch > 0 ? mh(wh, --Ch) : 0), xh--, Z === 10 && ((xh = 1), bh--), Z);
}
function kh() {
  return ((Z = Ch < Sh ? mh(wh, Ch++) : 0), xh++, Z === 10 && ((xh = 1), bh++), Z);
}
function Ah() {
  return mh(wh, Ch);
}
...
function Ph(e) {
  return ((bh = xh = 1), (Sh = gh((wh = e))), (Ch = 0), []);
}
function Fh(e) {
  return ((wh = ``), e);
}
function Ih(e) {
  return dh(Mh(Ch - 1, zh(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Lh(e) {
  for (; (Z = Ah()) && Z < 33; ) kh();
  return Nh(e) > 2 || Nh(Z) > 3 ? `` : ` `;
}
function Rh(e, t) {
  for (; --t && kh() && !(Z < 48 || Z > 102 || (Z > 57 && Z < 65) || (Z > 70 && Z < 97)); );
  return Mh(e, jh() + (t < 6 && Ah() == 32 && kh() == 32));
}
function zh(e) {
  for (; kh(); )
    switch (Z) {
...
function Bh(e, t) {
  for (; kh() && e + Z !== 57 && !(e + Z === 84 && Ah() === 47); );
  return `/*` + Mh(t, Ch - 1) + `*` + ch(e === 47 ? e : kh());
}
function Vh(e) {
  for (; !Nh(Ah()); ) kh();
  return Mh(e, Ch);
...
function Hh(e) {
  return Fh(Uh(``, null, null, null, [``], (e = Ph(e)), 0, [0], e));
}
function Uh(e, t, n, r, i, a, o, s, c) {
  for (
    ...
    switch (((m = v), (v = kh()))) {
      case 40:
        if (m != 108 && mh(C, d - 1) == 58) {
          ph((C += X(Ih(v), `&`, `&\f`)), `&\f`) != -1 && (_ = -1);
          break;
        }
      case 34:
      case 39:
        ...
        switch (v) {
          ...
          case 59 + u:
            (_ == -1 && (C = X(C, /\f/g, ``)),
              p > 0 &&
                gh(C) - d &&
                vh(p > 32 ? Kh(C + `;`, r, n, d - 1) : Kh(X(C, ` `, ``) + `;`, r, n, d - 2), c));
            break;
          case 59:
            C += `;`;
          default:
            if ((vh((S = Wh(C, t, n, l, u, i, s, y, (b = []), (x = []), d)), a), v === 123))
              if (u === 0) Uh(C, t, S, S, b, a, d, s, x);
              else
                switch (f === 99 && mh(C, 3) === 110 ? 100 : f) {
                  case 100:
                  case 108:
                  case 109:
                  case 115:
                    Uh(
                      ...
                      S,
                      S,
                      r && vh(Wh(e, S, S, 0, 0, i, s, y, i, (b = []), d), x),
                      i,
                      x,
                      d,
                      s,
      ...
      default:
        if (h < 1) {
          if (v == 123) --h;
          else if (v == 125 && h++ == 0 && Oh() == 125) continue;
        }
        switch (((C += ch(v)), v * h)) {
          case 38:
            _ = u > 0 ? 1 : ((C += `\f`), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            (Ah() === 45 && (C += Ih(kh())), (f = Ah()), (u = d = gh((y = C += Vh(jh())))), v++);
            break;
          case 45:
            m === 45 && gh(C) == 2 && (h = 0);
        }
...
function Wh(e, t, n, r, i, a, o, s, c, l, u) {
  for (var d = i - 1, f = i === 0 ? a : [``], p = _h(f), m = 0, h = 0, g = 0; m < r; ++m)
    for (var _ = 0, v = hh(e, d + 1, (d = sh((h = o[m])))), y = e; _ < p; ++_)
      (y = dh(h > 0 ? f[_] + ` ` + v : X(v, /&\f/g, f[_]))) && (c[g++] = y);
  return Th(e, t, n, i === 0 ? nh : s, c, l, u);
}
function Gh(e, t, n) {
  return Th(e, t, n, th, ch(Dh()), hh(e, 2, -2), 0);
}
function Kh(e, t, n, r) {
  return Th(e, t, n, rh, hh(e, 0, r), hh(e, r + 1, -1), r);
}
function qh(e, t) {
  for (var n = ``, r = _h(e), i = 0; i < r; i++) n += t(e[i], i, e, t) || ``;
  return n;
}
function Jh(e, t, n, r) {
  switch (e.type) {
  ...
  return gh((n = qh(e.children, r))) ? (e.return = e.value + `{` + n + `}`) : ``;
}
function Yh(e) {
  var t = _h(e);
...
var Qh = function (e, t, n) {
    for (var r = 0, i = 0; (r = i), (i = Ah()), r === 38 && i === 12 && (t[n] = 1), !Nh(i); ) kh();
    return Mh(e, Ch);
  },
  $h = function (e, t) {
    var n = -1,
    ...
    do
      switch (Nh(r)) {
        case 0:
          (r === 38 && Ah() === 12 && (t[n] = 1), (e[n] += Qh(Ch - 1, t, n)));
          break;
        case 2:
          e[n] += Ih(r);
          break;
  ...
  ng = function (e) {
    if (!(e.type !== `rule` || !e.parent || e.length < 1)) {
      ...
      if (!(e.props.length === 1 && t.charCodeAt(0) !== 58 && !tg.get(n)) && !r) {
        tg.set(e, !0);
        for (var i = [], a = eg(t, i), o = n.props, s = 0, c = 0; s < a.length; s++)
...
function ig(e, t) {
  switch (uh(e, t)) {
    ...
    case 6968:
    case 2756:
      return Y + e + eh + e + $m + e + e;
    case 6828:
    case 4268:
      return Y + e + $m + e + e;
    case 6165:
      return Y + e + $m + `flex-` + e + e;
    case 5187:
      return Y + e + X(e, /(\w+).+(:[^]+)/, Y + `box-$1$2` + $m + `flex-$1$2`) + e;
    case 5443:
      return Y + e + $m + `flex-item-` + X(e, /flex-|-self/, ``) + e;
    case 4675:
      return Y + e + $m + `flex-line-pack` + X(e, /align-content|flex-|-self/, ``) + e;
    case 5548:
      return Y + e + $m + X(e, `shrink`, `negative`) + e;
    case 5292:
      return Y + e + $m + X(e, `basis`, `preferred-size`) + e;
    case 6060:
      return Y + `box-` + X(e, `-grow`, ``) + Y + e + $m + X(e, `grow`, `positive`) + e;
    case 4554:
    ...
    case 4968:
      return (
        X(
          X(e, /(.+:)(flex-)?(.*)/, Y + `box-pack:$3` + $m + `flex-pack:$3`),
          /s.+-b[^;]+/,
          `justify`,
        ) +
        Y +
    ...
    case 4765:
      if (gh(e) - 1 - t > 6)
        switch (mh(e, t + 1)) {
          case 109:
            if (mh(e, t + 4) !== 45) break;
          case 102:
            return (
              X(
                e,
                /(.+:)(.+)-([^]+)/,
                `$1` + Y + `$2-$3$1` + eh + (mh(e, t + 3) == 108 ? `$3` : `$2-$3`),
              ) + e
            );
          case 115:
            return ~ph(e, `stretch`) ? ig(X(e, `stretch`, `fill-available`), t) + e : e;
        }
      break;
    case 4949:
      if (mh(e, t + 1) !== 115) break;
    case 6444:
      switch (mh(e, gh(e) - 3 - (~ph(e, `!important`) && 10))) {
        case 107:
          return X(e, `:`, `:` + Y) + e;
        case 101:
          return (
    ...
    case 5936:
      switch (mh(e, t + 11)) {
        case 114:
          return Y + e + $m + X(e, /[svh]\w+-[tblr]{2}/, `tb`) + e;
        case 108:
          return Y + e + $m + X(e, /[svh]\w+-[tblr]{2}/, `tb-rl`) + e;
        case 45:
          return Y + e + $m + X(e, /[svh]\w+-[tblr]{2}/, `lr`) + e;
      }
      return Y + e + $m + e + e;
  }
  return e;
      ...
      if (e.length > -1 && !e.return)
        switch (e.type) {
          case rh:
            ...
            break;
          case ah:
            return qh([Eh(e, { value: X(e.value, `@`, `@` + Y) })], r);
          case nh:
            if (e.length)
              return yh(e.props, function (t) {
                switch (fh(t, /(::plac\w+|:read-\w+)/)) {
                  case `:read-only`:
                  case `:read-write`:
                    return qh([Eh(e, { props: [X(t, /:(read-\w+)/, `:` + eh + `$1`)] })], r);
                  case `::placeholder`:
                    return qh(
                      [
                        Eh(e, { props: [X(t, /:(plac\w+)/, `:` + Y + `input-$1`)] }),
                        Eh(e, { props: [X(t, /:(plac\w+)/, `:` + eh + `$1`)] }),
                        Eh(e, { props: [X(t, /:(plac\w+)/, $m + `input-$1`)] }),
                      ],
                      r,
                    );
                }
...
var fg = function (e, t, n) {
    var r = e.key + `-` + t.name;
    (n === !1 || ug === !1) && e.registered[r] === void 0 && (e.registered[r] = t.styles);
  },
  pg = function (e, t, n) {
    fg(e, t, n);
    var r = e.key + `-` + t.name;
...
var hg = {
  ...
  xg = Zh(function (e) {
    return yg(e) ? e : e.replace(_g, `-$&`).toLowerCase();
  }),
  Sg = function (e, t) {
    switch (e) {
      case `animation`:
      case `animationName`:
        if (typeof t == `string`)
          return t.replace(vg, function (e, t, n) {
            return ((Dg = { name: t, styles: n, next: Dg }), t);
          });
    }
    return hg[e] !== 1 && !yg(e) && typeof t == `number` && t !== 0 ? t + `px` : t;
  },
...
function wg(e, t, n) {
  ...
  switch (typeof n) {
    ...
    case `object`:
      var i = n;
      if (i.anim === 1) return ((Dg = { name: i.name, styles: i.styles, next: Dg }), i.name);
      var a = n;
      if (a.styles !== void 0) {
        var o = a.next;
        if (o !== void 0)
          for (; o !== void 0; )
            ((Dg = { name: o.name, styles: o.styles, next: Dg }), (o = o.next));
        return a.styles + `;`;
      }
      return Tg(e, t, n);
    case `function`:
...
function Tg(e, t, n) {
  var r = ``;
  if (Array.isArray(n)) for (var i = 0; i < n.length; i++) r += wg(e, t, n[i]) + `;`;
  else
    for (var a in n) {
      var o = n[a];
      if (typeof o != `object`) {
        ...
        if (a === `NO_COMPONENT_SELECTOR` && gg) throw Error(Cg);
        if (Array.isArray(o) && typeof o[0] == `string` && (t == null || t[o[0]] === void 0))
          for (var c = 0; c < o.length; c++) bg(o[c]) && (r += xg(a) + `:` + Sg(a, o[c]) + `;`);
        else {
          var l = wg(e, t, o);
          switch (a) {
            case `animation`:
...
function Og(e, t, n) {
  ...
  Dg = void 0;
  var a = e[0];
  a == null || a.raw === void 0 ? ((r = !1), (i += wg(n, t, a))) : (i += a[0]);
  for (var o = 1; o < e.length; o++) ((i += wg(n, t, e[o])), r && (i += a[o]));
  Eg.lastIndex = 0;
  for (var s = ``, c; (c = Eg.exec(i)) !== null; ) s += `-` + c[1];
  return { name: mg(i) + s, styles: i, next: Dg };
}
var kg = function (e) {
    return e();
  },
...
var Mg = x.createContext(typeof HTMLElement < `u` ? og({ key: `css` }) : null);
Mg.Provider;
var Ng = function (e) {
    return (0, x.forwardRef)(function (t, n) {
      return e(t, (0, x.useContext)(Mg), n);
    });
  },
  Pg = x.createContext({}),
  Fg = {}.hasOwnProperty,
  ...
  Lg = function (e, t) {
    var n = {};
    for (var r in t) Fg.call(t, r) && (n[r] = t[r]);
    return ((n[Ig] = e), n);
  },
  Rg = function (e) {
    var t = e.cache,
  ...
  zg = Ng(function (e, t, n) {
    ...
    typeof e.className == `string`
      ? (o = dg(t.registered, a, e.className))
      : e.className != null && (o = e.className + ` `);
    var s = Og(a, void 0, x.useContext(Pg));
    o += t.key + `-` + s.name;
    var c = {};
    for (var l in e) Fg.call(e, l) && l !== `css` && l !== Ig && (c[l] = e[l]);
    return (
      (c.className = o),
      n && (c.ref = n),
      x.createElement(
        x.Fragment,
        null,
        x.createElement(Rg, { cache: t, serialized: s, isStringTag: typeof i == `string` }),
        x.createElement(i, c),
      )
    );
  });
...
var Bg = function (e, t) {
  var n = arguments;
  if (t == null || !Fg.call(t, `css`)) return x.createElement.apply(void 0, n);
  var r = n.length,
    i = Array(r);
  ((i[0] = zg), (i[1] = Lg(e, t)));
...
var Wg = function (e) {
    ...
    return (
      jg(function () {
        for (var e = 0; e < n.length; e++) pg(t, n[e], !1);
      }),
      null
    );
  },
  Gg = Ng(function (e, t) {
    var n = [],
      r = function () {
        var e = Og([...arguments], t.registered);
        return (n.push(e), fg(t, e, !1), t.key + `-` + e.name);
      },
      i = {
        css: r,
        cx: function () {
          var e = [...arguments];
          return Ug(t.registered, r, Hg(e));
        },
        theme: x.useContext(Pg),
      },
      a = e.children(i);
    return x.createElement(
      x.Fragment,
      null,
      x.createElement(Wg, { cache: t, serializedArr: n }),
      a,
    );
  });
function Kg(e, t) {
...
var qg = 2,
  ...
  Qg = (0, x.memo)(function (e) {
    var t = e.children,
      n = e.isInset,
      r = e.focus,
      i = r === void 0 ? (n ? Zg : Xg) : r === `on` && (n ? Yg : Jg);
    return Bg(Gg, null, function (e) {
      var n = e.css,
        r = e.cx;
...
var s_ = 8,
  c_ = [`default`, `primary`, `danger`, `warning`],
  l_ = { default: `${32 / 14}em`, compact: `${24 / 14}em`, none: `auto` },
  u_ = { default: l_.default, compact: l_.compact, none: `inherit` },
  d_ = { default: `0 ${s_ + s_ / 4}px`, compact: `0 ${s_ + s_ / 4}px`, none: `0` },
  f_ = { compact: `0 ${s_ / 4}px`, default: `0 ${s_ / 4}px`, none: `0` },
  p_ = { default: `middle`, compact: `middle`, none: `baseline` },
  m_ = { content: `0 ${s_ / 4}px`, icon: `0 ${s_ / 4}px` },
  h_ = {
  ...
  g_ = {
    ...
    "&::after": o_(o_({}, h_), {}, { content: `""`, borderColor: `var(--ds-border, #0B120E24)` }),
  ...
  C_ = {
    ...
    "&:not([disabled])::after": o_(
      o_({}, h_),
      {},
      { content: `""`, borderColor: `var(--ds-border-selected, #1868DB)` },
    ),
  },
  w_ = { '&[data-has-overlay="true"]': { cursor: `default`, textDecoration: `none` } };
function T_(e) {
  var t = e.appearance,
    n = e.spacing,
    r = e.isSelected,
            ...
            o_(
              o_(
                o_(
                  o_(
                    o_(
                      o_(o_({}, t === `default` && g_), t === `primary` && __),
                      t === `link` && v_,
                    ),
                    t === `subtle` && y_,
                  ),
...
function O_(e) {
  var t = e.hasOverlay;
  return Vg({ opacity: t ? 0 : 1, transition: `opacity 0.3s` });
}
var k_ = {
    position: `absolute`,
    left: 0,
  ...
  A_ = function (e) {
    return e && (0, x.isValidElement)(e) && e.type === Jm;
  },
  j_ = [
    `analyticsContext`,
    `appearance`,
  ...
  F_ = function (e, t) {
    return !e || A_(e) ? null : t;
  },
  I_ = function (e, t) {
    return A_(e) ? e : e ? Bg(`span`, { css: t }, e) : null;
  },
  L_ = x.forwardRef(function (e, t) {
    ...
    return (
      (b || v || i === `warning`) &&
        (fe = {
          "[data-theme] & circle": {
            stroke: `${b || v ? `var(--ds-icon-subtle, ${pd})` : `var(--ds-icon-warning-inverse, ${pd})`} !important`,
          },
        }),
      Bg(
        Qg,
        ...
        Bg(
          ...
          m ? Bg(`span`, { css: [M, E_({ spacing: ee }), F_(c, N_)] }, m) : null,
          I_(c, [M, D_({ spacing: ee })]),
          p ? Bg(`span`, { css: [M, E_({ spacing: ee }), F_(c, P_)] }, p) : null,
          O ? Bg(`span`, { css: [k_, fe] }, O) : null,
        ),
      )
    );
  });
...
var z_ = [
  ...
  B_ = typeof navigator < `u` && navigator.userAgent.toLowerCase().indexOf(`firefox`) > -1,
  V_ = x.memo(
    x.forwardRef(function (e, t) {
      var n = e.appearance,
        ...
        y = g(e, z_),
        b = R_({ children: i, iconBefore: a, iconAfter: o }),
...
V_.displayName = `Button`;
function H_(e) {
  return x.createElement(V_, {
...
function U_(e) {
  return x.createElement(V_, V({}, e, { appearance: `subtle` }));
}
var W_ = { container: `_1e0c1txw _kqswh2mm` };
function G_(e) {
  var t = e.key,
    n = e.testId,
    r = e.from,
  ...
  return x.createElement(
    uf,
    { as: `li`, testId: n, key: t, xcss: W_.container, paddingInline: `space.100` },
    x.createElement(
      Uf,
      { testId: n && `${n}-text` },
      x.createElement(Jm, null, `Skipped pages from `, r, ` to `, i),
      `…`,
    ),
  );
}
...
function J_(e, t) {
  return !!(e === t || (q_(e) && q_(t)));
}
function Y_(e, t) {
  if (e.length !== t.length) return !1;
  for (var n = 0; n < e.length; n++) if (!J_(e[n], t[n])) return !1;
  return !0;
}
function X_(e, t) {
  t === void 0 && (t = Y_);
...
function iv(e) {
  var t = e.chevronDirection === `left` ? Q_.default : $_.default;
  return x.createElement(
    uf,
    { as: `span`, xcss: nv.navigatorIconWrapper },
...
function av(e, t) {
  var n = e.components,
    ...
    ne = function (e, t, n) {
      ...
      return x.createElement(
        kf,
        { as: `li`, xcss: nv.paginationMenuItem, key: `page-${w ? w(e, t) : t}` },
        x.createElement(
          U_,
          {
            component: r.Page,
  ...
  return x.createElement(
    ...
    x.createElement(
      ...
      x.createElement(H_, {
        ...
        isDisabled: k || A === 0,
        iconBefore: x.createElement(iv, { chevronDirection: `left` }),
        "aria-label": p,
        testId: O && `${O}--left-navigator`,
      }),
      x.createElement(
        kf,
        { space: `space.0`, alignBlock: `baseline`, as: `ul`, xcss: nv.paginationMenu },
        Z_(C, A, { max: y, ellipsis: E, transform: ne }, O),
      ),
      x.createElement(H_, {
        key: `right-navigator`,
        component: r.Next,
        ...
        iconBefore: x.createElement(iv, { chevronDirection: `right` }),
        "aria-label": h,
...
var ov = (0, x.memo)((0, x.forwardRef)(av));
function sv(e, t, n) {
...
var mv = `--local-dynamic-table-text-color`,
  hv = function (e) {
    var t = e.isRanking,
      n = e.testId,
      r = g(e, uv);
  ...
  gv = (0, x.forwardRef)(function (e, t) {
    var n = e.width,
      r = e.children;
    e.isSortable;
    var i = e.sortOrder,
    ...
    var s = e.style,
      ...
      u = g(e, dv),
      d = pv(
        pv(pv({}, s), n && Xu({ width: n })),
        {},
        l({}, mv, `var(--ds-text-subtlest, #6B6E76)`),
      ),
      f = i === `ASC`,
      p = i === ku,
      m = function () {
    ...
    return x.createElement(
      ...
      V({ "aria-sort": m(), onClick: void 0, ref: t, "data-testid": c }, u, {
        ...
        style: pv(pv({}, d), {}, { "--_17ckjys": Pu(`var(--ds-text-subtle, ${`var(${mv})`})`) }),
      }),
      r,
    );
  });
function _v(e, t, n) {
  return ((t = _(t)), u(e, vv() ? Reflect.construct(t, n || [], _(e).constructor) : t.apply(e, n)));
}
function vv() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var wv = (0, x.createContext)(null),
  Tv = (0, x.createContext)(null);
function Ev() {
  return (0, x.useContext)(Tv);
}
function Dv(e) {
  var t = e.isOpen,
    n = e.type,
...
var Ov = { none: 0, small: 100, medium: 350, large: 700 },
  kv = 0.5,
  Av = { none: Ov.none, small: Ov.small * kv, medium: Ov.medium * kv, large: Ov.large * kv },
  jv = function () {
    return typeof window < `u` && `matchMedia` in window;
  },
  Mv = function () {
    return jv() ? window.matchMedia(`(prefers-reduced-motion: reduce)`).matches : !1;
  },
  Nv = 5;
function Q(e) {
  if (!e.length) return;
  ...
  for (let n of e) {
    ...
    let e = n.split(` `);
    for (let n of e) {
      let e = n.startsWith(`_`) ? n.slice(0, Nv) : n;
      t[e] = n;
    }
  }
  let n = ``;
...
var Pv = function (e) {
  ...
  Iv = { appear: !0, isExiting: !1 },
  Lv = (0, x.createContext)(Iv),
  Rv = function (e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Iv;
    return x.createElement(Lv.Provider, { key: `${e.key}-provider`, value: t }, e);
  },
  zv = function (e) {
    var t = [];
    return (
  ...
  Bv = function (e, t) {
    for (var n = t.concat([]), r = Vv(t), i = 0; i < e.length; i++) {
      var a = e[i];
...
var Kv = (0, x.createContext)(function () {
    return { isReady: !0, delay: 0, ref: rc };
  }),
  qv = function () {
    var e = Gv();
    return (0, x.useContext)(Kv)(e);
  },
  Jv = function (e) {
    var t = e.children,
  ...
  Yv = { top: `bottom`, bottom: `top`, left: `right`, right: `left` },
  Xv = function (e) {
    var t = e.children,
      n = e.duration,
      r = n === void 0 ? `large` : n,
...
var Qv = function (e) {
  ...
  ey = function (e, t) {
    if (typeof e == `function`) return $v(e, t);
    e != null && (e.current = t);
  },
  ty = function (e) {
    return e.reduce(function (e, t) {
  ...
  dy = `popper`,
  fy = `reference`,
  py = sy.reduce(function (e, t) {
    return e.concat([t + `-` + cy, t + `-end`]);
  }, []),
  my = [].concat(sy, [oy]).reduce(function (e, t) {
    return e.concat([t, t + `-` + cy, t + `-end`]);
  }, []),
  hy = [
    `beforeRead`,
    `read`,
...
function vy(e) {
  return e instanceof _y(e).Element || e instanceof Element;
}
function yy(e) {
  return e instanceof _y(e).HTMLElement || e instanceof HTMLElement;
}
function by(e) {
  return typeof ShadowRoot > `u` ? !1 : e instanceof _y(e).ShadowRoot || e instanceof ShadowRoot;
}
function xy(e) {
  var t = e.state;
...
function Ay(e, t, n) {
  ...
  t &&
    yy(e) &&
    ((i = (e.offsetWidth > 0 && Dy(r.width) / e.offsetWidth) || 1),
    (a = (e.offsetHeight > 0 && Dy(r.height) / e.offsetHeight) || 1));
  var o = (vy(e) ? _y(e) : window).visualViewport,
    s = !ky() && n,
...
function Ny(e) {
  return _y(e).getComputedStyle(e);
}
function Py(e) {
  return [`table`, `td`, `th`].indexOf(gy(e)) >= 0;
}
function Fy(e) {
  return ((vy(e) ? e.ownerDocument : e.document) || window.document).documentElement;
}
function Iy(e) {
  return gy(e) === `html` ? e : e.assignedSlot || e.parentNode || (by(e) ? e.host : null) || Fy(e);
}
function Ly(e) {
  return !yy(e) || Ny(e).position === `fixed` ? null : e.offsetParent;
}
function Ry(e) {
  var t = /firefox/i.test(Oy());
  if (/Trident/i.test(Oy()) && yy(e) && Ny(e).position === `fixed`) return null;
  var n = Iy(e);
  for (by(n) && (n = n.host); yy(n) && [`html`, `body`].indexOf(gy(n)) < 0; ) {
    var r = Ny(n);
    if (
      r.transform !== `none` ||
      r.perspective !== `none` ||
...
function zy(e) {
  for (var t = _y(e), n = Ly(e); n && Py(n) && Ny(n).position === `static`; ) n = Ly(n);
  return n && (gy(n) === `html` || (gy(n) === `body` && Ny(n).position === `static`))
    ? t
    : n || Ry(e) || t;
}
function By(e) {
...
function Jy(e) {
  ...
  r != null &&
    ((typeof r == `string` && ((r = t.elements.popper.querySelector(r)), !r)) ||
      (My(t.elements.popper, r) && (t.elements.arrow = r)));
}
var Yy = {
  name: `arrow`,
  enabled: !0,
...
function Qy(e, t) {
  ...
  return { x: Dy(n * i) / i || 0, y: Dy(r * i) / i || 0 };
}
function $y(e) {
  var t,
    n = e.popper,
...
function eb(e) {
  var t = e.state,
    ...
    c = s === void 0 ? !0 : s,
    l = {
      placement: wy(t.placement),
      variation: Xy(t.placement),
...
var tb = { name: `computeStyles`, enabled: !0, phase: `beforeWrite`, fn: eb, data: {} },
  nb = { passive: !0 };
function rb(e) {
  var t = e.state,
    n = e.instance,
    ...
    o = r.resize,
    s = o === void 0 ? !0 : o,
    c = _y(t.elements.popper),
    l = [].concat(t.scrollParents.reference, t.scrollParents.popper);
  return (
    a &&
      l.forEach(function (e) {
        e.addEventListener(`scroll`, n.update, nb);
      }),
    s && c.addEventListener(`resize`, n.update, nb),
    function () {
      (a &&
        l.forEach(function (e) {
          e.removeEventListener(`scroll`, n.update, nb);
        }),
        s && c.removeEventListener(`resize`, n.update, nb));
    }
  );
}
var ib = {
  ...
  ab = { left: `right`, right: `left`, bottom: `top`, top: `bottom` };
function ob(e) {
...
function ub(e) {
  return Ay(Fy(e)).left + lb(e).scrollLeft;
}
function db(e, t) {
  var n = _y(e),
    r = Fy(e),
  ...
  return { width: a, height: o, x: s + ub(e), y: c };
}
function fb(e) {
  var t = Fy(e),
    n = lb(e),
    r = e.ownerDocument?.body,
    i = Ty(t.scrollWidth, t.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0),
    a = Ty(t.scrollHeight, t.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0),
    o = -n.scrollLeft + ub(e),
    s = -n.scrollTop;
  return (
    Ny(r || t).direction === `rtl` && (o += Ty(t.clientWidth, r ? r.clientWidth : 0) - i),
...
function mb(e) {
  return [`html`, `body`, `#document`].indexOf(gy(e)) >= 0
...
function hb(e, t) {
  ...
  var n = mb(e),
    ...
    i = _y(n),
    a = r ? [i].concat(i.visualViewport || [], pb(n) ? n : []) : n,
    o = t.concat(a);
  return r ? o : o.concat(hb(Iy(a)));
}
function gb(e) {
...
function vb(e, t, n) {
  return t === `viewport` ? gb(db(e, n)) : vy(t) ? _b(t, n) : gb(fb(Fy(e)));
}
function yb(e) {
  var t = hb(Iy(e)),
    n = [`absolute`, `fixed`].indexOf(Ny(e).position) >= 0 && yy(e) ? zy(e) : e;
  return vy(n)
    ? t.filter(function (e) {
        return vy(e) && My(e, n) && gy(e) !== `body`;
      })
    : [];
}
function bb(e, t, n, r) {
  var i = t === `clippingParents` ? yb(e) : [].concat(t),
    a = [].concat(i, [n]),
    o = a[0],
    s = a.reduce(
      function (t, n) {
        var i = vb(e, n, r);
        return (
          (t.top = Ty(i.top, t.top)),
          (t.right = Ey(i.right, t.right)),
          (t.bottom = Ey(i.bottom, t.bottom)),
          (t.left = Ty(i.left, t.left)),
          t
        );
      },
      vb(e, o, r),
...
function Sb(e, t) {
  ...
  var n = t,
    ...
    h = n.padding,
    g = h === void 0 ? 0 : h,
    _ = Wy(typeof g == `number` ? Gy(g, sy) : g),
    v = f === `popper` ? fy : dy,
    y = e.rects.popper,
    b = e.elements[m ? v : f],
    x = bb(vy(b) ? b : b.contextElement || Fy(e.elements.popper), c, u, o),
    S = Ay(e.elements.reference),
    C = xb({ reference: S, element: y, strategy: `absolute`, placement: i }),
    w = gb(Object.assign({}, y, C)),
    T = f === `popper` ? w : S,
    E = {
...
function Cb(e, t) {
  ...
  var p = f.reduce(function (t, n) {
    return ((t[n] = Sb(e, { placement: n, boundary: i, rootBoundary: a, padding: o })[wy(n)]), t);
  }, {});
...
function Ob(e) {
  return [`top`, iy, ry, ay].some(function (t) {
    return e[t] >= 0;
  });
}
function kb(e) {
...
function Mb(e) {
  var t = e.state,
    ...
    i = n.offset,
    a = i === void 0 ? [0, 0] : i,
    o = my.reduce(function (e, n) {
      return ((e[n] = jb(n, t.rects, a)), e);
    }, {}),
    s = o[t.placement],
    c = s.x,
    l = s.y;
...
var Nb = { name: `offset`, enabled: !0, phase: `main`, requires: [`popperOffsets`], fn: Mb };
function Pb(e) {
  var t = e.state,
    n = e.name;
  t.modifiersData[n] = xb({
...
var Fb = { name: `popperOffsets`, enabled: !0, phase: `read`, fn: Pb, data: {} };
function Ib(e) {
  return e === `x` ? `y` : `x`;
}
function Lb(e) {
  ...
  if (S) {
    if (a) {
      var k = b === `y` ? `top` : ay,
        ...
        ae = v === `start` ? -w[A] : -C[A],
        oe = t.elements.arrow,
        se = p && oe ? jy(oe) : { width: 0, height: 0 },
        ...
        pe = t.elements.arrow && zy(t.elements.arrow),
        me = pe ? (b === `y` ? pe.clientTop || 0 : pe.clientLeft || 0) : 0,
        he = D?.[b] ?? 0,
        ge = j + de - he - me,
        _e = j + fe - he,
        ve = Vy(p ? Ey(te, ge) : te, j, p ? Ty(ne, _e) : ne);
      ((S[b] = ve), (O[b] = ve - j));
    }
    if (s) {
      var ye = b === `x` ? `top` : ay,
...
function Bb(e) {
  return e === _y(e) || !yy(e) ? lb(e) : zb(e);
}
function Vb(e) {
  var t = e.getBoundingClientRect(),
    n = Dy(t.width) / e.offsetWidth || 1,
    r = Dy(t.height) / e.offsetHeight || 1;
  return n !== 1 || r !== 1;
}
function Hb(e, t, n) {
  n === void 0 && (n = !1);
  ...
  return (
    (r || (!r && !n)) &&
      ((gy(t) !== `body` || pb(a)) && (s = Bb(t)),
      yy(t) ? ((c = Ay(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : a && (c.x = ub(a))),
    {
...
var qb = { placement: `bottom`, modifiers: [], strategy: `absolute` };
function Jb() {
      ...
      c = {
        ...
        setOptions: function (n) {
          ...
          (u(),
            ...
            (i.scrollParents = {
              reference: vy(e) ? hb(e) : e.contextElement ? hb(e.contextElement) : [],
              popper: hb(t),
            }));
          var s = Wb(Kb([].concat(r, i.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!s) {
            ...
            if (Jb(t, n)) {
              ((i.rects = {
                reference: Hb(t, zy(n), i.options.strategy === `fixed`),
                popper: jy(n),
              }),
                (i.reset = !1),
...
var Xb = Yb({ defaultModifiers: [ib, Fb, tb, Cy, Nb, Eb, Rb, Yy, Ab] }),
  Zb = e(
    i((e, t) => {
...
function lx(e) {
  var t = e.children,
    ...
    y = (0, x.useMemo)(
      function () {
        var e = {
            name: `preventOverflow`,
            options: { padding: ax, rootBoundary: h ? `viewport` : `document` },
          },
          t = { name: `offset`, options: { offset: [_, v] } },
          n = h ? ix({ viewportPadding: ax }) : [];
        return [].concat(ox, [e, t], m(n));
      },
      [_, v, h],
    ),
    b = (0, x.useMemo)(
  ...
  return x.createElement(rx, { modifiers: b, placement: o, strategy: d, referenceElement: c }, n);
}
var ux = `atlaskit-portal-container`,
  dx = `body > .atlaskit-portal-container`,
  fx = `atlaskit-portal`,
  px = function (e) {
    var t = document.createElement(`div`);
    return ((t.className = fx), (t.style.zIndex = `${e}`), t);
  },
  mx = function () {
    return document.body;
  },
  hx = function () {
    var e = document.querySelector(dx);
    if (!e) {
      var t,
  ...
  _x = function (e) {
    e.parentElement || hx().appendChild(e);
  },
  vx = function () {
...
function xx(e) {
  ...
  return (
    ...
    (0, is.createPortal)(
      i && K(`platform_dst_subtree_theming`) ? x.createElement(Nm, { defaultColorMode: i }, n) : n,
      r,
    )
  );
}
var Sx = typeof window < `u` ? x.useLayoutEffect : x.useEffect;
function Cx(e) {
  var t = e.zIndex,
    n = e.children,
  ...
  var s = x.createElement(
    x.Suspense,
    { fallback: null },
    o && K(`platform_dst_subtree_theming`) ? x.createElement(Nm, { defaultColorMode: o }, n) : n,
  );
...
var wx = function (e) {
    var t = f((0, x.useState)(!1), 2),
      ...
      i = f(
        (0, x.useState)(function () {
          return e === `layoutEffect` ? Sx : x.useEffect;
        }),
        1,
      )[0];
    return (
  ...
  kx = function (e, t) {
    var n = { layer: Ox(Number(t)), zIndex: t };
...
function Mx(e) {
  var t = e.zIndex,
    ...
    r = e.children,
    i = e.mountStrategy,
    a = wx(i === void 0 ? `effect` : i);
  return (
    jx(n),
    K(`platform_design_system_team_portal_logic_r18_fix`)
      ? x.createElement(Cx, { zIndex: n }, r)
      : a
        ? x.createElement(xx, { zIndex: n }, r)
        : null
  );
}
var Nx = {
...
function Ix() {
  Fx ||
    ((Fx = (0, Kp.bindAll)(window, [
      { type: `dragend`, listener: Lx },
      { type: `pointerdown`, listener: Lx },
      {
        type: `pointermove`,
        listener: (function () {
          var e = 0;
    ...
    Array.from(Px).forEach(function (e) {
      e.onDragStart();
    }));
}
function Lx() {
...
function Rx() {
  return (0, Kp.bindAll)(window, [
    { type: `dragstart`, listener: Ix },
    { type: `dragenter`, listener: Ix },
  ]);
}
var zx = null;
function Bx(e) {
  return (
    (zx ||= Rx()),
    Px.add(e),
    e.onRegister({ isDragging: Fx !== null }),
    function () {
      if ((Px.delete(e), Px.size === 0)) {
        var t;
        ((t = zx) == null || t(), (zx = null));
      }
    }
...
var Vx = null;
function Hx() {
  Vx != null && (window.clearTimeout(Vx), (Vx = null));
}
function Ux(e, t) {
  (Hx(),
...
function Gx(e) {
  ...
  function o() {
    if (n()) {
      ...
      if (t === `hide-animating`) {
        ((t = `shown`), Hx(), e.show({ isImmediate: !1 }));
        return;
      }
    }
  }
  ...
  function d() {
    var n = K(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? e.shouldAlwaysFadeIn : !1,
      r = !!(Wx && Wx.isVisible()) && !n;
    ((Wx &&= (Hx(), Wx.entry.hide({ isImmediate: !0 }), Wx.entry.done(), null)),
      (Wx = { entry: e, isVisible: l }));
    function i() {
    ...
    ((t = `waiting-to-show`), Ux(i, e.delay));
  }
  return (
    d(),
    {
...
function Jx(e) {
  ...
  for (let n of e) {
    ...
    let e = n.split(` `);
    for (let n of e) {
      let e = n.startsWith(`_`) ? n.slice(0, qx) : n;
      t[e] = n;
    }
  }
  let n = ``;
...
var Yx = {
  ...
  Xx = function (e) {
    ...
    return x.createElement(
      `div`,
      { className: Jx([Yx.shortcutSegmentsContainer]) },
      t.map(function (e, t) {
        return x.createElement(`kbd`, { key: `${e}-${t}`, className: Jx([Yx.shortcutSegment]) }, e);
      }),
    );
  },
  Zx = (0, x.forwardRef)(function (e, t) {
    ...
    return x.createElement(
      ...
      x.createElement(
        ...
        i,
        u && x.createElement(Xx, { shortcut: u }),
      ),
    );
  });
Zx.displayName = `TooltipPrimitive`;
var Qx = {
  ...
  $x = (0, x.forwardRef)(function (e, t) {
    ...
    return x.createElement(
      Zx,
      {
        ref: t,
        style: n,
        className: Jx([Qx.base, a && Qx.truncate, r]),
        placement: o,
        testId: s,
        id: u,
        onMouseOut: c,
...
var iS = Nx.tooltip(),
  aS = { componentName: `tooltip`, packageName: `@atlaskit/tooltip`, packageVersion: `20.14.5` },
...
function cS(e) {
  var t = e.children,
    ...
    ce = se ? a : r,
    le = Ou(rS({ fn: v, action: `displayed`, analyticsData: D }, aS)),
    ue = Ou(rS({ fn: b, action: `hidden`, analyticsData: D }, aS)),
    M = (0, x.useRef)(null),
            ...
            se
              ? {
                  ...
                  mouse: K(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
                    ? void 0
                    : eS({ left: e.clientX, top: e.clientY }),
                  clientX: e.clientX,
                  clientY: e.clientY,
                }
              : { type: `keyboard` },
      ...
      ? function (e) {
          ...
          (t = M.current) != null &&
            ...
            (K(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ||
              (M.current.mousePosition = eS({ left: e.clientX, top: e.clientY })),
  ...
  var He = function () {
      ...
      return se &&
        ...
        me.current &&
        K(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
        ? tS(M.current.mousePos, { targetElement: me.current, tooltipPosition: r })
        : se &&
            (t = M.current) != null &&
            t.mousePosition &&
            !K(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
  ...
  var Ke = ze
      ...
      : null,
    qe = oe && K(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? x.Fragment : lS;
  return x.createElement(
    x.Fragment,
    null,
    typeof t == `function`
      ? x.createElement(
          x.Fragment,
          null,
          t(rS(rS({}, We), {}, { "aria-describedby": Ue, ref: _e })),
          Ke,
        )
    ...
    Re
      ? x.createElement(
          qe,
          null,
          x.createElement(lx, { placement: ce, referenceElement: He(), strategy: k }, function (e) {
            var t = e.ref,
              n = e.style,
              r = e.update,
              i = e.placement,
                  ...
                  function (e) {
                    ...
                    return x.createElement(
                      u,
                      {
                        ref: t,
                        className: `Tooltip ${i}`,
                        style: rS(rS({}, n), A && { pointerEvents: `none` }),
                        truncate: c,
                        placement: ce,
...
var lS = function (e) {
    var t = e.children;
    return x.createElement(Mx, { zIndex: iS }, t);
  },
  uS = e(bv()),
  dS = e(xv()),
  fS = [
  ...
  mS = { headCellContainer: `_1e0c1txw _4cvr1h6o`, text: `_11c8wadc _syazazsu _k48pwu06` },
  hS = function (e) {
    var t = e.content,
      n = e.inlineStyles,
      r = e.testId;
    ...
    var i = e.innerRef,
      ...
      ne = x.createElement(
        uf,
        { xcss: mS.headCellContainer, onMouseEnter: j, onMouseLeave: te, onFocus: ee, onBlur: A },
        x.createElement(
          cS,
          { content: o === `ASC` ? d : m },
          x.createElement(
            Zf,
            { onClick: s, xcss: pS.buttonWrapper, "aria-roledescription": _ },
            x.createElement(
              Tf,
              { xcss: O ? pS.hideIconHeaderWrapper : pS.visibleHeaderWrapper },
              x.createElement(`span`, { className: q([mS.text]) }, t),
            ),
            k &&
              x.createElement(
                Tf,
                { xcss: D ? pS.sortIconVisibleWrapper : pS.sortIconHiddenWrapper },
                o === `ASC`
                  ? x.createElement(dS.default, {
                      label: ``,
                      color: `var(--ds-text-subtle, #505258)`,
                      testId: r && `${r}--up--icon`,
                    })
...
var yS = yv(
    (function (e) {
      function t() {
        return (d(this, t), _S(this, t, arguments));
      }
      return (
        h(t, e),
        p(t, [
          {
            ...
            value: function () {
              ...
              var n = e.refWidth,
                r = g(e, gS),
                i = sc(t, n);
              return x.createElement(hS, V({ inlineStyles: i }, r));
            },
          },
        ])
      );
...
var wS = (function (e) {
  function t(e) {
    var n;
    return (d(this, t), (n = SS(this, t, [e])), (n.state = { activeSortButtonId: null }), n);
  }
  return (
    h(t, e),
    p(t, [
...
var DS = function (e) {
    ...
    var de = function (e) {
      ...
      he = function () {
        return re || (ic(i || [], T, v).length > 2 ? ju : Au);
      },
      ge = function () {
        return m ? x.createElement(zu, { testId: l }) : E && x.createElement(Bu, { testId: l }, E);
      },
      _e = i && i.length,
      ve,
      ye = !1;
  ...
  OS = (0, x.lazy)(function () {
    return at(
      () => import(`./body-D3uFc3r1.js`),
      __vite__mapDeps([5, 1, 3, 6, 7]),
      import.meta.url,
    );
  }),
  kS = (0, x.forwardRef)(function (e, t) {
    var n = e.isRankable,
      r = n === void 0 ? !1 : n,
      i = e.isRanking,
      a = e.onRankStart,
    ...
    var m = x.createElement(sd, V({ ref: t }, c));
    return l && d
      ? x.createElement(
          ud,
          { fallback: m },
...
function BS() {
  ...
  let n = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`explain error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    ...
    i = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`explain analyze error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    ...
    o = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`execute query error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    ...
    c = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`Optimize error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    ...
    u = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`dropStats error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    d = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`deoptimize error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    f = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`History error`, e.message));
      } finally {
        e.stopLoading();
      }
    },
    p = async () => {
      ...
      try {
        ...
        (console.error(e), zS(`Slowquery error`, e.message));
      } finally {
        e.stopLoading();
      }
    };
...
var VS = Us(BS),
  ...
  US = () => {
    HS.render((0, $.jsx)(Js, { ...ec, children: (0, $.jsx)(VS, {}) }));
  };
pn.view.theme
  .enable()
  .then(() => {
