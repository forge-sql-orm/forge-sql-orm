const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./custom-theme-1YuD6i9f.js",
      "./custom-theme-loading-utils-CdXzkiPo.js",
...
var Eu = [`span`, `p`, `strong`, `em`],
  ...
  ku = { medium: `_11c8fhey`, UNSAFE_small: `_11c8rymc`, large: `_11c81d4k`, small: `_11c8wadc` },
                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        Mt(
                                          () => import(`./custom-theme-1YuD6i9f.js`),
...
var hf = 8,
  gf = [`default`, `primary`, `danger`, `warning`],
  _f = { default: `${32 / 14}em`, compact: `${24 / 14}em`, none: `auto` },
  vf = { default: _f.default, compact: _f.compact, none: `inherit` },
  yf = { default: `0 ${hf + hf / 4}px`, compact: `0 ${hf + hf / 4}px`, none: `0` },
  bf = { compact: `0 ${hf / 4}px`, default: `0 ${hf / 4}px`, none: `0` },
  xf = { default: `middle`, compact: `middle`, none: `baseline` },
  Sf = { content: `0 ${hf / 4}px`, icon: `0 ${hf / 4}px` },
  Cf = {
  ...
  wf = {
    ...
    "&::after": mf(mf({}, Cf), {}, { content: `""`, borderColor: `var(--ds-border, #0B120E24)` }),
  ...
  Mf = { '&[data-has-overlay="true"]': { cursor: `default`, textDecoration: `none` } };
function Nf(e) {
  var t = e.appearance,
    n = e.spacing,
    r = e.isSelected,
            ...
            mf(
              mf(
                mf(
                  mf(
                    mf(
                      mf(mf({}, t === `default` && wf), t === `primary` && Tf),
                      t === `link` && Ef,
                    ),
                    t === `subtle` && Df,
                  ),
...
var Lf = {
  ...
  Uf = function (e, t) {
    return !e || Rf(e) ? null : t;
  },
  Wf = function (e, t) {
    return Rf(e) ? e : e ? k(`span`, { css: t }, e) : null;
  },
  Gf = V.forwardRef(function (e, t) {
    ...
    return (
      ...
      k(
        ...
        k(
          ...
          m ? k(`span`, { css: [L, Pf({ spacing: A }), Uf(c, Vf)] }, m) : null,
          Wf(c, [L, Ff({ spacing: A })]),
          p ? k(`span`, { css: [L, Pf({ spacing: A }), Uf(c, Hf)] }, p) : null,
          D ? k(`span`, { css: [Lf, ce] }, D) : null,
        ),
      )
    );
  });
...
function Zf(e) {
  return V.createElement(Yf, P({}, e, { appearance: `subtle` }));
}
  ...
  return V.createElement(
    ...
    V.createElement(
      ...
      V.createElement(Xf, {
        ...
        isDisabled: O || A === 0,
        iconBefore: V.createElement(fp, { chevronDirection: `left` }),
        "aria-label": p,
      ...
      V.createElement(Xf, {
        ...
        iconBefore: V.createElement(fp, { chevronDirection: `right` }),
        "aria-label": h,
...
var mp = (0, V.memo)((0, V.forwardRef)(pp));
function hp(e, t, n) {
...
var Sp = `--local-dynamic-table-text-color`,
  Cp = function (e) {
    var t = e.isRanking,
      n = e.testId,
      r = g(e, vp);
  ...
  wp = (0, V.forwardRef)(function (e, t) {
    var n = e.width,
      r = e.children;
    e.isSortable;
    var i = e.sortOrder,
    ...
    var s = e.style,
      ...
      d = xp(
        xp(xp({}, s), n && A({ width: n })),
        {},
        l({}, Sp, `var(--ds-text-subtlest, #6B6E76)`),
      ),
      f = i === `ASC`,
      p = i === j,
      m = function () {
...
var kp = (0, V.createContext)(null),
  Ap = (0, V.createContext)(null);
function jp() {
  return (0, V.useContext)(Ap);
}
function Mp(e) {
  var t = e.isOpen,
    n = e.type,
...
var Np = { none: 0, small: 100, medium: 350, large: 700 },
  Pp = 0.5,
  Fp = { none: Np.none, small: Np.small * Pp, medium: Np.medium * Pp, large: Np.large * Pp },
  Ip = function () {
    return typeof window < `u` && `matchMedia` in window;
  },
  Lp = function () {
    return Ip() ? window.matchMedia(`(prefers-reduced-motion: reduce)`).matches : !1;
  },
  Rp = function (e) {
    switch (e.cleanup) {
      case `next-effect`:
  ...
  Bp = { appear: !0, isExiting: !1 },
  Vp = (0, V.createContext)(Bp),
  Hp = function (e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Bp;
    return V.createElement(Vp.Provider, { key: `${e.key}-provider`, value: t }, e);
  },
  Up = function (e) {
    var t = [];
    return (
  ...
  Wp = function (e, t) {
    for (var n = t.concat([]), r = Gp(t), i = 0; i < e.length; i++) {
      var a = e[i];
...
var Xp = (0, V.createContext)(function () {
    return { isReady: !0, delay: 0, ref: Z };
  }),
  Zp = function () {
    var e = Yp();
    return (0, V.useContext)(Xp)(e);
  };
T();
var Qp = function (e) {
    var t = e.children,
...
var nm = function (e) {
  ...
  im = function (e, t) {
    if (typeof e == `function`) return rm(e, t);
    e != null && (e.current = t);
  },
  am = function (e) {
    return e.reduce(function (e, t) {
  ...
  hm = `popper`,
  gm = `reference`,
  _m = dm.reduce(function (e, t) {
    return e.concat([t + `-` + fm, t + `-end`]);
  }, []),
  vm = [].concat(dm, [um]).reduce(function (e, t) {
    return e.concat([t, t + `-` + fm, t + `-end`]);
  }, []),
  ym = [
    `beforeRead`,
    `read`,
...
function Sm(e) {
  return e instanceof xm(e).Element || e instanceof Element;
}
function Cm(e) {
  return e instanceof xm(e).HTMLElement || e instanceof HTMLElement;
}
function wm(e) {
  return typeof ShadowRoot > `u` ? !1 : e instanceof xm(e).ShadowRoot || e instanceof ShadowRoot;
}
function Tm(e) {
  var t = e.state;
...
function Pm(e, t, n) {
  ...
  t &&
    Cm(e) &&
    ((i = (e.offsetWidth > 0 && jm(r.width) / e.offsetWidth) || 1),
    (a = (e.offsetHeight > 0 && jm(r.height) / e.offsetHeight) || 1));
  var o = (Sm(e) ? xm(e) : window).visualViewport,
    s = !Nm() && n,
...
function Lm(e) {
  return xm(e).getComputedStyle(e);
}
function Rm(e) {
  return [`table`, `td`, `th`].indexOf(bm(e)) >= 0;
}
function zm(e) {
  return ((Sm(e) ? e.ownerDocument : e.document) || window.document).documentElement;
}
function Bm(e) {
  return bm(e) === `html` ? e : e.assignedSlot || e.parentNode || (wm(e) ? e.host : null) || zm(e);
}
function Vm(e) {
  return !Cm(e) || Lm(e).position === `fixed` ? null : e.offsetParent;
}
function Hm(e) {
  var t = /firefox/i.test(Mm());
  if (/Trident/i.test(Mm()) && Cm(e) && Lm(e).position === `fixed`) return null;
  var n = Bm(e);
  for (wm(n) && (n = n.host); Cm(n) && [`html`, `body`].indexOf(bm(n)) < 0; ) {
    var r = Lm(n);
    if (
      r.transform !== `none` ||
      r.perspective !== `none` ||
...
function Um(e) {
  for (var t = xm(e), n = Vm(e); n && Rm(n) && Lm(n).position === `static`; ) n = Vm(n);
  return n && (bm(n) === `html` || (bm(n) === `body` && Lm(n).position === `static`))
    ? t
    : n || Hm(e) || t;
}
function Wm(e) {
...
function Qm(e) {
  ...
  r != null &&
    ((typeof r == `string` && ((r = t.elements.popper.querySelector(r)), !r)) ||
      (Im(t.elements.popper, r) && (t.elements.arrow = r)));
}
var $m = {
  name: `arrow`,
  enabled: !0,
...
function nh(e, t) {
  ...
  return { x: jm(n * i) / i || 0, y: jm(r * i) / i || 0 };
}
function rh(e) {
  var t,
    n = e.popper,
  ...
  var D = Object.assign({ position: s }, l && th),
    O = u === !0 ? nh({ x: p, y: h }, xm(n)) : { x: p, y: h };
  if (((p = O.x), (h = O.y), c)) {
    var k;
...
function ih(e) {
  var t = e.state,
    ...
    c = s === void 0 ? !0 : s,
    l = {
      placement: Om(t.placement),
      variation: eh(t.placement),
...
var ah = { name: `computeStyles`, enabled: !0, phase: `beforeWrite`, fn: ih, data: {} },
  oh = { passive: !0 };
function sh(e) {
  var t = e.state,
    n = e.instance,
    ...
    o = r.resize,
    s = o === void 0 ? !0 : o,
    c = xm(t.elements.popper),
    l = [].concat(t.scrollParents.reference, t.scrollParents.popper);
  return (
    a &&
      l.forEach(function (e) {
        e.addEventListener(`scroll`, n.update, oh);
      }),
    s && c.addEventListener(`resize`, n.update, oh),
    function () {
      (a &&
        l.forEach(function (e) {
          e.removeEventListener(`scroll`, n.update, oh);
        }),
        s && c.removeEventListener(`resize`, n.update, oh));
    }
  );
}
var ch = {
...
function mh(e) {
  return Pm(zm(e)).left + ph(e).scrollLeft;
}
function hh(e, t) {
  var n = xm(e),
    r = zm(e),
  ...
  return { width: a, height: o, x: s + mh(e), y: c };
}
function gh(e) {
  var t = zm(e),
    n = ph(e),
    r = e.ownerDocument?.body,
    i = km(t.scrollWidth, t.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0),
    a = km(t.scrollHeight, t.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0),
    o = -n.scrollLeft + mh(e),
    s = -n.scrollTop;
  return (
    Lm(r || t).direction === `rtl` && (o += km(t.clientWidth, r ? r.clientWidth : 0) - i),
...
function vh(e) {
  return [`html`, `body`, `#document`].indexOf(bm(e)) >= 0
...
function yh(e, t) {
  ...
  var n = vh(e),
    ...
    i = xm(n),
    a = r ? [i].concat(i.visualViewport || [], _h(n) ? n : []) : n,
    o = t.concat(a);
  return r ? o : o.concat(yh(Bm(a)));
}
function bh(e) {
...
function Sh(e, t, n) {
  return t === `viewport` ? bh(hh(e, n)) : Sm(t) ? xh(t, n) : bh(gh(zm(e)));
}
function Ch(e) {
  var t = yh(Bm(e)),
    n = [`absolute`, `fixed`].indexOf(Lm(e).position) >= 0 && Cm(e) ? Um(e) : e;
  return Sm(n)
    ? t.filter(function (e) {
        return Sm(e) && Im(e, n) && bm(e) !== `body`;
      })
    : [];
}
function wh(e, t, n, r) {
  var i = t === `clippingParents` ? Ch(e) : [].concat(t),
    ...
    s = a.reduce(
      function (t, n) {
        var i = Sh(e, n, r);
        return (
          (t.top = km(i.top, t.top)),
          (t.right = Am(i.right, t.right)),
          (t.bottom = Am(i.bottom, t.bottom)),
          (t.left = km(i.left, t.left)),
          t
        );
      },
      Sh(e, o, r),
...
function Eh(e, t) {
  ...
  var n = t,
    ...
    h = n.padding,
    g = h === void 0 ? 0 : h,
    _ = Jm(typeof g == `number` ? Ym(g, dm) : g),
    v = f === `popper` ? gm : hm,
    y = e.rects.popper,
    b = e.elements[m ? v : f],
    x = wh(Sm(b) ? b : b.contextElement || zm(e.elements.popper), c, u, o),
    S = Pm(e.elements.reference),
    C = Th({ reference: S, element: y, strategy: `absolute`, placement: i }),
    w = bh(Object.assign({}, y, C)),
    T = f === `popper` ? w : S,
    E = {
...
function Dh(e, t) {
  ...
  var p = f.reduce(function (t, n) {
    return ((t[n] = Eh(e, { placement: n, boundary: i, rootBoundary: a, padding: o })[Om(n)]), t);
  }, {});
  ...
  if (!t.modifiersData[r]._skip) {
    for (
      ...
      var E = y[T],
        D = Om(E),
        O = eh(E) === fm,
        k = [`top`, sm].indexOf(D) >= 0,
        A = k ? `width` : `height`,
        j = Eh(t, { placement: E, boundary: u, rootBoundary: d, altBoundary: f, padding: l }),
        M = k ? (O ? cm : lm) : O ? sm : `top`;
      b[A] > x[A] && (M = uh(M));
      var ee = uh(M),
        N = [];
      if (
...
function Mh(e) {
  return [`top`, cm, sm, lm].some(function (t) {
    return e[t] >= 0;
  });
}
function Nh(e) {
...
function Ih(e) {
  var t = e.state,
    ...
    i = n.offset,
    a = i === void 0 ? [0, 0] : i,
    o = vm.reduce(function (e, n) {
      return ((e[n] = Fh(n, t.rects, a)), e);
    }, {}),
    s = o[t.placement],
    c = s.x,
    l = s.y;
...
var Lh = { name: `offset`, enabled: !0, phase: `main`, requires: [`popperOffsets`], fn: Ih };
function Rh(e) {
  var t = e.state,
    n = e.name;
...
var zh = { name: `popperOffsets`, enabled: !0, phase: `read`, fn: Rh, data: {} };
function Bh(e) {
  return e === `x` ? `y` : `x`;
}
function Vh(e) {
  var t = e.state,
    ...
    m = n.tetherOffset,
    h = m === void 0 ? 0 : m,
    g = Eh(t, { boundary: c, rootBoundary: l, padding: d, altBoundary: u }),
    _ = Om(t.placement),
    v = eh(t.placement),
    y = !v,
    b = Wm(_),
  ...
  if (S) {
    if (a) {
      var k = b === `y` ? `top` : lm,
        ...
        R = t.elements.arrow && Um(t.elements.arrow),
        ce = R ? (b === `y` ? R.clientTop || 0 : R.clientLeft || 0) : 0,
        le = D?.[b] ?? 0,
        ue = M + I - le - ce,
        de = M + L - le,
        fe = Gm(p ? Am(ee, ue) : ee, M, p ? km(N, de) : N);
      ((S[b] = fe), (O[b] = fe - M));
    }
    if (s) {
      var pe = b === `x` ? `top` : lm,
        ...
        he = z + g[pe],
        ge = z - g[me],
        V = [`top`, lm].indexOf(_) !== -1,
        H = D?.[x] ?? 0,
        _e = V ? he : z - C[B] - w[B] - H + E.altAxis,
        ve = V ? z + C[B] + w[B] - H - E.altAxis : ge,
        ye = p && V ? Km(_e, z, ve) : Gm(p ? _e : he, z, p ? ve : ge);
      ((S[x] = ye), (O[x] = ye - z));
    }
    t.modifiersData[r] = O;
  }
...
function Wh(e) {
  return e === xm(e) || !Cm(e) ? ph(e) : Uh(e);
}
function Gh(e) {
  var t = e.getBoundingClientRect(),
    n = jm(t.width) / e.offsetWidth || 1,
    r = jm(t.height) / e.offsetHeight || 1;
  return n !== 1 || r !== 1;
}
function Kh(e, t, n) {
  n === void 0 && (n = !1);
  ...
  return (
    (r || (!r && !n)) &&
      ((bm(t) !== `body` || _h(a)) && (s = Wh(t)),
      Cm(t) ? ((c = Pm(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : a && (c.x = mh(a))),
    {
...
var Zh = { placement: `bottom`, modifiers: [], strategy: `absolute` };
function Qh() {
      ...
      c = {
        ...
        setOptions: function (n) {
          ...
          (u(),
            ...
            (i.scrollParents = {
              reference: Sm(e) ? yh(e) : e.contextElement ? yh(e.contextElement) : [],
              popper: yh(t),
            }));
          var s = Jh(Xh([].concat(r, i.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!s) {
            ...
            if (Qh(t, n)) {
              ((i.rects = {
                reference: Kh(t, Um(n), i.options.strategy === `fixed`),
                popper: Fm(n),
              }),
                (i.reset = !1),
...
var eg = $h({ defaultModifiers: [ch, zh, ah, Dm, Lh, Ah, Hh, $m, Ph] }),
  tg = e(
    i((e, t) => {
    ...
    var r = V.useRef(null),
      ...
      l = V.useMemo(
        function () {
          ...
          return (0, tg.default)(r.current, e) ? r.current || e : ((r.current = e), e);
        },
...
function pg(e) {
  var t = e.children,
    ...
    y = (0, V.useMemo)(
      function () {
        var e = {
            name: `preventOverflow`,
            options: { padding: lg, rootBoundary: h ? `viewport` : `document` },
          },
          t = { name: `offset`, options: { offset: [_, v] } },
          n = h ? cg({ viewportPadding: lg }) : [];
        return [].concat(ug, [e, t], m(n));
      },
      [_, v, h],
    ),
    b = (0, V.useMemo)(
  ...
  return V.createElement(sg, { modifiers: b, placement: o, strategy: d, referenceElement: c }, n);
}
var mg = `atlaskit-portal-container`,
  hg = `body > .atlaskit-portal-container`,
  gg = `atlaskit-portal`,
  _g = function () {
    return document.body;
  },
  vg = function () {
    var e = document.querySelector(hg);
    if (!e) {
      var t,
  ...
  yg = function (e) {
    e.parentElement || vg().appendChild(e);
  },
  bg = function (e) {
    var t = document.createElement(`div`);
    return ((t.className = gg), (t.style.zIndex = `${e}`), t);
  },
  xg = function () {
    var e = document.querySelector(hg);
    if (!e) {
...
function Cg(e) {
  ...
  return (
    ...
    (0, V.useEffect)(
      function () {
        F(`import_into_jsm_in_template_gallery_killswitch`) && i && Sg(a);
      },
      [i, a],
    ),
    (0, V.useEffect)(
...
var wg = typeof window < `u` ? V.useLayoutEffect : V.useEffect,
  Tg = function () {
        ...
        if (F(`import_into_jsm_in_template_gallery_killswitch`)) {
          if (!r) {
            ...
            return !e || !n
              ...
              : (n.appendChild(e),
                function () {
                  (n && (n.removeChild(e), !n.hasChildNodes() && Ag(n)), o(null));
                });
          }
        } else {
          var i = Eg(t);
...
var Mg = function (e) {
    var t = f((0, V.useState)(!1), 2),
      ...
      i = f(
        (0, V.useState)(function () {
          return e === `layoutEffect` ? wg : V.useEffect;
        }),
        1,
      )[0];
    return (
  ...
  Ig = function (e) {
    return Fg.hasOwnProperty(e) ? Fg[e] : null;
  },
  Lg = function (e, t) {
    var n = { layer: Ig(Number(t)), zIndex: t };
...
function Bg(e) {
  ...
  return (
    ...
    F(`platform_design_system_team_portal_logic_r18_fix`)
      ? V.createElement(jg, { zIndex: n, isClosed: s }, r)
      : c
        ? V.createElement(Cg, { zIndex: n, isClosed: s }, r)
        : null
  );
}
var Vg = {
...
function Wg() {
  Ug ||
    ...
    Array.from(Hg).forEach(function (e) {
      e.onDragStart();
    }));
}
function Gg() {
...
function Kg() {
  return (0, dd.bindAll)(window, [
    { type: `dragstart`, listener: Wg },
    { type: `dragenter`, listener: Wg },
  ]);
}
var qg = null;
function Jg(e) {
  return (
    (qg ||= Kg()),
    Hg.add(e),
    e.onRegister({ isDragging: Ug !== null }),
    function () {
      if ((Hg.delete(e), Hg.size === 0)) {
        var t;
        ((t = qg) == null || t(), (qg = null));
      }
    }
...
var Zg = null;
function Qg() {
  Zg != null && (window.clearTimeout(Zg), (Zg = null));
}
function $g(e, t) {
  (Qg(),
    (Zg = window.setTimeout(function () {
      ((Zg = null), e());
    }, t)));
}
var e_ = null;
function t_(e) {
  ...
  function d() {
    var n = F(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? e.shouldAlwaysFadeIn : !1,
      r = !!(e_ && e_.isVisible()) && !n;
    ((e_ &&= (Qg(), e_.entry.hide({ isImmediate: !0 }), e_.entry.done(), null)),
      (e_ = { entry: e, isVisible: l }));
    function i() {
...
var d_ = Vg.tooltip(),
  f_ = { componentName: `tooltip`, packageName: `@atlaskit/tooltip`, packageVersion: `21.1.4` },
...
function h_(e) {
            ...
            ie
              ? {
                  ...
                  mouse: F(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
                    ? void 0
                    : Yg({ left: e.clientX, top: e.clientY }),
                  clientX: e.clientX,
                  clientY: e.clientY,
                }
              : { type: `keyboard` },
      ...
      ? function (e) {
          ...
          (t = I.current) != null &&
            ...
            (F(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ||
              (I.current.mousePosition = Yg({ left: e.clientX, top: e.clientY })),
  ...
  var Ie = function () {
      ...
      return ie &&
        ...
        le.current &&
        F(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
        ? Xg(I.current.mousePos, { targetElement: le.current, tooltipPosition: r })
        : ie &&
            (t = I.current) != null &&
            t.mousePosition &&
            !F(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
  ...
  return V.createElement(
    ...
    Me
      ? V.createElement(
          Ve,
          null,
          V.createElement(pg, { placement: ae, referenceElement: Ie(), strategy: O }, function (e) {
            var t = e.ref,
              n = e.style,
              r = e.update,
              i = e.placement,
...
var g_ = function (e) {
  var t = e.children;
  return V.createElement(Bg, { zIndex: d_ }, t);
};
T();
var __ = e(Tp()),
  v_ = e(Ep()),
