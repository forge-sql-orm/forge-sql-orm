    ...
    return (
      x.forEach(function (e) {
        ...
        p(
          ...
          a.includes(d) ? (typeof m == `string` ? m : r[m]) : S(d, n),
        ) <= l &&
...
var ce = [1.12, 1.33, 2.03, 2.73, 3.33, 4.27, 5.2, 6.62, 12.46, 14.25],
  ...
  $ = function (e) {
    var t = v(e)[0],
      ...
      c = ue(s, e),
      u = i(s);
    return ((u[c] = e), { ramp: u, replacedColor: s[c] });
  };
function de(e, t, n) {
  for (var r = [], i = 1; i <= t; i++)
  ...
  return (
    (r === `light` || r === `auto`) &&
      ...
      c.push({
        ...
        css: `
html[${u}="${i}"][${d}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${o(l.light, s)}
}`,
      }),
    (r === `dark` || r === `auto`) &&
      ...
      c.push({
        ...
        css: `
html[${u}="${i}"][${d}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${o(l.dark, s)}
}`,
      }),
