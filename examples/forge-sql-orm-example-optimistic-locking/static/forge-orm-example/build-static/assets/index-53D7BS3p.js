  ...
  function e(t) {
    ...
    (p(this, e),
      ...
      h(this, `clone`, function () {
        return new e({ payload: lc({}, n.payload) });
      }),
  ...
  return y(e, [
    {
      ...
      value: function (e) {
        return (
          ...
          g(e) === `object` && (this.payload = lc(lc({}, this.payload), e)),
          this
        );
      },
    },
...
function pc(e, t, n) {
  return ((t = d(t)), f(e, mc() ? Reflect.construct(t, n || [], d(e).constructor) : t.apply(e, n)));
}
function mc() {
  try {
...
function hc(e, t, n, r) {
  var i = fc(d(1 & r ? e.prototype : e), t, n);
    ...
    y(t, [
      {
        key: `update`,
        value: function (e) {
          return this.hasFired ? this : hc(t, `update`, this, 3)([e]);
        },
      },
    ])
  );
...
var Vc = `@all-features`,
  Hc = (function () {
    function e() {
      (p(this, e), h(this, `eventToValue`, new Map()), (this.emitter = new Rc.default()));
    }
    return y(e, [
      {
        key: `onGateUpdated`,
        value: function (e, t, n, r) {
          var i = this,
            a = n(e, Bc(Bc({}, r), {}, { fireGateExposure: !1 }));
          this.eventToValue.get(t) === void 0 && this.eventToValue.set(t, a);
          var o = function () {
            var a = n(e, Bc(Bc({}, r), {}, { fireGateExposure: !1 }));
      ...
      },
      {
        ...
        value: function (e, t, n, r, i, a) {
          var o = this,
            s = `${e}.${t}`,
            c = i(e, t, n, Bc(Bc({}, a), {}, { fireExperimentExposure: !1 }));
          this.eventToValue.get(r) === void 0 && this.eventToValue.set(r, c);
          var l = function () {
            var s = i(e, t, n, Bc(Bc({}, a), {}, { fireExperimentExposure: !1 }));
...
var Gc = {
  ...
  Kc = { Development: `development`, Staging: `staging`, Production: `production` },
...
var Zc = function (e) {
    return Xc({ perimeter: Wc() ? qc.FEDRAMP_MODERATE : qc.COMMERCIAL }, e);
  },
  Qc = function (e, t) {
    if (!e && !t) return !0;
    if (!e || !t) return !1;
...
function el(e) {
  ...
  var n = t.shift();
  if (n == null) return el.apply(void 0, [e].concat(_(t)));
  for (var r = 0, i = Object.entries(n); r < i.length; r++) {
    ...
    u && d ? (e[o] = el(c, s)) : (e[o] = s);
  }
  return el.apply(void 0, [e].concat(_(t)));
}
var tl = function (e) {
    var t = e.api,
  ...
  nl = Object.entries(Gc).map(function (e) {
    var t = l(e, 2),
      n = t[0],
      r = t[1];
      ...
      [
        {
          ...
          value: function (t) {
            var n = new e(
              ...
              t.ruleID,
              rl(t.details),
              il(t.__evaluation?.secondary_exposures ?? []),
              t.groupName ?? void 0,
            );
      ...
      [
        {
          ...
          value: function (t) {
            return new e(
              ...
              il(t.__evaluation?.secondary_exposures ?? []),
              il(t.__evaluation?.undelegated_secondary_exposures ?? []),
...
var pl = 5e3,
  ml = `https://api.atlassian.com/flags`,
  hl = `https://api.stg.atlassian.com/flags`,
  gl = `https://api.dev.atlassian.com/flags`,
  _l = `https://api.stg.atlassian-us-gov-mod.com/flags`,
  vl = `https://api.atlassian-us-gov-mod.com/flags`,
  yl = `https://atlassian-statsig-proxy-archetype.atl-paas.%s.atl-ic.net`,
  bl = `oasis-stg.com/flags`,
  xl = `atlassian-isolated.net/flags`,
  Sl = `/gateway/api/flags`,
  Cl = (function () {
    function e() {
      p(this, e);
    }
    return y(e, null, [
      ...
      },
      {
        ...
        value: function (e) {
          ...
          if (t === void 0) return e ? yl.replace(`%s`, e) : null;
          var n = t.protocol,
            r = t.hostname,
            i = r.match(/([^.]+)\.oasis-stg\.com$/);
          if (i) return `${n}//api.${i[1]}.${bl}`;
          var a = r.match(/([^.]+)\.atlassian-isolated\.net$/);
          return a ? `${n}//api.${a[1]}.${xl}` : null;
        },
      },
      {
...
function Dl(e, t, n) {
  return ((t = d(t)), f(e, Ol() ? Reflect.construct(t, n || [], d(e).constructor) : t.apply(e, n)));
}
function Ol() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Al = (function (e) {
    function t() {
      ...
      return (
        p(this, t),
        (e = Dl(this, t, [`NoFetchDataAdapter`, `nofetch`])),
      ...
      y(t, [
          ...
          value: function (e) {
            this.bootstrapResult = e
              ? {
                  ...
                  receivedAt: Date.now(),
                  stableID: wl.StableID.get(this._getSdkKey()),
                  fullUserHash: null,
                }
              : null;
          },
                        ...
                        case 0:
                          return e.abrupt(
                            ...
                            this.bootstrapResult &&
                              El(
                                El({}, this.bootstrapResult),
                                {},
                                { fullUserHash: (0, wl._getFullUserHash)(n) },
                              ),
                          );
                        case 1:
                        case `end`:
        ...
        },
        {
          ...
          value: function (e) {
            return (
              this.bootstrapResult &&
              El(El({}, this.bootstrapResult), {}, { fullUserHash: (0, wl._getFullUserHash)(e) })
            );
          },
        },
        {
        ...
        },
        {
          key: `_getCacheKey`,
          value: function (e) {
            var t = (0, wl._getStorageKey)(this._getSdkKey(), e);
            return `${wl.DataAdapterCachePrefix}.${this._cacheSuffix}.${t}`;
          },
        },
        {
...
function Pl(e, t) {
  var n = (typeof Symbol < `u` && e[Symbol.iterator]) || e[`@@iterator`];
  if (!n) {
    if (Array.isArray(e) || (n = Fl(e)) || (t && e && typeof e.length == `number`)) {
      n && (e = n);
      var r = 0,
        i = function () {};
      return {
...
var Ll = `LocalOverride:Recognized`,
  Rl = `STATSIG_OVERRIDES`,
  zl = `STATSIG_JS_LITE_LOCAL_OVERRIDES`,
  Bl = function () {
  ...
  Hl = (function () {
    ...
    return y(e, [
      ...
      },
      {
        key: `mergeOverrides`,
        value: function () {
          for (var e = Bl(), t = [...arguments], n = 0, r = t; n < r.length; n++) {
      ...
      },
      {
        ...
        value: function () {
          var e = this.mergeOverrides(
            this._overrides,
            this.parseStoredOverrides(zl),
            this.parseStoredOverrides(this._localStorageKey),
          );
          try {
            window.localStorage.removeItem(zl);
          } catch {}
          ...
          for (var n = 0, r = Object.entries(t); n < r.length; n++)
            for (
              ...
              var u = l(c[s], 2),
                d = u[0],
                f = u[1];
              this._djb2Map.set(Vl((0, jl._DJB2)(d), a), f);
            }
          this._overrides = t;
        },
      },
      ...
      },
      {
        ...
        value: function (e, t) {
          ((this._overrides.gates[e] = t),
            this._djb2Map.set(Vl((0, jl._DJB2)(e), `gates`), t),
            this.saveOverrides());
        },
      },
      {
        ...
        value: function (e) {
          (delete this._overrides.gates[e],
            this._djb2Map.delete(Vl((0, jl._DJB2)(e), `gates`)),
            this.saveOverrides());
        },
      },
      {
        key: `getGateOverride`,
        value: function (e, t) {
          var n = this._overrides.gates[e.name] ?? this._djb2Map.get(Vl(e.name, `gates`));
          return n == null
            ? null
            : Nl(Nl({}, e), {}, { value: n, details: Nl(Nl({}, e.details), {}, { reason: Ll }) });
        },
      },
      {
        ...
        value: function (e, t) {
          ((this._overrides.configs[e] = t),
            this._djb2Map.set(Vl((0, jl._DJB2)(e), `configs`), t),
            this.saveOverrides());
        },
      },
      {
        ...
        value: function (e) {
          (delete this._overrides.configs[e],
            this._djb2Map.delete(Vl((0, jl._DJB2)(e), `configs`)),
            this.saveOverrides());
        },
      },
      {
      ...
      },
      {
        ...
        value: function (e, t) {
          ((this._overrides.layers[e] = t),
            this._djb2Map.set(Vl((0, jl._DJB2)(e), `layers`), t),
            this.saveOverrides());
        },
      },
      {
        ...
        value: function (e) {
          (delete this._overrides.layers[e],
            this._djb2Map.delete(Vl((0, jl._DJB2)(e), `layers`)),
            this.saveOverrides());
        },
      },
      {
      ...
      },
      {
        ...
        value: function (e, t) {
          var n = this._overrides.layers[e.name] ?? this._djb2Map.get(Vl(e.name, `layers`));
          return n == null
            ? null
            : Nl(
                Nl({}, e),
                {},
                {
                  ...
                  details: Nl(Nl({}, e.details), {}, { reason: Ll }),
                },
              );
        },
      },
      {
        ...
        value: function (e, t) {
          var n = t[e.name] ?? this._djb2Map.get(Vl(e.name, `configs`));
          return n == null
            ? null
            : Nl(
                Nl({}, e),
  ...
  Ul = [`sdkKey`, `environment`, `updateUserCompletionCallback`, `perimeter`];
function Wl(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var r = Object.getOwnPropertySymbols(e);
  ...
  Jl = (function () {
    function e() {
      ...
      (p(this, e),
        ...
        h(this, `subscriptions`, new Hc()),
        h(this, `dataAdapter`, new Al()),
        h(this, `statsigValuesUpdated`, function () {
          (t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated());
        }),
        (this.overrideAdapter = a || new Hl(i)));
    }
    return y(e, [
      {
        key: `initialize`,
              ...
              return W.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((a = Zc(t)), !this.initPromise)) {
                          e.next = 4;
                          break;
                        }
                        return (
                          Qc(a, this.initOptions) ||
                            console.warn(
              ...
              return W.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((o = Zc(t)), !this.initPromise)) {
                          e.next = 4;
                          break;
                        }
                        return (
                          Qc(o, this.initOptions) ||
                            console.warn(
                              `Feature Gates client already initialized with different options. New options were not applied.`,
                            ),
                          e.abrupt(`return`, this.initPromise)
                      ...
                      case 4:
                        return (
                          ...
                          (this.initOptions = o),
                          (this.provider = n),
                          this.provider.setClientVersion(sl),
        ...
        value: function (e, t, n, r) {
          ...
          (i = this.initOptions.analyticsWebClient) == null ||
            i
              ...
              .catch(function (e) {
                a.initOptions.environment !== Kc.Production &&
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (i = Zc(t)),
                          (a = function () {
                            return Cl.fetchExperimentValues(i, n, r).then(function (e) {
                              return {
          ...
          try {
            ...
            return (
              (this.hasGetExperimentErrorOccurred ||=
                ...
                !0)),
              new al(e, {}, ``, { time: Date.now(), reason: Gc.Error })
            );
          }
        },
      },
      ...
      },
      {
        key: `isCurrentUser`,
        value: function (e, t) {
          return Qc(this.currentIdentifiers, e) && Qc(this.currentAttributes, t);
        },
      },
      {
        key: `onGateUpdated`,
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 5:
                        return (
                          (e.prev = 5),
                          (s = Cl.fetchClientSdk(t).then(function (e) {
                            return (i.sdkKey = e.clientSdkKey);
                          })),
                          (c = Cl.fetchExperimentValues(t, n, r)),
                          (e.next = 10),
                          Promise.all([s, c])
                        );
                      case 10:
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (a = Gl(Gl({}, t), {}, { disableCurrentPageLogging: !0 })),
                          (e.prev = 1),
                          (e.next = 4),
                          n.setProfile(t, r, i)
                        );
                    ...
                    switch ((e.prev = e.next)) {
                        ...
                        return (
                          ...
                          (d = Gl(
                            ...
                            {},
                            {
                              ...
                              logEventCompressionMode: wl.LogEventCompressionMode.Forced,
                            },
                          )),
                          n.stableId
                            ? wl.StableID.setOverride(n.stableId, s)
                            : (d.disableStableID = !0),
                          (e.prev = 13),
                          (this.statsigClient = new wl.StatsigClient(s, this.user, d)),
                      ...
                      case 20:
                        return (
                          ...
                          (this.statsigClient = new wl.StatsigClient(Kl, this.user, d)),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        ((o = e.sent),
                          (c = $c(n, o.customAttributesFromFetch)),
                          (s = el({}, o.experimentValues.user, c)),
                          (e.next = 14));
                        break;
                      case 9:
                        throw (
        ...
        value: function (e) {
          ...
          try {
            ...
            var n = t.fireLayerExposure,
              r = n === void 0 ? !0 : n;
            return ol.fromLayer(this.statsigClient.getLayer(e, { disableExposureLog: !r }));
          } catch (t) {
            return (
              (this.hasGetLayerErrorOccurred ||=
                ...
                !0)),
              ol.fromLayer((0, wl._makeLayer)(e, { reason: `Error` }, null))
            );
          }
        },
      },
...
if (typeof window < `u`)
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = K;
    ...
    var Xl, Zl;
    Yl = window.__FEATUREGATES_JS__;
    var Ql =
      ((Xl = Yl) == null || (Zl = Xl.getPackageVersion) == null ? void 0 : Zl.call(Xl)) ||
      `4.10.0 or earlier`;
    if (Ql !== `0.0.0-development`) {
      var $l = `Multiple versions of FeatureGateClients found on the current page.
      The currently bound version is ${Ql} when module version ${sl} was loading.`;
      console.warn($l);
    }
  }
var eu = Yl,
  ...
  ru =
    (globalThis == null || (tu = globalThis.process) == null || (tu = tu.env) == null
      ? void 0
      : tu.JEST_WORKER_ID) === void 0 &&
    (globalThis == null || (nu = globalThis.process) == null || (nu = nu.env) == null
      ? void 0
      : nu.NODE_ENV) !== `production`,
  iu = function () {
    var e;
    ru && (e = console).debug.apply(e, arguments);
  },
  au = `@atlaskit/platform-feature-flags`,
  ou = `__PLATFORM_FEATURE_FLAGS__`,
  su = typeof process < `u` && !0,
  cu = su ? {}.ENABLE_PLATFORM_FF === `true` : !1,
  lu = su ? {}.STORYBOOK_ENABLE_PLATFORM_FF === `true` : !1,
  uu = cu || lu,
  du = { booleanResolver: void 0 },
  fu = typeof window < `u` ? window : globalThis;
fu[ou] = fu.__PLATFORM_FEATURE_FLAGS__ || du;
function pu(e) {
  if (uu)
    return (
      iu(
  ...
  try {
    if (
      fu.__PLATFORM_FEATURE_FLAGS__?.booleanResolver === void 0 ||
      fu.__PLATFORM_FEATURE_FLAGS__?.booleanResolver === null
    )
      return eu.checkGate(e);
    var t = fu.__PLATFORM_FEATURE_FLAGS__?.booleanResolver(e);
...
var ud = (function (e) {
  ...
  dd = Qu(
    T.forwardRef(function (e, t) {
      return T.createElement(ud, H({}, e, { forwardedRef: t }));
    }),
  );
function fd(e, t, n) {
...
var Hf = [`as`, `children`, `isInset`, `testId`, `style`, `xcss`],
  ...
  Jf = (0, T.forwardRef)(function (e, t) {
    ...
    return T.createElement(
      Wf,
      H({ as: `button`, tabIndex: h ?? (Vf() && !r ? 0 : void 0), style: d }, y, {
        type: a,
        onClick: v,
        disabled: r,
...
function nm(e) {
  ...
  return (
    ...
    function () {
      (Zp.unbind(), q(`platform_increased-contrast-themes`) && tm.unbind());
    }
  );
}
function rm(e, t) {
                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        ct(
                                          () => import(`./custom-theme-BaXWjAJM.js`),
                                          __vite__mapDeps([2, 3]),
                                          import.meta.url,
                                        )
                                      );
      ...
      T.createElement(
        ...
        T.createElement(
          ...
          T.createElement(
            bm.Provider,
            { value: _ },
            S ? t : T.createElement(`div`, H({}, C, { className: J([Nm.body]) }), t),
          ),
        ),
      ),
    ),
    ...
    return (
      ...
      Ag(
        ...
        Ag(
          ...
          h ? Ag(`span`, { css: [M, Zg({ spacing: ee }), i_(c, n_)] }, h) : null,
          a_(c, [M, Yg({ spacing: ee })]),
          p ? Ag(`span`, { css: [M, Zg({ spacing: ee }), i_(c, r_)] }, p) : null,
          O ? Ag(`span`, { css: [$g, fe] }, O) : null,
        ),
      )
    );
  });
...
function M_(e) {
  return T.createElement(A_, H({}, e, { appearance: `subtle` }));
}
...
var Iv = function (e) {
  ...
  Rv = function (e, t) {
    if (typeof e == `function`) return Lv(e, t);
    e != null && (e.current = t);
  },
  zv = function (e) {
    return e.reduce(function (e, t) {
  ...
  Yv = `popper`,
  Xv = `reference`,
  Zv = Gv.reduce(function (e, t) {
    return e.concat([t + `-` + Kv, t + `-end`]);
  }, []),
  Qv = [].concat(Gv, [Wv]).reduce(function (e, t) {
    return e.concat([t, t + `-` + Kv, t + `-end`]);
  }, []),
  $v = [
    `beforeRead`,
    `read`,
...
function my(e, t, n) {
  ...
  var o = (ny(e) ? ty(e) : window).visualViewport,
    s = !py() && n,
...
function vy(e) {
  return [`table`, `td`, `th`].indexOf(ey(e)) >= 0;
}
function yy(e) {
  return ((ny(e) ? e.ownerDocument : e.document) || window.document).documentElement;
}
function by(e) {
  return ey(e) === `html` ? e : e.assignedSlot || e.parentNode || (iy(e) ? e.host : null) || yy(e);
}
function xy(e) {
  return !ry(e) || _y(e).position === `fixed` ? null : e.offsetParent;
}
function Sy(e) {
  var t = /firefox/i.test(fy());
  if (/Trident/i.test(fy()) && ry(e) && _y(e).position === `fixed`) return null;
  var n = by(e);
  for (iy(n) && (n = n.host); ry(n) && [`html`, `body`].indexOf(ey(n)) < 0; ) {
    var r = _y(n);
    if (
      r.transform !== `none` ||
      r.perspective !== `none` ||
...
function Cy(e) {
  for (var t = ty(e), n = xy(e); n && vy(n) && _y(n).position === `static`; ) n = xy(n);
  return n && (ey(n) === `html` || (ey(n) === `body` && _y(n).position === `static`))
    ? t
    : n || Sy(e) || t;
}
function wy(e) {
...
function My(e) {
  ...
  r != null &&
    ((typeof r == `string` && ((r = t.elements.popper.querySelector(r)), !r)) ||
      (gy(t.elements.popper, r) && (t.elements.arrow = r)));
}
var Ny = {
  name: `arrow`,
  enabled: !0,
...
function Ly(e) {
  ...
  var D = Object.assign({ position: s }, l && Fy),
    O = u === !0 ? Iy({ x: p, y: h }, ty(n)) : { x: p, y: h };
  if (((p = O.x), (h = O.y), c)) {
    var k;
...
var zy = { name: `computeStyles`, enabled: !0, phase: `beforeWrite`, fn: Ry, data: {} },
  By = { passive: !0 };
function Vy(e) {
  var t = e.state,
    n = e.instance,
  ...
  return (
    ...
    s && c.addEventListener(`resize`, n.update, By),
    function () {
      (a &&
        l.forEach(function (e) {
          e.removeEventListener(`scroll`, n.update, By);
        }),
        s && c.removeEventListener(`resize`, n.update, By));
    }
  );
}
var Hy = {
...
function Jy(e) {
  return my(yy(e)).left + qy(e).scrollLeft;
}
function Yy(e, t) {
  var n = ty(e),
    r = yy(e),
  ...
  return { width: a, height: o, x: s + Jy(e), y: c };
}
function Xy(e) {
  var t = yy(e),
    n = qy(e),
    r = e.ownerDocument?.body,
    i = ly(t.scrollWidth, t.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0),
    a = ly(t.scrollHeight, t.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0),
    o = -n.scrollLeft + Jy(e),
    s = -n.scrollTop;
  return (
    _y(r || t).direction === `rtl` && (o += ly(t.clientWidth, r ? r.clientWidth : 0) - i),
...
function Qy(e) {
  return [`html`, `body`, `#document`].indexOf(ey(e)) >= 0
...
function $y(e, t) {
  ...
  var n = Qy(e),
    ...
    i = ty(n),
    a = r ? [i].concat(i.visualViewport || [], Zy(n) ? n : []) : n,
    o = t.concat(a);
  return r ? o : o.concat($y(by(a)));
}
function eb(e) {
...
function nb(e, t, n) {
  return t === `viewport` ? eb(Yy(e, n)) : ny(t) ? tb(t, n) : eb(Xy(yy(e)));
}
function rb(e) {
  var t = $y(by(e)),
    n = [`absolute`, `fixed`].indexOf(_y(e).position) >= 0 && ry(e) ? Cy(e) : e;
  return ny(n)
    ? t.filter(function (e) {
        return ny(e) && gy(e, n) && ey(e) !== `body`;
      })
    : [];
}
function ib(e, t, n, r) {
  var i = t === `clippingParents` ? rb(e) : [].concat(t),
    a = [].concat(i, [n]),
    o = a[0],
    s = a.reduce(
      function (t, n) {
        var i = nb(e, n, r);
        return (
          (t.top = ly(i.top, t.top)),
          (t.right = uy(i.right, t.right)),
          (t.bottom = uy(i.bottom, t.bottom)),
          (t.left = ly(i.left, t.left)),
          t
        );
      },
      nb(e, o, r),
...
function ob(e, t) {
  ...
  var n = t,
    ...
    h = n.padding,
    g = h === void 0 ? 0 : h,
    _ = Oy(typeof g == `number` ? ky(g, Gv) : g),
    v = f === `popper` ? Xv : Yv,
    y = e.rects.popper,
    b = e.elements[m ? v : f],
    x = ib(ny(b) ? b : b.contextElement || yy(e.elements.popper), c, u, o),
    S = my(e.elements.reference),
    C = ab({ reference: S, element: y, strategy: `absolute`, placement: i }),
    w = eb(Object.assign({}, y, C)),
    T = f === `popper` ? w : S,
    E = {
...
function sb(e, t) {
  ...
  var p = f.reduce(function (t, n) {
    return ((t[n] = ob(e, { placement: n, boundary: i, rootBoundary: a, padding: o })[cy(n)]), t);
  }, {});
  ...
  if (!t.modifiersData[r]._skip) {
    for (
      ...
      var E = y[T],
        D = cy(E),
        O = Py(E) === Kv,
        k = [`top`, Vv].indexOf(D) >= 0,
        ee = k ? `width` : `height`,
        A = ob(t, { placement: E, boundary: u, rootBoundary: d, altBoundary: f, padding: l }),
        j = k ? (O ? Hv : Uv) : O ? Vv : `top`;
      b[ee] > x[ee] && (j = Wy(j));
      var te = Wy(j),
        ne = [];
      if (
...
function fb(e) {
  return [`top`, Hv, Vv, Uv].some(function (t) {
    return e[t] >= 0;
  });
}
function pb(e) {
  var t = e.state,
    ...
    o = ob(t, { elementContext: `reference` }),
    s = ob(t, { altBoundary: !0 }),
    c = db(o, r),
    l = db(s, i, a),
    u = fb(c),
    d = fb(l);
...
var _b = { name: `offset`, enabled: !0, phase: `main`, requires: [`popperOffsets`], fn: gb };
function vb(e) {
  var t = e.state,
    n = e.name;
...
var yb = { name: `popperOffsets`, enabled: !0, phase: `read`, fn: vb, data: {} };
function bb(e) {
  return e === `x` ? `y` : `x`;
}
function xb(e) {
  var t = e.state,
    ...
    m = n.tetherOffset,
    h = m === void 0 ? 0 : m,
    g = ob(t, { boundary: c, rootBoundary: l, padding: d, altBoundary: u }),
    _ = cy(t.placement),
    v = Py(t.placement),
    y = !v,
    b = wy(_),
  ...
  if (S) {
    if (a) {
      var k = b === `y` ? `top` : Uv,
        ...
        ae = v === `start` ? -w[A] : -C[A],
        oe = t.elements.arrow,
        se = p && oe ? hy(oe) : { width: 0, height: 0 },
        ...
        ge = j + de - he - me,
        _e = j + fe - he,
        ve = Ty(p ? uy(te, ge) : te, j, p ? ly(ne, _e) : ne);
      ((S[b] = ve), (O[b] = ve - j));
    }
    if (s) {
      var ye = b === `x` ? `top` : Uv,
...
function Eb(e, t, n) {
  ...
  return (
    (r || (!r && !n)) &&
      ((ey(t) !== `body` || Zy(a)) && (s = wb(t)),
      ry(t) ? ((c = my(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : a && (c.x = Jy(a))),
    {
      ...
      c = {
        ...
        setOptions: function (n) {
          ...
          (u(),
            ...
            (i.scrollParents = {
              reference: ny(e) ? $y(e) : e.contextElement ? $y(e.contextElement) : [],
              popper: $y(t),
            }));
          var s = Ob(Ab([].concat(r, i.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!s) {
            ...
            if (Mb(t, n)) {
              ((i.rects = {
                reference: Eb(t, Cy(n), i.options.strategy === `fixed`),
                popper: hy(n),
              }),
                (i.reset = !1),
...
var Pb = Nb({ defaultModifiers: [Hy, yb, zy, sy, _b, ub, Sb, Ny, mb] }),
  Fb = e(
    i((e, t) => {
    ...
    var r = T.useRef(null),
      ...
      l = T.useMemo(
        function () {
          ...
          return (0, Fb.default)(r.current, e) ? r.current || e : ((r.current = e), e);
        },
...
function qb(e) {
  var t = e.children,
    ...
    y = (0, T.useMemo)(
      function () {
        var e = {
            name: `preventOverflow`,
            options: { padding: Ub, rootBoundary: m ? `viewport` : `document` },
          },
          t = { name: `offset`, options: { offset: [g, v] } },
          n = m ? Hb({ viewportPadding: Ub }) : [];
        return [].concat(Wb, [e, t], _(n));
      },
      [g, v, m],
    ),
    b = (0, T.useMemo)(
  ...
  return T.createElement(Vb, { modifiers: b, placement: o, strategy: f, referenceElement: c }, n);
}
var Jb = `atlaskit-portal-container`,
  Yb = `body > .atlaskit-portal-container`,
  Xb = `atlaskit-portal`,
  Zb = function () {
    return document.body;
  },
  Qb = function () {
    var e = document.querySelector(Yb);
    if (!e) {
      var t,
  ...
  ex = function (e) {
    ...
    return ((t.className = Xb), (t.style.zIndex = `${e}`), t);
  },
  tx = function () {
    var e = document.querySelector(Yb);
    if (!e) {
...
function rx(e) {
  ...
  return (
    ...
    (0, T.useEffect)(
      function () {
        q(`import_into_jsm_in_template_gallery_killswitch`) && i && nx(a);
      },
      [i, a],
    ),
    (0, T.useEffect)(
    ...
    (0, ss.createPortal)(o ? T.createElement(Pm, { defaultColorMode: o }, n) : n, a)
  );
}
var ix = typeof window < `u` ? T.useLayoutEffect : T.useEffect,
  ax = function () {
        ...
        if (q(`import_into_jsm_in_template_gallery_killswitch`)) {
          if (!r) {
            ...
            return !e || !n
              ...
              : (n.appendChild(e),
                function () {
                  (n && (n.removeChild(e), !n.hasChildNodes() && ux(n)), o(null));
                });
          }
        } else {
          var i = ox(t);
...
var fx = function (e) {
    var t = l((0, T.useState)(!1), 2),
      ...
      i = l(
        (0, T.useState)(function () {
          return e === `layoutEffect` ? ix : T.useEffect;
        }),
        1,
      )[0];
    return (
  ...
  gx = function (e) {
    return hx.hasOwnProperty(e) ? hx[e] : null;
  },
  _x = function (e, t) {
    var n = { layer: gx(Number(t)), zIndex: t };
...
function bx(e) {
  ...
  return (
    ...
    q(`platform_design_system_team_portal_logic_r18_fix`)
      ? T.createElement(dx, { zIndex: n, isClosed: s }, r)
      : c
        ? T.createElement(rx, { zIndex: n, isClosed: s }, r)
        : null
  );
}
var xx = {
...
function wx() {
  Cx ||
    ((Cx = (0, qp.bindAll)(window, [
      { type: `dragend`, listener: Tx },
      { type: `pointerdown`, listener: Tx },
      {
        type: `pointermove`,
        listener: (function () {
          var e = 0;
...
var Gx = xx.tooltip(),
  Kx = { componentName: `tooltip`, packageName: `@atlaskit/tooltip`, packageVersion: `21.1.6` },
...
function Yx(e) {
  var t = e.children,
    ...
    ce = se ? a : r,
    le = Eu(Wx({ fn: v, action: `displayed`, analyticsData: D }, Kx)),
    ue = Eu(Wx({ fn: b, action: `hidden`, analyticsData: D }, Kx)),
    M = (0, T.useRef)(null),
            ...
            se
              ? {
                  ...
                  mouse: q(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
                    ? void 0
                    : kx({ left: e.clientX, top: e.clientY }),
                  clientX: e.clientX,
                  clientY: e.clientY,
                }
              : { type: `keyboard` },
      ...
      ? function (e) {
          ...
          (t = M.current) != null &&
            ...
            (q(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ||
              (M.current.mousePosition = kx({ left: e.clientX, top: e.clientY })),
  ...
  var Ve = function () {
      ...
      return se &&
        ...
        me.current &&
        q(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
        ? Ax(M.current.mousePos, { targetElement: me.current, tooltipPosition: r })
        : se &&
            (t = M.current) != null &&
            t.mousePosition &&
            !q(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
  ...
  var Ge = Re
      ...
      : null,
    Ke = oe && q(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? T.Fragment : Xx;
  return T.createElement(
    T.Fragment,
    null,
    typeof t == `function`
    ...
    Le
      ? T.createElement(
          Ke,
          null,
          T.createElement(qb, { placement: ce, referenceElement: Ve(), strategy: k }, function (e) {
            var t = e.ref,
              n = e.style,
              r = e.update,
              i = e.placement,
...
var Xx = function (e) {
  var t = e.children;
  return T.createElement(bx, { zIndex: Gx }, t);
};
Y();
var Zx = [
  `width`,
...
var yS = function (e) {
    ...
    var de = function (e) {
      ...
      he = function () {
        return re || (Mu(i || [], w, v).length > 2 ? Au : ku);
      },
      ge = function () {
    ...
    return T.createElement(
      ...
      !xe &&
        Ce &&
        T.createElement(kd, { isLoading: m, spinnerSize: `large`, testId: u, loadingLabel: s }, Ce),
    );
  },
  bS = (0, T.lazy)(function () {
    return ct(
      () => import(`./body-obiuuuwd.js`),
  ...
  xS = (0, T.forwardRef)(function (e, t) {
    ...
    var h = T.createElement(dd, H({ ref: t }, c));
    return u && f
      ? T.createElement(
          md,
          { fallback: h },
...
var LS =
  ...
  JS = T.forwardRef(function (e, t) {
    var n = e.appearance,
      ...
      F = je || c,
      Me = u && !je;
    (Ig(Te, i), we.className, we.css, we.as, we.style);
    var Ne = m(we, RS);
    return T.createElement(
      Jf,
      H(
      ...
      T.createElement(
        ...
        c && (E || !w) && T.createElement(Lm, { id: De }, zS),
      ),
    );
  });
Y();
