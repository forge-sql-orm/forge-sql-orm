...
import { t as p } from "./client-core-vendor-BFJ-FBHn.js";
function m(e, t) {
...
var T = e(ae()),
  ...
  O = { Development: `development`, Staging: `staging`, Production: `production` },
  k = { COMMERCIAL: `commercial`, FEDRAMP_MODERATE: `fedramp-moderate` },
  be = [
    `api`,
...
var j = function (e) {
    return A({ perimeter: ye() ? k.FEDRAMP_MODERATE : k.COMMERCIAL }, e);
  },
  M = function (e, t) {
    if (!e && !t) return !0;
    if (!e || !t) return !1;
  ...
  I = (function () {
    ...
    return u(e, null, [
      ...
      },
      {
        ...
        value: (function () {
          var t = _(
            T.default.mark(function t(n, r, i, a) {
              var o, s, c, l, u;
              return T.default.wrap(
                function (t) {
                  for (;;)
    ...
    return (
      ...
      u(t, [
          ...
          value: function (e) {
            this.bootstrapResult = e
              ? {
                  ...
                  receivedAt: Date.now(),
                  stableID: E.StableID.get(this._getSdkKey()),
                  fullUserHash: null,
                }
              : null;
          },
        ...
        },
        {
          key: `_getCacheKey`,
          value: function (e) {
            var t = (0, E._getStorageKey)(this._getSdkKey(), e);
            return `${E.DataAdapterCachePrefix}.${this._cacheSuffix}.${t}`;
          },
        },
        {
...
var Qe = `LocalOverride:Recognized`,
  ...
  nt = [`sdkKey`, `environment`, `updateUserCompletionCallback`, `perimeter`];
function rt(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var r = Object.getOwnPropertySymbols(e);
...
var it = `client-default-key`,
  at = `https://xp.atlassian.com/v1/rgstr`,
  ot = (function () {
    function e() {
      var t = this,
    ...
    return u(e, [
              ...
              return T.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((a = j(t)), !this.initPromise)) {
                          e.next = 4;
                          break;
                        }
                        return (
                          M(a, this.initOptions) ||
                            console.warn(
              ...
              return T.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((o = j(t)), !this.initPromise)) {
                          e.next = 4;
                          break;
                        }
                        return (
                          M(o, this.initOptions) ||
                            console.warn(
                              `Feature Gates client already initialized with different options. New options were not applied.`,
                            ),
                          e.abrupt(`return`, this.initPromise)
        ...
        value: function (e, t, n, r) {
          ...
          (i = this.initOptions.analyticsWebClient) == null ||
            i
              ...
              .catch(function (e) {
                a.initOptions.environment !== O.Production &&
      ...
      },
      {
        key: `isCurrentUser`,
        value: function (e, t) {
          return M(this.currentIdentifiers, e) && M(this.currentAttributes, t);
        },
      },
      {
        key: `onGateUpdated`,
                    ...
                    switch ((e.prev = e.next)) {
                        ...
                        return (
                          ...
                          (f = H(
                            ...
                            {},
                            {
                              ...
                              logEventCompressionMode: E.LogEventCompressionMode.Forced,
                            },
                          )),
                          n.stableId
                      ...
                      case 20:
                        return (
                          ...
                          (this.statsigClient = new E.StatsigClient(it, this.user, f)),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        ((o = e.sent),
                          (c = Se(n, o.customAttributesFromFetch)),
                          (s = N({}, o.experimentValues.user, c)),
                          (e.next = 14));
                        break;
                      case 9:
                        throw (
...
((U = W),
  ...
  s(W, `checkGate`, function (e, t) {
    try {
      ...
      U.hasCheckGateErrorOccurred ||
        (console.warn({
          msg: `An error has occurred checking the feature gate from criterion override. Only the first occurrence of this error is logged.`,
          gateName: e,
          error: t,
        }),
        (U.hasCheckGateErrorOccurred = !0));
    }
  ...
  s(W, `getExperimentValue`, function (e, t, n, r) {
    try {
      ...
      return (
        U.hasGetExperimentValueErrorOccurred ||
          (console.warn({
          ...
          (U.hasGetExperimentValueErrorOccurred = !0)),
        n
      );
    }
...
if (typeof window < `u`)
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = W;
    ...
    var K, st;
    G = window.__FEATUREGATES_JS__;
    var ct =
      ((K = G) == null || (st = K.getPackageVersion) == null ? void 0 : st.call(K)) ||
      `4.10.0 or earlier`;
...
var ut = G,
  ...
  J,
  dt =
    (globalThis == null || (q = globalThis.process) == null || (q = q.env) == null
      ? void 0
      : q.JEST_WORKER_ID) === void 0 &&
    (globalThis == null || (J = globalThis.process) == null || (J = J.env) == null
      ? void 0
      : J.NODE_ENV) !== `production`,
  ft = function () {
    var e;
    dt && (e = console).debug.apply(e, arguments);
  },
  pt = `@atlaskit/platform-feature-flags`,
  mt = `__PLATFORM_FEATURE_FLAGS__`,
  ht = typeof process < `u` && !0,
  gt = ht ? {}.ENABLE_PLATFORM_FF === `true` : !1,
  _t = ht ? {}.STORYBOOK_ENABLE_PLATFORM_FF === `true` : !1,
  vt = gt || _t,
  yt = { booleanResolver: void 0 },
  Y = typeof window < `u` ? window : globalThis;
Y[mt] = Y.__PLATFORM_FEATURE_FLAGS__ || yt;
function bt(e) {
  if (vt)
    return (
      ft(
  ...
  try {
    if (
      Y.__PLATFORM_FEATURE_FLAGS__?.booleanResolver === void 0 ||
      Y.__PLATFORM_FEATURE_FLAGS__?.booleanResolver === null
    )
      return ut.checkGate(e);
    var t = Y.__PLATFORM_FEATURE_FLAGS__?.booleanResolver(e);
