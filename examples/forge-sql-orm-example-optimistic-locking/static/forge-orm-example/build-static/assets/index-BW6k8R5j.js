...
import { g as ur, a as Xv, r as sr, b as Tt, s as at } from "./client-core-vendor-BHtPNzq_.js";
import { r as Nb } from "./lodash-vendor-B1Yp1k-s.js";
function Fb(e, t) {
...
function fp(e, t, r) {
  ...
  function u(v) {
    v.value instanceof an ? Promise.resolve(v.value.v).then(l, d) : p(o[0][2], v);
  }
  function l(v) {
    s("next", v);
  }
...
const zb = {
    ...
    __importStar: gp,
    __importDefault: bp,
    __classPrivateFieldGet: _p,
    __classPrivateFieldSet: mp,
    __classPrivateFieldIn: yp,
    __addDisposableResource: wp,
    __disposeResources: kp,
...
function ao() {
  return (
    Ou ||
      ((Ou = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(Gb(), e));
      })($i)),
    $i
  );
}
...
function Ap() {
  if (Ju) return po;
  ((Ju = 1), Object.defineProperty(po, "__esModule", { value: !0 }), (po.default = r));
  let e;
...
function jc() {
  return (
    vl ||
      ((vl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(Dp(), e));
      })(Ki)),
    Ki
  );
}
...
function S_() {
  if (pl) return ea;
  ((pl = 1), Object.defineProperty(ea, "__esModule", { value: !0 }), (ea.router = void 0));
  const t = (0, he().getCallBridge)(),
    r = async (i) => {
...
function E_() {
  return (
    hl ||
      ((hl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(S_(), e));
      })(es)),
    es
  );
}
...
function C_() {
  return (
    bl ||
      ((bl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(x_(), e));
      })(ts)),
    ts
  );
}
...
function j_() {
  return (
    kl ||
      ((kl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(Rp(), e));
      })(ns)),
    ns
  );
}
...
function L_() {
  return (
    Pl ||
      ((Pl = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(F_(), e));
      })(is)),
    is
  );
}
...
function q_() {
  return (
    Il ||
      ((Il = 1),
      (function (e) {
        (Object.defineProperty(e, "__esModule", { value: !0 }), pt.__exportStar(U_(), e));
      })(cs)),
    cs
  );
}
  ...
  return (
    Bl ||
      ...
      (function (e) {
        Object.defineProperty(e, "__esModule", { value: !0 });
        const t = pt;
        (t.__exportStar(H_(), e), t.__exportStar(Tp(), e));
      })(us)),
    us
  );
}
...
function tm() {
  ...
  return ((pa.ForgeDataAdapter = t), pa);
}
var vs = {},
  Jl;
function Np() {
...
var $p = typeof Object.getOwnPropertySymbols < "u";
function lm(e) {
  var t = Object.keys(e);
  if (!$p) return t;
...
function Hp(e, t, r) {
  ...
  var n = new lr(e);
  return (t !== en && Cy(n, t), r !== en && vh(n, r), n);
}
function bm(e, t) {
  return xh(e, t);
}
...
function mm(e, t, r) {
  ...
  if (pn(e)) return ue.map(e, { name: r, deep: !1 });
...
function Cm(e, t, r, n) {
  ...
  var o = Jp(e, this, t, r, !1, !1);
  return (Rt(n, t, o), 2);
}
function Pm(e, t, r, n) {
  var a,
    o = Jp(e, this, t, r, (a = this.options_) == null ? void 0 : a.bound);
...
function uh() {
  j.inBatch > 0 || j.isRunningReactions || oc(py);
}
function py() {
  j.isRunningReactions = !0;
  for (var e = j.pendingReactions, t = 0; e.length > 0; ) {
    ++t === vy && (console.error("[mobx] cycle in reaction: " + e[0]), e.splice(0));
...
var ps = Wp("flow"),
  My = Wp("flow.bound", { bound: !0 }),
  sn = Object.assign(function (t, r) {
    if (io(r)) return ps.decorate_20223_(t, r);
    if (Sr(r)) return oo(t, r, ps);
    var n = t,
      ...
      o = function () {
        ...
        return (
          (v.cancel = lt(a + " - runid: " + u + " - cancel", function () {
            try {
              p && ad(p);
  ...
  yh = (function () {
    function e(r, n, a) {
      ...
      (n === void 0 && (n = xr),
        ...
        mt(Map) || X(18),
        Tr(function () {
          ((o.keysAtom_ = Hp("ObservableMap.keys()")),
            (o.data_ = new Map()),
            (o.hasMap_ = new Map()),
            r && o.merge(r));
        }));
      ...
      (t.replace = function (n) {
        ...
        return (
          Jt(function () {
            ...
            for (var v = tn(o.entries()), g; !(g = v()).done; ) {
              var f = g.value,
                h = f[0],
                b = f[1],
                _ = a.data_.has(h);
  ...
  wh = (function () {
    function e(r, n, a) {
      ...
      (n === void 0 && (n = xr),
        ...
        Tr(function () {
          ((o.atom_ = Hp(o.name_)), r && o.replace(r));
        }));
    }
    var t = e.prototype;
    return (
...
function vd(e) {
  return Si(e) ? e.slice() : pn(e) || Dr(e) || Wt(e) || Ct(e) ? Array.from(e.entries()) : e;
}
var pd,
  Qy = ((pd = vi().Iterator) == null ? void 0 : pd.prototype) || {};
function Lc(e) {
...
var p0 = { $$typeof: !0, render: !0, compare: !0, type: !0, displayName: !0 };
function h0(e, t) {
  Object.keys(e).forEach(function (r) {
    p0[r] || Object.defineProperty(t, r, Object.getOwnPropertyDescriptor(e, r));
  });
}
var ys;
...
Ie([lt.bound], xe.prototype, "saveState", 1);
Ie([lt.bound], xe.prototype, "saveResponse", 1);
Ie([lt.bound], xe.prototype, "saveUpdateResponse", 1);
Ie([lt.bound], xe.prototype, "clearStates", 1);
Ie([lt], xe.prototype, "loading", 1);
Ie([lt], xe.prototype, "stopLoading", 1);
const x0 = new xe();
class C0 {
  constructor() {
    this.stateStore = x0;
  ...
  return _e(e, [
    {
      ...
      value: function (r) {
        return (
          ...
          Ae(r) === "object" && (this.payload = ks(ks({}, this.payload), r)),
          this
        );
      },
    },
    ...
    d = m.useCallback(
      function () {
        var p = s({
          ...
          v = J0({ componentName: n, packageName: a, packageVersion: o }, u.current);
        p.context.push(v);
        var g = p.clone();
        ...
        [
          {
            ...
            value: function (o, i) {
              ...
              var g, f;
              return (
                v ? ((g = c), (f = c)) : ((g = iw(s, c, u, l) || []), (f = Mh(g, d, p))),
                Md(Md({}, i), {}, { pageRows: f })
              );
            },
          },
    ...
    return m.createElement(
      ...
      m.createElement("svg", {
        ...
        className: A([
          ...
          s ? "_1bsb1kw7 _4t3i1kw7" : v === "small" ? Lw[l] : Fw[l],
        ]),
      }),
    );
  });
...
var l1 = [
  ...
  d1 = function (t) {
    var r = t.children;
    return m.createElement("span", { className: A([pc.separator]) }, r);
  },
  Mo = m.memo(
    m.forwardRef(function (e, t) {
      var r = e.as,
      ...
      return m.createElement(
        ...
        ee({}, b, {
          ...
          rowGap: d,
          wrap: c ? "wrap" : void 0,
          xcss: Xh(u === "hug" && pc.hug, u === "fill" && pc.fill, v),
          testId: g,
          ref: t,
        }),
        y,
...
var Yh = m.createContext(!1),
  ...
  _1 = { medium: "_11c8fhey", UNSAFE_small: "_11c8rymc", large: "_11c81d4k", small: "_11c8wadc" },
  m1 = { bold: "_k48pwu06", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  y1 = {
  ...
  Zh = m.forwardRef(function (e, t) {
    ...
    return v ? f : m.createElement(h1, { value: !0 }, f);
  });
function w1() {
  ...
  Qh = m.forwardRef(function (e, t) {
    ...
    return m.createElement(
      ...
      ee({ as: "button", tabIndex: g ?? (w1() && !n ? 0 : void 0), style: d }, y, {
        ...
        onClick: _,
        disabled: n,
        xcss: Jh(Hd.root, n && Hd.disabled, v),
        testId: p,
        ref: t,
      }),
      r,
...
var gk = (function (e) {
  function t() {
    ...
    return (
      be(this, t),
      (r = pk(this, t, ["NoFetchDataAdapter", "nofetch"])),
    ...
    return _e(e, [
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return o == null
            ? null
            : Ue(Ue({}, r), {}, { value: o, details: Ue(Ue({}, r.details), {}, { reason: Bs }) });
        },
      },
      {
          ...
          return o == null
            ...
            : Ue(
                ...
                {},
                {
                  ...
                  details: Ue(Ue({}, r.details), {}, { reason: Bs }),
                },
              );
        },
      },
                    ...
                    switch ((l.prev = l.next)) {
                      case 0:
                        return (
                          ...
                          (c = ko(a)),
                          (s = function () {
                            return Ls.fetchExperimentValues(c, o, i).then(function (p) {
                    ...
                    switch ((h.prev = h.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new gt.StatsigClient(If, this.user, v)),
    ...
    return t
      ...
      .reduce(function (r, n) {
        var a = K(n, 2),
          o = a[0],
          i = a[1];
        if ((o === "colorMode" && gg(i) && (r[o] = i), pg(o) && hg(i) && (r[o] = i), o === yc))
          try {
            r[yc] = JSON.parse(i);
          } catch {}
        return r;
...
var Gk = "light",
  ...
  mg = function () {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      ...
      _ = zk({ dark: o, light: c, shape: d, spacing: v, typography: f }),
      y = C(C({}, Nr, _), Ai, n === "auto" ? Gk : n);
    if (
      (oe("platform_increased-contrast-themes") &&
        (y = Bf(Bf({}, y), {}, C({}, vg, u === "auto" ? Hk : u))),
      b && bg(b.brandColor))
    ) {
...
function tO(e) {
  var t = document.documentElement;
  t.setAttribute(vg, e.matches ? "more" : "no-preference");
}
...
function QP(e) {
  var t = Ne(Array.from(document.head.querySelectorAll("style[".concat(Ii, "][").concat(Nr, "]"))));
  t.length < e ||
                                  ...
                                  switch ((le.prev = le.next)) {
                                    case 0:
                                      return (
                                        (le.next = 2),
                                        qe(
                                          () => import("./custom-theme-CQN3uDi_.js"),
...
function HO() {
  return ((we = Ge > 0 ? Re(bn, --Ge) : 0), un--, we === 10 && ((un = 1), Ti--), we);
}
function Xe() {
  return ((we = Ge < Dg ? Re(bn, Ge++) : 0), un++, we === 10 && ((un = 1), Ti++), we);
}
function jt() {
  return Re(bn, Ge);
}
        ...
        switch (_) {
          ...
          case 59 + l:
            (b == -1 && (x = ae(x, /\f/g, "")),
              v > 0 &&
                Et(x) - d &&
                xo(v > 32 ? Kf(x + ";", n, r, d - 1) : Kf(ae(x, " ", "") + ";", n, r, d - 2), s));
            break;
          case 59:
            x += ";";
          default:
      ...
      default:
        ...
        switch (((x += Di(_)), _ * f)) {
          ...
          case 44:
            ...
            break;
          case 64:
            (jt() === 45 && (x += Lo(Xe())), (p = jt()), (l = d = Et((y = x += XO(Fo())))), _++);
            break;
          case 45:
            g === 45 && Et(x) == 2 && (f = 0);
        }
...
function Hf(e, t, r, n, a, o, i, c, s, u, l) {
  for (var d = a - 1, p = a === 0 ? o : [""], v = Xc(p), g = 0, f = 0, h = 0; g < n; ++g)
    for (var b = 0, _ = Za(e, d + 1, (d = UO((f = i[g])))), y = e; b < v; ++b)
      (y = jg(f > 0 ? p[b] + " " + _ : ae(_, /&\f/g, p[b]))) && (s[h++] = y);
...
function Ng(e, t) {
  switch (zO(e, t)) {
          ...
          case 102:
            return (
              ae(
                e,
                /(.+:)(.+)-([^]+)/,
                "$1" + ne + "$2-$3$1" + oi + (Re(e, t + 3) == 108 ? "$3" : "$2-$3"),
              ) + e
            );
          case 115:
    ...
    case 6444:
      switch (Re(e, Et(e) - 3 - (~wc(e, "!important") && 10))) {
        case 107:
          return ae(e, ":", ":" + ne) + e;
        case 101:
          return (
                ...
                case "::placeholder":
                  return nn(
                    [
                      ...
                      xa(t, { props: [ae(o, /:(plac\w+)/, Me + "input-$1")] }),
                    ],
                    a,
                  );
              }
...
var Yc = function (t, r, n) {
    var a = t.key + "-" + r.name;
    (n === !1 || pS === !1) && t.registered[a] === void 0 && (t.registered[a] = r.styles);
  },
  Lg = function (t, r, n) {
    Yc(t, r, n);
    var a = t.key + "-" + r.name;
...
function Zc(e, t, r) {
  ...
  ev.lastIndex = 0;
  for (var u = "", l; (l = ev.exec(a)) !== null; ) u += "-" + l[1];
  var d = hS(a) + u;
    ...
    return (
      ...
      Xt(
        ...
        Xt(
          ...
          f ? Xt("span", { css: [Le, nv({ spacing: z }), av(u, tE)] }, f) : null,
          nE(u, [Le, XS({ spacing: z })]),
          g ? Xt("span", { css: [Le, nv({ spacing: z }), av(u, rE)] }, g) : null,
...
var iE = [
  ...
  ov = typeof navigator < "u" && navigator.userAgent.toLowerCase().indexOf("firefox") > -1,
  tu = O.memo(
    O.forwardRef(function (t, r) {
      var n = t.appearance,
  ...
  return O.createElement(
    ...
    O.createElement(
      ...
      O.createElement(iv, {
        ...
        isDisabled: D || F === 0,
        iconBefore: O.createElement(lv, { chevronDirection: "left" }),
        "aria-label": p,
      ...
      O.createElement(
        ...
        vE(w, F, { max: _, ellipsis: R, transform: W }, P),
      ),
      O.createElement(iv, {
        key: "right-navigator",
        component: n.Next,
        ...
        iconBefore: O.createElement(lv, { chevronDirection: "right" }),
        "aria-label": g,
...
var fv = "--local-dynamic-table-text-color",
  kE = function (t) {
    var r = t.isRanking,
      n = t.testId,
      a = ie(t, yE);
  ...
  OE = m.forwardRef(function (e, t) {
    ...
    var c = e.style,
      ...
      l = Ca(
        ...
        {},
        C({}, fv, "var(--ds-text-subtlest, #6B6E76)"),
      ),
      d = a === Pr,
      p = a === ti,
      v = function () {
    ...
    return m.createElement(
      ...
      ee({ "aria-sort": v(), onClick: void 0, ref: t, "data-testid": s }, u, {
        ...
        style: Ca(
          Ca({}, l),
          {},
          { "--_17ckjys": ar("var(--ds-text-subtle, ".concat("var(".concat(fv, ")"), ")")) },
        ),
      }),
      n,
    );
...
function xE() {
  if (vv) return Pa;
  ((vv = 1), Object.defineProperty(Pa, "__esModule", { value: !0 }), (Pa.default = void 0));
  var e = r(Ar()),
    t = r(Pi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function RE() {
  if (pv) return Ra;
  ((pv = 1), Object.defineProperty(Ra, "__esModule", { value: !0 }), (Ra.default = void 0));
  var e = r(Ar()),
    t = r(Pi);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
var WE = m.createContext(function () {
    return { isReady: !0, delay: 0, ref: Fe };
  }),
  JE = function () {
    var t = KE(),
      r = m.useContext(WE);
...
function vo(e) {
  for (var t = Ye(e), r = yv(e); r && _x(r) && Qt(r).position === "static"; ) r = yv(r);
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      ...
      var D = k[P],
        ...
        F = [$e, ft].indexOf(L) >= 0,
        H = F ? "width" : "height",
        V = ro(t, { placement: D, boundary: l, rootBoundary: d, altBoundary: p, padding: u }),
        W = F ? (z ? vt : Ve) : z ? ft : $e;
      w[H] > S[H] && (W = Uo(W));
      var U = Uo(W),
        q = [];
...
function Ev(e) {
  return [$e, vt, ft, Ve].some(function (t) {
    return e[t] >= 0;
  });
}
function zx(e) {
...
function Vx(e, t, r) {
  ...
  return (
    (i = i || 0),
    (c = (c || 0) * a),
    [Ve, vt].indexOf(n) >= 0 ? { x: c, y: i } : { x: i, y: c }
  );
}
function Gx(e) {
  var t = e.state,
  ...
  if (S) {
    if (o) {
      var z,
        ...
        ce = _ === ln ? -R[V] : -x[V],
        le = t.elements.arrow,
        Oe = v && le ? au(le) : { width: 0, height: 0 },
        ...
        Be = t.elements.arrow && vo(t.elements.arrow),
        fr = Be ? (k === "y" ? Be.clientTop || 0 : Be.clientLeft || 0) : 0,
        er = (z = D?.[k]) != null ? z : 0,
        tt = W + Ce - er - fr,
        je = W + ve - er,
        rt = qa(v ? ii(U, tt) : U, W, v ? Or(q, je) : q);
      ((S[k] = rt), (L[k] = rt - W));
    }
    if (c) {
      var kt,
        ...
        nt = [$e, Ve].indexOf(b) !== -1,
        Lt = (kt = D?.[w]) != null ? kt : 0,
        ge = nt ? Se : Te - x[re] - R[re] - Lt + P.altAxis,
        Bt = nt ? Te + x[re] + R[re] - Lt - P.altAxis : Ee,
        Ke = v && nt ? yx(ge, Te, Bt) : qa(v ? ge : Se, Te, v ? Bt : Ee);
      ((S[w] = Ke), (L[w] = Ke - Te));
    }
    t.modifiersData[n] = L;
  }
      ...
      v = {
        ...
        forceUpdate: function () {
          if (!p) {
            ...
            if (Cv(_, y)) {
              ((l.rects = {
                reference: tC(_, vo(y), l.options.strategy === "fixed"),
                popper: au(y),
              }),
                (l.reset = !1),
    ...
    b = m.useMemo(
      function () {
        var y = {
          ...
          w = v ? _C({ viewportPadding: Ac }) : [];
        return [].concat(mC, [y, k], Ne(w));
      },
      [f, h, v],
    ),
    _ = m.useMemo(
...
var ub = "atlaskit-portal-container",
  ...
  EC = function (t) {
    t.parentElement || vb().appendChild(t);
  },
  pb = function () {
...
function FC() {
  return Mr.bindAll(window, [
    { type: "dragstart", listener: Iv },
    { type: "dragenter", listener: Iv },
  ]);
}
var Po = null;
function LC(e) {
...
var Dv = {
  ...
  qC = function (t) {
    ...
    return m.createElement(
      "div",
      { className: A([Dv.shortcutSegmentsContainer]) },
      r.map(function (n, a) {
        return m.createElement(
          "kbd",
          { key: "".concat(n, "-").concat(a), className: A([Dv.shortcutSegment]) },
          n,
        );
      }),
    );
  ...
  bb = m.forwardRef(function (t, r) {
    ...
    return m.createElement(
      gb,
      {
        ref: r,
        style: n,
        className: A([Tv.base, i && Tv.truncate, a]),
        placement: c,
        testId: s,
        id: d,
        onMouseOut: u,
...
var $C = AO.tooltip(),
  Fv = { componentName: "tooltip", packageName: "@atlaskit/tooltip", packageVersion: "20.14.0" },
...
function HC(e) {
  var t = e.children,
    ...
    ce = te ? o : n,
    le = Dd(Yr({ fn: b, action: "displayed", analyticsData: I }, Fv)),
    Oe = Dd(Yr({ fn: y, action: "hidden", analyticsData: I }, Fv)),
    N = m.useRef(null),
    me = m.useState("hide"),
    Le = K(me, 2),
    fe = Le[0],
    ...
    re = m.useCallback(function (B) {
      ((N.current = B), (De.current = !1));
    }, []),
    Se = m.useCallback(
      function () {
        N.current &&
          (De.current && rt.current(), (N.current = null), (De.current = !1), Ce("hide"));
      },
      [rt],
    ),
    Ee = m.useCallback(
          ...
          var de = te
            ? {
                ...
                mouse: oe("platform_dst_nav4_side_nav_resize_tooltip_feedback")
                  ? void 0
                  : Mv({ left: B.clientX, top: B.clientY }),
                clientX: B.clientX,
                clientY: B.clientY,
              }
            : { type: "keyboard" };
      ...
      ? function (B) {
          ...
          (de = N.current) !== null &&
            ...
            (oe("platform_dst_nav4_side_nav_resize_tooltip_feedback") ||
              (N.current.mousePosition = Mv({ left: B.clientX, top: B.clientY })),
  ...
  var fu = function () {
      ...
      if (
        ...
        return zC(N.current.mousePos, { targetElement: ve.current, tooltipPosition: n });
      if (
        te &&
        (zt = N.current) !== null &&
        zt !== void 0 &&
  ...
  var pu = lu
      ? O.createElement(
          "span",
          { "data-testid": v ? "".concat(v, "-hidden") : void 0, hidden: !0, id: mn },
  ...
  return O.createElement(
    ...
    typeof t == "function"
      ...
      : O.createElement(Ib, ee({}, Bi, { ref: fr, role: "presentation" }), t, pu),
    Li
      ? O.createElement(
          Db,
          null,
...
var KC = function (t) {
  ...
  Lv = { headCellContainer: "_1e0c1txw _4cvr1h6o", text: "_11c8wadc _syazazsu _k48pwu06" },
  _b = function (t) {
    var r = t.content,
      n = t.inlineStyles,
      a = t.testId;
    ...
    var o = t.innerRef,
      ...
      q = O.createElement(
        Ri,
        { xcss: Lv.headCellContainer, onMouseEnter: W, onMouseLeave: U, onFocus: H, onBlur: V },
        O.createElement(
          HC,
          { content: c === Pr ? p : g },
          O.createElement(
            ...
            O.createElement(
              ...
              O.createElement("span", { className: A([Lv.text]) }, r),
            ),
            F &&
              O.createElement(
                ai,
...
var oP = function (t) {
    ...
    return O.createElement(
      ...
      !He &&
        Te &&
        O.createElement(Gh, { isLoading: g, spinnerSize: ri, testId: l, loadingLabel: s }, Te),
    );
  },
  iP = m.lazy(function () {
    return qe(
      () => import("./body-BZqwT2py.js"),
...
var _P = [
  ...
  yP = O.forwardRef(function (e, t) {
    var r = e.appearance,
      ...
      _n = Ke || s,
      qt = l && !Ke;
    (Vg(Te, a), De.className, De.css, De.as, De.style);
    var Fi = ie(De, mP);
    return O.createElement(
      Qh,
      ee(
        ...
        Fi,
        {
          ...
          xcss: Xh(
            ...
            ge === "primary" && qv.root,
            ge === "primary" && Ut && qv.interactive,
            ge === "warning" && zv.root,
            ge === "warning" && Ut && zv.interactive,
            ge === "danger" && $v.root,
            ge === "danger" && Ut && $v.interactive,
            ge === "discovery" && Vv.root,
            ge === "discovery" && Ut && Vv.interactive,
            ge === "subtle" && Gv.root,
            ge === "subtle" && Ut && Gv.interactive,
        ...
        {
          "aria-label": s && x && !R ? "".concat(x, " ").concat(Uv) : x,
      ...
      O.createElement(
        ...
        s && (R || !x) && O.createElement(ji, { id: Se }, Uv),
      ),
    );
  }),
  Qr = {
...
var xP = { componentName: "tabs", packageName: "@atlaskit/tabs", packageVersion: "18.3.2" },
  Wv = function (t) {
    var r = t.tabPanel,
      n = t.index,
      a = t.isSelected,
  ...
  CP = function (t) {
    ...
    var w = m.useCallback(
      ...
      x = n
        ? Wv({ tabPanel: y[f], index: f, isSelected: !0, tabsId: c })
        : Array.from(k.current).map(function (R) {
            return Wv({ tabPanel: y[R], index: R, isSelected: R === f, tabsId: c });
          });
    return m.createElement(
      "div",
      {
