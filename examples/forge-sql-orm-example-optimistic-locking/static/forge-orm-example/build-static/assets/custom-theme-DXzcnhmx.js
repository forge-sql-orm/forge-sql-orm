...
var ce = [1.12, 1.33, 2.03, 2.73, 3.33, 4.27, 5.2, 6.62, 12.46, 14.25],
  ...
  $ = function (e) {
    var t = o(e)[0],
      n = a(t, 100, 60),
      i = s(n[0], n[1], n[2]) < 0.4 ? ce : le,
      c = _(e),
      l = Y.fromInt(re({ r: c[0], g: c[1], b: c[2], a: c[3] })),
      u = i.map(function (e) {
  ...
  return (
    (r === `light` || r === `auto`) &&
      ...
      o.push({
        ...
        css: `
html[${c}="${i}"][${d}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${h(s.light, a)}
}`,
      }),
    (r === `dark` || r === `auto`) &&
      ...
      o.push({
        ...
        css: `
html[${c}="${i}"][${d}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${h(s.dark, a)}
}`,
      }),
