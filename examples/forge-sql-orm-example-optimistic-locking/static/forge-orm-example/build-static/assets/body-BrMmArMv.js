            ...
            if (e.canStart(t) && !t.defaultPrevented && t.dataTransfer) {
              ...
              if (n instanceof HTMLElement) {
                ...
                if (i) {
                  ...
                  if (i.dragHandle) {
                    var s = Me({ x: a.clientX, y: a.clientY });
...
function Ut(e, t, n) {
  return ((t = i(t)), a(e, Wt() ? Reflect.construct(t, n || [], i(e).constructor) : t.apply(e, n)));
}
function Wt() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Kt = (function (e) {
  function t() {
    return (o(this, t), Ut(this, t, arguments));
  }
  return (
    f(t, e),
    u(
...
function gi(e) {
  var t = e.children,
    ...
    w = (0, j.useCallback)(
      function (e) {
        (y.current && C(),
          e && S(ie(e, c(c({}, L.draggable.droppableId, f), L.draggable.index, String(i)))),
          (y.current = e),
  ...
  ((0, j.useEffect)(
    function () {
      if (D.type === `idle` && !o) {
        var e = y.current;
        h(e instanceof HTMLElement);
        var t = b.current;
        return (
          h(t instanceof HTMLElement),
          (0, G.bindAll)(t, [
            {
              type: `keydown`,
              listener: function (t) {
  ...
  var z = D.type !== `idle` && m === `standard`,
    oe = (0, j.useRef)(null);
  Ur({ elementRef: z ? oe : y, data: k, direction: d, contextId: _, isDropDisabled: ne, type: p });
  var se = (0, j.useRef)(!0);
  ...
  (0, j.useEffect)(
    ...
    [k.draggableId, k.contextId, R, F, d, _, B, v],
  );
  var le = (0, j.useMemo)(
      function () {
        return {
          ...
          dragHandleProps: c(
            c(
              c(
                c(
                  c({ role: `button`, "aria-describedby": Xt(_) }, I.dragHandle.contextId, _),
          ...
          return {
            ...
            dragHandleProps: c(
              c(
                c(
                  c(
                    c({ role: `button`, "aria-describedby": Xt(f) }, I.dragHandle.contextId, f),
                    I.dragHandle.draggableId,
                    i,
                  ),
                  `tabIndex`,
...
var ji = 4,
  ...
  Ni = S({ position: `absolute`, top: 0, left: 0 }),
  Pi = S({ opacity: 0 }),
  Fi = {
    horizontal: S({ width: 2, height: `100%`, marginLeft: -2 }),
    vertical: S({ width: `100%`, height: 2, marginTop: -2 }),
  };
function Ii(e) {
  var t = e.direction,
    n = e.dimensions,
...
var Li = c({}, L.dropIndicator, ``),
  Ri = function (e) {
    ...
    var g = Q[t].mainAxis,
      ...
      y = n === `virtual`;
    return v(`div`, w({ ref: s, css: [Mi, Fi[t], y && Ni, f && Pi], style: _ }, Li));
  };
function zi(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
function Wi(e) {
  ...
  (0, j.useEffect)(
    function () {
      var e = x.current;
      return (
        h(e instanceof HTMLElement, "innerRef must provide an `HTMLElement`"),
        U(
          y.register({
            droppableId: n,
            type: a,
...
var qi = [`isRanking`, `innerRef`],
  Ji = function (e) {
    var t = e.isRanking,
      n = e.innerRef,
      r = s(e, qi);
    return j.createElement(y, w({}, r, { innerRef: n, className: p([t && `_vchhusvi`]) }));
  },
  Yi = [`content`, `testId`];
function Xi(e, t, n) {
