...
function C(e, t, n) {
  return ((t = i(t)), a(e, w() ? Reflect.construct(t, n || [], i(e).constructor) : t.apply(e, n)));
}
function w() {
  try {
...
var T = !0,
  ...
  D = (function (e) {
    function t(e) {
      var n;
      return (o(this, t), (n = C(this, t)), (n.message = e), n);
    }
    return (
      f(t, e),
      u(t, [
...
function me(e, t) {
  var n = t.element,
    ...
    s =
      i
        .map(function (e) {
          return { edge: e, value: fe[e](o, a) };
        })
        .sort(function (e, t) {
          return e.value - t.value;
        })[0]?.edge ?? null;
  return de(de({}, e), {}, c({}, pe, s));
}
function he(e) {
  return e[pe] ?? null;
}
...
function _e(e) {
  ...
  return (0, k.useMemo)(
    function () {
      return c(
        c(
          c(c(c(c({}, ge, !0), `draggableId`, t), `droppableId`, n), `getIndex`, r),
          `contextId`,
          i,
        ),
        `type`,
...
function be(e) {
  ...
  return (0, k.useMemo)(
    function () {
      return c(c(c(c({}, ve, !0), `contextId`, t), `droppableId`, n), `getIsDropDisabled`, r);
    },
    [t, n, r],
  );
}
...
function xt(e) {
  ...
  function p(e) {
    ...
    for (var s = bt(a), l = bt(o), u = [], d = 0; d < s.length; d++) {
      var f,
        p = s[d],
        m = l[d];
      if (m != null) {
            ...
            if (e.canStart(t) && !t.defaultPrevented && t.dataTransfer) {
              ...
              if (n instanceof HTMLElement) {
                ...
                if (i) {
                  ...
                  if (i.dragHandle) {
                    var s = je({ x: a.clientX, y: a.clientY });
...
function Bt(e, t, n) {
  return ((t = i(t)), a(e, Vt() ? Reflect.construct(t, n || [], i(e).constructor) : t.apply(e, n)));
}
function Vt() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Ut = (function (e) {
  function t() {
    return (o(this, t), Bt(this, t, arguments));
  }
  return (
    f(t, e),
    u(
...
function hr(e) {
  ...
  return k.createElement(mr.Provider, { value: i }, t);
}
function gr() {
...
function Nr(e) {
  var t = e.children,
    ...
    l = e.onDragUpdate,
    u = e.onDragEnd,
    d = r((0, k.useState)(jr), 1)[0];
  Jt({ contextId: d, text: i });
  var f = pr(),
    p = kr(),
    m = p.schedule,
    h = p.flush,
...
var ri = (0, k.memo)(
    (0, k.forwardRef)(function (e, t) {
      ...
      return k.createElement(`div`, x({ ref: t, style: o }, a));
    }),
  ),
  Q = {
    vertical: {
...
function pi(e) {
  var t = e.children,
    ...
    C = (0, k.useCallback)(
      function (e) {
        (v.current && S(),
          e && x(ie(e, c(c({}, I.draggable.droppableId, f), I.draggable.index, String(i)))),
          (v.current = e),
  ...
  var le = (0, k.useMemo)(
      function () {
        return {
          draggableProps: c(
            c(c({}, F.draggable.contextId, g), F.draggable.id, n),
            `style`,
          ...
          dragHandleProps: c(
            c(
              c(
                c(
                  c({ role: `button`, "aria-describedby": qt(g) }, F.dragHandle.contextId, g),
    ...
    t(
      (0, k.useMemo)(
        function () {
          return {
            innerRef: p,
            draggableProps: c(c(c({}, F.draggable.contextId, f), F.draggable.id, i), `style`, s),
            dragHandleProps: c(
              c(
                c(
                  c(
                    c({ role: `button`, "aria-describedby": qt(f) }, F.dragHandle.contextId, f),
                    F.dragHandle.draggableId,
                    i,
                  ),
                  `tabIndex`,
      ...
      di({ draggingOver: o, isClone: !0, isDragging: !0, mode: d }),
      (0, k.useMemo)(
        function () {
    ...
    var t = e.direction,
      ...
      h = (0, k.useCallback)(
        function (e) {
          ...
          return (
            p(s),
            u(Di({ targetLocation: r, isInHomeLocation: s, direction: t, mode: n, contextId: a }))
          );
        },
        [a, t, n],
      );
...
function Vi(e) {
      ...
      function (e) {
        (e &&
          ie(
            e,
            c(
              c(c(c({}, I.droppable.type, a), I.droppable.direction, s), F.droppable.id, n),
  ...
  var M = (0, k.useMemo)(
      function () {
        return D ? k.createElement(Fi, { direction: s, mode: u }) : null;
      },
      [s, D, u],
    ),
    te = (0, k.useMemo)(
      function () {
        return {
          innerRef: x,
          droppableProps: c(c({}, F.droppable.contextId, _), F.droppable.id, n),
...
var Hi = [`isRanking`, `isRankingItem`, `testId`],
  ...
  Ki = [`content`, `testId`];
function qi(e, t, n) {
  return ((t = i(t)), a(e, Ji() ? Reflect.construct(t, n || [], i(e).constructor) : t.apply(e, n)));
}
function Ji() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Yi = y(
    (function (e) {
      function t() {
        return (o(this, t), qi(this, t, arguments));
      }
      return (
        f(t, e),
        u(t, [
...
function $i(e, t, n) {
  return ((t = i(t)), a(e, ea() ? Reflect.construct(t, n || [], i(e).constructor) : t.apply(e, n)));
}
function ea() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
