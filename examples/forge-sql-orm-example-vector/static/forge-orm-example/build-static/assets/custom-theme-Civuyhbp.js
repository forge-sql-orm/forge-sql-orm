    ...
    return (
      x.forEach(function (e) {
        var o = e.backgroundLight,
          ...
          p = t[d];
        _(
          a.includes(c) ? (typeof f == `string` ? f : r[f]) : S(c, n),
          a.includes(d) ? (typeof p == `string` ? p : r[p]) : S(d, n),
        ) <= l &&
...
(n(Z, `SCALED_DISCOUNT_FROM_LINRGB`, [
  [0.001200833568784504, 0.002389694492170889, 0.0002795742885861124],
  [0.0005891086651375999, 0.0029785502573438758, 0.0003270666104008398],
  [0.00010146692491640572, 0.0005364214359186694, 0.0032979401770712076],
]),
  n(Z, `LINRGB_FROM_SCALED_DISCOUNT`, [
    [1373.2198709594231, -1100.4251190754821, -7.278681089101213],
    [-271.815969077903, 559.6580465940733, -32.46047482791194],
    [1.9622899599665666, -57.173814538844006, 308.7233197812385],
  ]),
  n(Z, `Y_FROM_LINRGB`, [0.2126, 0.7152, 0.0722]),
  n(
    Z,
    `CRITICAL_PLANES`,
    [
...
var Q = (function () {
  function e(n, r, i, a, o, s, c, l, u, d) {
    (t(this, e),
      (this.n = n),
      (this.aw = r),
      (this.nbb = i),
...
var ce = [1.12, 1.33, 2.03, 2.73, 3.33, 4.27, 5.2, 6.62, 12.46, 14.25],
  ...
  $ = function (e) {
    var t = s(e)[0],
      n = o(t, 100, 60),
      r = c(n[0], n[1], n[2]) < 0.4 ? ce : le,
      i = v(e),
      a = Y.fromInt(re({ r: i[0], g: i[1], b: i[2], a: i[3] })),
      l = r.map(function (e) {
        var t = ne(Y.from(a.hue, a.chroma, ae.darker(100, e) + 0.25).toInt());
        return h(t.r, t.g, t.b);
      }),
      d = ue(l, e),
      f = u(l);
    return ((f[d] = e), { ramp: f, replacedColor: l[d] });
  };
function de(e, t, n) {
  for (var r = [], i = 1; i <= t; i++)
...
var fe = function (e, t, n) {
    ...
    if (d >= 4.5) {
      var f = i(de(c, 2, s), 2),
        ...
        m = f[1],
        h = c;
      d < 5.4 && d >= 4.8 && c === 6 && (h = c + 1);
      var g = i(de(h, 1, s), 1)[0];
      l = {
        "color.text.brand": h,
        "color.icon.brand": c,
    ...
    return (
      Object.entries(a).forEach(function (e) {
        var t = i(e, 2),
          ...
          a = t[1];
        (n === `light` || n === `dark`) &&
          (o[n] = se(se({}, a), C({ customThemeTokenMap: a, mode: n, themeRamp: r })));
      }),
      o
    );
  },
...
function he(t) {
  var n,
    r = t == null || (n = t.UNSAFE_themeOptions) == null ? void 0 : n.brandColor,
    i = t?.colorMode || e.colorMode,
    o = l(JSON.stringify(t?.UNSAFE_themeOptions)),
    s = $(r).ramp,
    c = [],
    u = pe(r, i, s);
  return (
    (i === `light` || i === `auto`) &&
      ...
      c.push({
        id: `light`,
        attrs: { "data-theme": `light`, "data-custom-theme": o },
        css: `
html[${a}="${o}"][${f}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${g(u.light, s)}
}`,
      }),
    (i === `dark` || i === `auto`) &&
      ...
      c.push({
        id: `dark`,
        attrs: { "data-theme": `dark`, "data-custom-theme": o },
        css: `
html[${a}="${o}"][${f}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${g(u.dark, s)}
}`,
      }),
