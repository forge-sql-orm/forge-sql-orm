...
import { t as n } from "./client-core-vendor-DGzKkEmo.js";
function r(e) {
...
function ne(e, t) {
  for (; !{}.hasOwnProperty.call(e, t) && (e = S(e)) !== null; );
  return e;
}
function C() {
  return (
...
var ie = t((e, t) => {
            ...
            a?.has_updates !== !0 || (a.time ?? 0) < this._lcut
              ...
              : ((this._valuesForExternalUse = (0, t._typedJsonParse)(
                ...
                a.response_format === `init-v2`
                  ? (this._values = new i.V2InitializeContainer(a))
                  : (this._values = new r.V1InitializeContainer(a)),
                (this._bootstrapMetadata = this._extractBootstrapMetadata(e.source, a)),
                e.source && a.user && this._setWarningState(n, a),
  ...
  ve = t((e) => {
    ...
    var t = n(),
      r = 2;
    function i(e, n) {
      let i = (0, t._typedJsonParse)(n, `checksum`, `DeltasEvaluationResponse`);
      if (!i) return { hadBadDeltaChecksum: !0 };
      let s = o(a(e, i)),
        c = (0, t._DJB2Object)(
          {
      ...
      return c === i.checksumV2
        ? JSON.stringify(s)
        : {
            hadBadDeltaChecksum: !0,
            badChecksum: c,
            badMergedConfigs: s,
            badFullResponse: i.deltas_full_response,
          };
    }
    e._resolveDeltasResponse = i;
    function a(e, t) {
    ...
    function o(e) {
      let t = e;
      return (
        s(e.deleted_gates, t.feature_gates),
        delete t.deleted_gates,
        s(e.deleted_configs, t.dynamic_configs),
        delete t.deleted_configs,
        s(e.deleted_layers, t.layer_configs),
  ...
  ye = t((e) => {
    ...
    var r = n(),
      i = ve();
    e.default = class extends r.NetworkCore {
      constructor(e, t) {
        super(e, t);
        let n = e?.networkConfig;
        ((this._option = e),
          (this._initializeUrlConfig = new r.UrlConfiguration(
            r.Endpoint._initialize,
            n?.initializeUrl,
            n?.api,
            n?.initializeFallbackUrls,
          )));
      }
      fetchEvaluations(e, n, i, a, o) {
        return t(this, void 0, void 0, function* () {
          let t = n ? (0, r._typedJsonParse)(n, `has_updates`, `InitializeResponse`) : null,
            s = {
              user: a,
      ...
      _fetchEvaluations(e, n, r, a) {
        return t(this, void 0, void 0, function* () {
          ...
          if (
            ...
            r.deltasResponseRequested !== !0
          )
            return t.body;
          let o = (0, i._resolveDeltasResponse)(n, t.body);
          return typeof o == `string`
            ? o
            : this._fetchEvaluations(
                e,
                n,
                Object.assign(Object.assign(Object.assign({}, r), o), {
                  deltasResponseRequested: !1,
                }),
                a,
              );
  ...
  be = t((e) => {
    ...
    function s(e, t, n) {
      return e.getFeatureGate(t.gate_name, i(n) ? void 0 : r).value ? t.pass_value : t.fail_value;
    }
    function c(e, t, n, o) {
      let s = e.getDynamicConfig(t.config_name, i(o) ? void 0 : r).get(t.param_name);
      return a(s, n) ? n : s;
    }
    function l(e, t, n, o) {
      let s = e.getExperiment(t.experiment_name, i(o) ? void 0 : r).get(t.param_name);
      return a(s, n) ? n : s;
    }
    function u(e, t, n, o) {
      let s = e.getLayer(t.layer_name, i(o) ? void 0 : r).get(t.param_name);
      return a(s, n) ? n : s;
    }
    function d(e, n, r) {
      return (i, a) => {
        if (n == null) return a;
        let d = n[i];
        if (d == null || (a != null && (0, t._typeOf)(a) !== d.param_type)) return a;
        switch (d.ref_type) {
          case `static`:
            return o(d, r);
          case `gate`:
  ...
  xe = t((e) => {
    ...
    var r = n(),
      i = ye();
    e.StatsigEvaluationsDataAdapter = class extends r.DataAdapterCore {
      constructor() {
      ...
      attach(e, t, n) {
        (super.attach(e, t, n),
          n !== null && n instanceof i.default
            ? (this._network = n)
            : (this._network = new i.default(t ?? {})));
      }
      getDataAsync(e, t, n) {
        return this._getDataAsyncImpl(e, (0, r._normalizeUser)(t, this._options), n);
      }
      prefetchData(e, t) {
        return this._prefetchDataImpl(e, t);
      }
      setData(e) {
        let t = (0, r._typedJsonParse)(e, `has_updates`, `data`);
        t && `user` in t
      ...
      _getCacheKey(e) {
        let t = (0, r._getStorageKey)(this._getSdkKey(), e, this._options?.customUserCacheKeyFunc);
        return `${r.DataAdapterCachePrefix}.${this._cacheSuffix}.${t}`;
      }
      _isCachedResultValidFor204(e, t) {
        return e.fullUserHash != null && e.fullUserHash === (0, r._getFullUserHash)(t);
      }
    };
  }),
  Se = t((e) => {
    ...
    var r = n(),
      ...
      o = be(),
      s = xe();
    e.default = class e extends r.StatsigClientBase {
      static instance(t) {
        let n = (0, r._getStatsigGlobal)().instance(t);
      ...
      constructor(e, t, n = null) {
        r.SDKType._setClientType(e, `javascript-client`);
        let o = new a.default(n, (e) => {
          this.$emt(e);
        });
        (super(e, n?.dataAdapter ?? new s.StatsigEvaluationsDataAdapter(), o, n),
          ...
          (this._store = new i.default(e, n ?? null)),
          (this._network = o),
          (this._user = this._configureUser(t, n)),
          (this._sdkInstanceID = (0, r.getUUID)()),
          (this._contextHandle = new r.PrecomputedEvaluationsContextHandle(
            e,
            () => this._options,
            () => this._errorBoundary,
      ...
      _updateUserAsyncImpl(e, n) {
        return t(this, void 0, void 0, function* () {
          ...
          if (
            ...
            (i = yield this.dataAdapter.getDataAsync(i, t, n)),
            t !== this._user)
          )
          ...
          (i != null &&
            ...
            r.Diagnostics._markInitProcessEnd(this._sdkKey, { success: a })),
          ...
          let o = r.Diagnostics._enqueueDiagnosticsEvent(
            this._user,
            this._logger,
            this._sdkKey,
            this._options,
      ...
      getContext() {
        let e = (0, r._cloneObject)(`StatsigUser`, this._user);
        return (
          (e ??= (r.Log.error(`Failed to clone user`), {})),
          {
            sdkKey: this._sdkKey,
      ...
      _runPostUpdate(e, t) {
        this.dataAdapter.getDataAsync(e, t, { priority: `low` }).catch((e) => {
          r.Log.error(`An error occurred after update.`, e);
        });
      }
      _resetForUser(e) {
        (this._logger.reset(),
      ...
      _configureUser(e, t) {
        var n;
        let i = (0, r._normalizeUser)(e, t),
          a = i.customIDs?.stableID;
        if (a) {
          let e = (n = this.storageProvider).isReadyResolver?.call(n);
          e
            ? e.then(
                () => r.StableID.setOverride(a, this._sdkKey),
                () => r.StableID.setOverride(a, this._sdkKey),
              )
            : r.StableID.setOverride(a, this._sdkKey);
        }
      ...
      _getFeatureGateImpl(e, t) {
        ...
        let o = (0, r._makeFeatureGate)(e, a, i),
          s = (n = this.overrideAdapter)?.getGateOverride?.call(n, o, this._user, t) ?? o;
        return (
          this._enqueueExposure(
            e,
            (0, r._createGateExposure)(this._user, s, this._store.getExposureMapping()),
            t,
          ),
      ...
      _getDynamicConfigImpl(e, t) {
        ...
        (this._checkUserHasIdForEvaluation(i?.id_type, e, `Dynamic config`),
          this._checkInitializationStatus(a.reason));
        let o = (0, r._makeDynamicConfig)(e, a, i),
          s = (n = this.overrideAdapter)?.getDynamicConfigOverride?.call(n, o, this._user, t) ?? o;
        return (
          this._enqueueExposure(
            e,
            (0, r._createConfigExposure)(this._user, s, this._store.getExposureMapping()),
            t,
          ),
      ...
      _getExperimentImpl(e, t) {
        ...
        (this._checkUserHasIdForEvaluation(i?.id_type, e, `Experiment`),
          this._checkInitializationStatus(a.reason));
        let o = (0, r._makeExperiment)(e, a, i);
        o.__evaluation != null &&
          (o.__evaluation.secondary_exposures = (0, r._mapExposures)(
            o.__evaluation?.secondary_exposures ?? [],
            this._store.getExposureMapping(),
          ));
        let s = (n = this.overrideAdapter)?.getExperimentOverride?.call(n, o, this._user, t) ?? o;
        return (
          this._enqueueExposure(
            e,
            (0, r._createConfigExposure)(this._user, s, this._store.getExposureMapping()),
      ...
      _getLayerImpl(e, t) {
        ...
        let { result: i, details: a } = this._store.getLayer(e),
          o = (0, r._makeLayer)(e, a, i),
          s = (n = this.overrideAdapter)?.getLayerOverride?.call(n, o, this._user, t);
        t?.disableExposureLog && this._logger.incrementNonExposureCount(e);
        let c = (0, r._mergeOverride)(o, s, s?.__value ?? o.__value, (n) => {
      ...
      _getParameterStoreImpl(e, t) {
        ...
        let a = {
            ...
            details: i,
            __configuration: r,
            get: (0, o._makeParamStoreGetter)(this, r, t),
          },
          s = (n = this.overrideAdapter)?.getParamStoreOverride?.call(n, a, t);
        return (
          s != null &&
            ((a.__configuration = s.config),
            (a.details = s.details),
            (a.get = (0, o._makeParamStoreGetter)(this, s.config, t))),
          a
        );
      }
      _checkUserHasIdForEvaluation(e, t, n) {
        e &&
          ((0, r._getUnitIDFromUser)(this._user, e) ||
            r.Log.warn(`The user does not have the required id_type "${e}" for ${n} "${t}"`));
      }
      _checkInitializationStatus(e) {
        (e === `Uninitialized` || e.startsWith(`Loading`)) &&
          r.Log.warn(`SDK initialization has not completed. Reason: ${e}`);
      }
    };
  }),
  Ce = t((e) => {
    ...
    var i = n(),
      a = Se();
    ((e.StatsigClient = a.default),
      r(n(), e),
      (e.default = Object.assign((0, i._getStatsigGlobal)(), { StatsigClient: a.default })));
  }),
  we = e(
    t((e, t) => {
...
var O = `@all-features`,
  Ee = (function () {
    function e() {
      (f(this, e), _(this, `eventToValue`, new Map()), (this.emitter = new we.default()));
    }
    return g(e, [
      {
        key: `onGateUpdated`,
        value: function (e, t, n, r) {
          var i = this,
            a = n(e, D(D({}, r), {}, { fireGateExposure: !1 }));
          this.eventToValue.get(t) === void 0 && this.eventToValue.set(t, a);
          var o = function () {
            var a = n(e, D(D({}, r), {}, { fireGateExposure: !1 }));
      ...
      },
      {
        ...
        value: function (e, t, n, r, i, a) {
          var o = this,
            s = `${e}.${t}`,
            c = i(e, t, n, D(D({}, a), {}, { fireExperimentExposure: !1 }));
          this.eventToValue.get(r) === void 0 && this.eventToValue.set(r, c);
          var l = function () {
            var s = i(e, t, n, D(D({}, a), {}, { fireExperimentExposure: !1 }));
...
var k = e(me()),
  ...
  j = { Development: `development`, Staging: `staging`, Production: `production` },
  M = { COMMERCIAL: `commercial`, FEDRAMP_MODERATE: `fedramp-moderate` },
  Ae = [
    `api`,
...
var P = function (e) {
    return N({ perimeter: Oe() ? M.FEDRAMP_MODERATE : M.COMMERCIAL }, e);
  },
  F = function (e, t) {
    if (!e && !t) return !0;
    if (!e || !t) return !1;
    ...
    (n.sort(i), r.sort(i));
    for (var a = 0; a < n.length; a++) if (c(n[a], 2)[1] !== c(r[a], 2)[1]) return !1;
    return !0;
  },
  Me = function (e, t) {
...
function I(e) {
  ...
  var n = t.shift();
  if (n == null) return I.apply(void 0, [e].concat(b(t)));
  for (var r = 0, i = Object.entries(n); r < i.length; r++) {
    var a = c(i[r], 2),
      o = a[0],
      s = a[1],
      l = e[o],
      u = s && d(s) === `object` && !Array.isArray(s),
      f = l && d(l) === `object` && !Array.isArray(l);
    u && f ? (e[o] = I(l, s)) : (e[o] = s);
  }
  return I.apply(void 0, [e].concat(b(t)));
}
var Ne = function (e) {
    var t = e.api,
  ...
  Pe = Object.entries(ke).map(function (e) {
    var t = c(e, 2),
      n = t[0],
      r = t[1];
      ...
      [
        {
          ...
          value: function (e, t, n) {
            var r,
              i = this.getValue(e, t);
            if (i == null) return t;
            var a = Array.isArray(t) ? `array` : d(t),
              o = Array.isArray(i) ? `array` : d(i);
            if (n) {
              var s;
              return n(i)
      ...
      [
        {
          ...
          value: function (t) {
            var n = new e(
              ...
              t.ruleID,
              Fe(t.details),
              L(t.__evaluation?.secondary_exposures ?? []),
              t.groupName ?? void 0,
            );
          ...
          value: function (e, t, n) {
            ...
            return n
              ? n(i)
                ? a()
                : t
              : t == null || (d(i) === d(t) && Array.isArray(t) === Array.isArray(i))
                ? a()
                : t;
          },
        },
      ...
      [
        {
          ...
          value: function (t) {
            return new e(
              ...
              L(t.__evaluation?.secondary_exposures ?? []),
              L(t.__evaluation?.undelegated_secondary_exposures ?? []),
...
function z(e) {
  ...
  return (
    (z = function (e) {
      ...
      function n() {
        return Be(e, arguments, S(this).constructor);
      }
      return (
...
function Ve(e, t, n) {
  return ((t = S(t)), x(e, He() ? Reflect.construct(t, n || [], S(e).constructor) : t.apply(e, n)));
}
function He() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Ke = 5e3,
  qe = `https://api.atlassian.com/flags`,
  Je = `https://api.stg.atlassian.com/flags`,
  Ye = `https://api.dev.atlassian.com/flags`,
  Xe = `https://api.stg.atlassian-us-gov-mod.com/flags`,
  Ze = `https://api.atlassian-us-gov-mod.com/flags`,
  Qe = `https://atlassian-statsig-proxy-archetype.atl-paas.%s.atl-ic.net`,
  $e = `oasis-stg.com/flags`,
  et = `atlassian-isolated.net/flags`,
  tt = `/gateway/api/flags`,
  B = (function () {
    function e() {
      f(this, e);
    }
    return g(e, null, [
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 5:
                      ...
                      throw new Ue(`Unexpected 204 response`);
                    case 7:
                    case `end`:
                      return e.stop();
                  }
      ...
      },
      {
        ...
        value: function (e) {
          ...
          if (t === void 0) return e ? Qe.replace(`%s`, e) : null;
          var n = t.protocol,
            r = t.hostname,
            i = r.match(/([^.]+)\.oasis-stg\.com$/);
          if (i) return `${n}//api.${i[1]}.${$e}`;
          var a = r.match(/([^.]+)\.atlassian-isolated\.net$/);
          return a ? `${n}//api.${a[1]}.${et}` : null;
        },
      },
      {
...
function rt(e, t, n) {
  return ((t = S(t)), x(e, it() ? Reflect.construct(t, n || [], S(e).constructor) : t.apply(e, n)));
}
function it() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
function at(e, t, n, r) {
  var i = C(S(1 & r ? e.prototype : e), t, n);
...
var ot = (function (e) {
    function t() {
      ...
      return (
        f(this, t),
        (e = rt(this, t, [`NoFetchDataAdapter`, `nofetch`])),
        _(e, `bootstrapResult`, null),
        e
      );
    }
    return (
      ...
      g(t, [
          ...
          value: function (e) {
            this.bootstrapResult = e
              ? {
                  ...
                  receivedAt: Date.now(),
                  stableID: A.StableID.get(this._getSdkKey()),
                  fullUserHash: null,
                }
              : null;
          },
        ...
        },
        {
          ...
          value: function (e) {
            return (
              this.bootstrapResult &&
              V(V({}, this.bootstrapResult), {}, { fullUserHash: (0, A._getFullUserHash)(e) })
            );
          },
        },
        {
        ...
        },
        {
          key: `_getCacheKey`,
          value: function (e) {
            var t = (0, A._getStorageKey)(this._getSdkKey(), e);
            return `${A.DataAdapterCachePrefix}.${this._cacheSuffix}.${t}`;
          },
        },
        {
...
var W = `LocalOverride:Recognized`,
  dt = `STATSIG_OVERRIDES`,
  ft = `STATSIG_JS_LITE_LOCAL_OVERRIDES`,
  G = function () {
  ...
  pt = (function () {
    ...
    return g(e, [
      ...
      },
      {
        key: `mergeOverrides`,
        value: function () {
          for (var e = G(), t = [...arguments], n = 0, r = t; n < r.length; n++) {
            ...
            for (var v = 0, y = Object.entries((ee = i.layers) ?? {}); v < y.length; v++) {
              var ee,
                b = c(y[v], 2),
                te = b[0],
                x = b[1];
      ...
      },
      {
        ...
        value: function (e) {
          ...
          for (var n = 0, r = Object.entries(t); n < r.length; n++)
            for (
              var i = c(r[n], 2), a = i[0], o = i[1], s = 0, l = Object.entries(o);
              s < l.length;
              s++
            ) {
              var u = c(l[s], 2),
                d = u[0],
                f = u[1];
              this._djb2Map.set(K((0, H._DJB2)(d), a), f);
            }
          this._overrides = t;
        },
      },
      ...
      },
      {
        ...
        value: function (e, t) {
          ((this._overrides.gates[e] = t),
            this._djb2Map.set(K((0, H._DJB2)(e), `gates`), t),
            this.saveOverrides());
        },
      },
      {
        ...
        value: function (e) {
          (delete this._overrides.gates[e],
            this._djb2Map.delete(K((0, H._DJB2)(e), `gates`)),
            this.saveOverrides());
        },
      },
      {
        key: `getGateOverride`,
        value: function (e, t) {
          var n = this._overrides.gates[e.name] ?? this._djb2Map.get(K(e.name, `gates`));
          return n == null
            ? null
            : U(U({}, e), {}, { value: n, details: U(U({}, e.details), {}, { reason: W }) });
        },
      },
      {
        ...
        value: function (e, t) {
          ((this._overrides.configs[e] = t),
            this._djb2Map.set(K((0, H._DJB2)(e), `configs`), t),
            this.saveOverrides());
        },
      },
      {
        ...
        value: function (e) {
          (delete this._overrides.configs[e],
            this._djb2Map.delete(K((0, H._DJB2)(e), `configs`)),
            this.saveOverrides());
        },
      },
      {
      ...
      },
      {
        ...
        value: function (e, t) {
          ((this._overrides.layers[e] = t),
            this._djb2Map.set(K((0, H._DJB2)(e), `layers`), t),
            this.saveOverrides());
        },
      },
      {
        ...
        value: function (e) {
          (delete this._overrides.layers[e],
            this._djb2Map.delete(K((0, H._DJB2)(e), `layers`)),
            this.saveOverrides());
        },
      },
      {
      ...
      },
      {
        ...
        value: function (e, t) {
          var n = this._overrides.layers[e.name] ?? this._djb2Map.get(K(e.name, `layers`));
          return n == null
            ? null
            : U(
                U({}, e),
                ...
                {
                  __value: n,
                  get: (0, H._makeTypedGet)(e.name, n),
                  details: U(U({}, e.details), {}, { reason: W }),
                },
              );
        },
      },
      {
        ...
        value: function (e, t) {
          var n = t[e.name] ?? this._djb2Map.get(K(e.name, `configs`));
          return n == null
            ? null
            : U(
                U({}, e),
  ...
  mt = [`sdkKey`, `environment`, `updateUserCompletionCallback`, `perimeter`];
function ht(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var r = Object.getOwnPropertySymbols(e);
...
var gt = `client-default-key`,
  _t = `https://xp.atlassian.com/v1/rgstr`,
  vt = (function () {
    function e() {
      var t = this,
        ...
        a = n.overrideAdapter;
      (f(this, e),
        _(this, `initPromise`, null),
        _(this, `initCompleted`, !1),
        _(this, `initWithDefaults`, !1),
        _(this, `hasCheckGateErrorOccurred`, !1),
        _(this, `hasGetExperimentErrorOccurred`, !1),
        _(this, `hasGetExperimentValueErrorOccurred`, !1),
        _(this, `hasGetLayerErrorOccurred`, !1),
        _(this, `hasGetLayerValueErrorOccurred`, !1),
        _(this, `subscriptions`, new Ee()),
        _(this, `dataAdapter`, new ot()),
        _(this, `statsigValuesUpdated`, function () {
          (t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated());
        }),
        (this.overrideAdapter = a || new pt(i)));
    }
    return g(e, [
      {
        key: `initialize`,
              ...
              return k.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((a = P(t)), !this.initPromise)) {
                          e.next = 4;
                          break;
                        }
                        return (
                          F(a, this.initOptions) ||
                            console.warn(
              ...
              return k.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (((o = P(t)), !this.initPromise)) {
                          e.next = 4;
                          break;
                        }
                        return (
                          F(o, this.initOptions) ||
                            console.warn(
                              `Feature Gates client already initialized with different options. New options were not applied.`,
                            ),
                          e.abrupt(`return`, this.initPromise)
        ...
        value: function (e, t, n, r) {
          ...
          (i = this.initOptions.analyticsWebClient) == null ||
            i
              ...
              .catch(function (e) {
                a.initOptions.environment !== j.Production &&
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (i = P(t)),
                          (a = function () {
                            return B.fetchExperimentValues(i, n, r).then(function (e) {
                              return {
          ...
          try {
            ...
            return (
              (this.hasGetExperimentErrorOccurred ||=
                ...
                !0)),
              new Ie(e, {}, ``, { time: Date.now(), reason: ke.Error })
            );
          }
        },
      },
      ...
      },
      {
        key: `isCurrentUser`,
        value: function (e, t) {
          return F(this.currentIdentifiers, e) && F(this.currentAttributes, t);
        },
      },
      {
        key: `onGateUpdated`,
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 5:
                        return (
                          (e.prev = 5),
                          (s = B.fetchClientSdk(t).then(function (e) {
                            return (i.sdkKey = e.clientSdkKey);
                          })),
                          (l = B.fetchExperimentValues(t, n, r)),
                          (e.next = 10),
                          Promise.all([s, l])
                        );
                      case 10:
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (a = q(q({}, t), {}, { disableCurrentPageLogging: !0 })),
                          (e.prev = 1),
                          (e.next = 4),
                          n.setProfile(t, r, i)
                        );
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          ((i = o.networkConfig) != null && i.logEventUrl) ||
                            (o.networkConfig = q(q({}, o.networkConfig), {}, { logEventUrl: _t })),
                          o.perimeter === M.FEDRAMP_MODERATE && (o.disableLogging = !0),
                          (s = o.sdkKey),
                          (c = o.environment),
                          ...
                          (f = q(
                            ...
                            {},
                            {
                              ...
                              logEventCompressionMode: A.LogEventCompressionMode.Forced,
                            },
                          )),
                          n.stableId
                            ? A.StableID.setOverride(n.stableId, s)
                            : (f.disableStableID = !0),
                          (e.prev = 13),
                          (this.statsigClient = new A.StatsigClient(s, this.user, f)),
                      ...
                      case 20:
                        return (
                          ...
                          (this.statsigClient = new A.StatsigClient(gt, this.user, f)),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        ((o = e.sent),
                          (c = Me(n, o.customAttributesFromFetch)),
                          (s = I({}, o.experimentValues.user, c)),
                          (e.next = 14));
                        break;
                      case 9:
                        throw (
        ...
        value: function (e) {
          ...
          try {
            ...
            var n = t.fireLayerExposure,
              r = n === void 0 ? !0 : n;
            return Le.fromLayer(this.statsigClient.getLayer(e, { disableExposureLog: !r }));
          } catch (t) {
            return (
              (this.hasGetLayerErrorOccurred ||=
                ...
                !0)),
              Le.fromLayer((0, A._makeLayer)(e, { reason: `Error` }, null))
            );
          }
        },
      },
...
((J = Y),
  _(Y, `client`, new vt()),
  _(Y, `hasCheckGateErrorOccurred`, !1),
  _(Y, `hasGetExperimentValueErrorOccurred`, !1),
  _(Y, `checkGate`, function (e, t) {
    try {
      if (
        typeof window < `u` &&
  ...
  _(Y, `getExperimentValue`, function (e, t, n, r) {
    try {
      if (
        typeof window < `u` &&
        window.__CRITERION__ &&
  ...
  _(Y, `initializeCalled`, J.client.initializeCalled.bind(J.client)),
  _(Y, `initializeCompleted`, J.client.initializeCompleted.bind(J.client)),
  _(Y, `waitUntilInitializeCompleted`, J.client.waitUntilInitializeCompleted.bind(J.client)),
  _(Y, `initialize`, J.client.initialize.bind(J.client)),
  _(Y, `initializeWithProvider`, J.client.initializeWithProvider.bind(J.client)),
  _(Y, `initializeFromValues`, J.client.initializeFromValues.bind(J.client)),
  _(Y, `manuallyLogGateExposure`, J.client.manuallyLogGateExposure.bind(J.client)),
  _(Y, `getExperiment`, J.client.getExperiment.bind(J.client)),
  _(Y, `manuallyLogExperimentExposure`, J.client.manuallyLogExperimentExposure.bind(J.client)),
  _(Y, `manuallyLogLayerExposure`, J.client.manuallyLogLayerExposure.bind(J.client)),
  _(Y, `shutdownStatsig`, J.client.shutdownStatsig.bind(J.client)),
  _(Y, `overrideGate`, J.client.overrideGate.bind(J.client)),
  _(Y, `clearGateOverride`, J.client.clearGateOverride.bind(J.client)),
  _(Y, `overrideConfig`, J.client.overrideConfig.bind(J.client)),
  _(Y, `clearConfigOverride`, J.client.clearConfigOverride.bind(J.client)),
  _(Y, `setOverrides`, J.client.setOverrides.bind(J.client)),
  _(Y, `getOverrides`, J.client.getOverrides.bind(J.client)),
  _(Y, `clearAllOverrides`, J.client.clearAllOverrides.bind(J.client)),
  _(Y, `isCurrentUser`, J.client.isCurrentUser.bind(J.client)),
  _(Y, `onGateUpdated`, J.client.onGateUpdated.bind(J.client)),
  _(Y, `onExperimentValueUpdated`, J.client.onExperimentValueUpdated.bind(J.client)),
  _(Y, `onAnyUpdated`, J.client.onAnyUpdated.bind(J.client)),
  _(Y, `updateUser`, J.client.updateUser.bind(J.client)),
  _(Y, `updateUserWithProvider`, J.client.updateUserWithProvider.bind(J.client)),
  _(Y, `updateUserWithValues`, J.client.updateUserWithValues.bind(J.client)),
  _(Y, `getPackageVersion`, J.client.getPackageVersion.bind(J.client)),
  _(Y, `getLayer`, J.client.getLayer.bind(J.client)),
  _(Y, `getLayerValue`, J.client.getLayerValue.bind(J.client)));
var yt = Y;
if (typeof window < `u`)
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = Y;
  else {
    var bt, xt;
    yt = window.__FEATUREGATES_JS__;
    var St =
      ((bt = yt) == null || (xt = bt.getPackageVersion) == null ? void 0 : xt.call(bt)) ||
      `4.10.0 or earlier`;
    if (St !== `0.0.0-development`) {
      var Ct = `Multiple versions of FeatureGateClients found on the current page.
      The currently bound version is ${St} when module version ${R} was loading.`;
      console.warn(Ct);
    }
  }
var wt = yt,
  ...
  Z,
  Tt =
    (globalThis == null || (X = globalThis.process) == null || (X = X.env) == null
      ? void 0
      : X.JEST_WORKER_ID) === void 0 &&
    (globalThis == null || (Z = globalThis.process) == null || (Z = Z.env) == null
      ? void 0
      : Z.NODE_ENV) !== `production`,
  Et = function () {
    var e;
    Tt && (e = console).debug.apply(e, arguments);
  },
  Dt = `@atlaskit/platform-feature-flags`,
  Ot = `__PLATFORM_FEATURE_FLAGS__`,
  kt = typeof process < `u` && !0,
  At = kt ? {}.ENABLE_PLATFORM_FF === `true` : !1,
  jt = kt ? {}.STORYBOOK_ENABLE_PLATFORM_FF === `true` : !1,
  Mt = At || jt,
  Nt = { booleanResolver: void 0 },
  Q = typeof window < `u` ? window : globalThis;
Q[Ot] = Q.__PLATFORM_FEATURE_FLAGS__ || Nt;
function Pt(e) {
  if (Mt)
    return (
      Et(
  ...
  try {
    if (
      Q.__PLATFORM_FEATURE_FLAGS__?.booleanResolver === void 0 ||
      Q.__PLATFORM_FEATURE_FLAGS__?.booleanResolver === null
    )
      return wt.checkGate(e);
    var t = Q.__PLATFORM_FEATURE_FLAGS__?.booleanResolver(e);
...
function zt() {
  if (Ft(`platform-dst-shape-theme-default`)) return `shape`;
}
function Bt() {
  if (Ft(`platform-dst-motion-theme-default`)) return `motion`;
}
var Vt = {
    colorMode: `auto`,
    contrastMode: `auto`,
  ...
  Ut = `data-theme`,
  Wt = `data-subtree-theme`,
  Gt = `data-color-mode`,
  Kt = `data-contrast-mode`,
  qt = `data-custom-theme`,
...
function cn(e, t) {
  var n = sn(JSON.stringify(e)),
    r = [];
  return (
    (t === `auto` ? [`light`, `dark`] : [t]).forEach(function (e) {
      var t = document.head.querySelector(`style[${qt}="${n}"][${Ut}="${e}"]`);
...
function ln(e) {
  var t = b(Array.from(document.head.querySelectorAll(`style[${qt}][${Ut}]`)));
  t.length < e ||
