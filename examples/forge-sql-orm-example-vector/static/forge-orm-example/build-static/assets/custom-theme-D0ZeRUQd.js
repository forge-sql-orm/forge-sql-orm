...
var y = {
  ...
  S = function (e, t) {
    return t === `light` ? b[e] : y[e];
  },
  C = function (e) {
    var t = e.customThemeTokenMap,
      n = e.mode,
      r = e.themeRamp,
      i = {},
      a = Object.keys(t);
    return (
      x.forEach(function (e) {
        var o = e.backgroundLight,
          ...
          m = t[f];
        d(
          a.includes(c) ? (typeof p == `string` ? p : r[p]) : S(c, n),
          a.includes(f) ? (typeof m == `string` ? m : r[m]) : S(f, n),
        ) <= l &&
          u.forEach(function (e) {
            var r = t[e];
            typeof r == `number` && (i[e] = n === `light` ? r + 1 : r - 1);
          });
      }),
      i
    );
...
var A = [
  ...
  M = [95.047, 100, 108.883];
function N(e, t, n) {
  return ((255 << 24) | ((e & 255) << 16) | ((t & 255) << 8) | (n & 255)) >>> 0;
}
function P(e) {
  return N(G(e[0]), G(e[1]), G(e[2]));
}
function F(e) {
  return (e >> 24) & 255;
}
...
function z(e, t, n) {
  var r = j,
    i = r[0][0] * e + r[0][1] * t + r[0][2] * n,
    a = r[1][0] * e + r[1][1] * t + r[1][2] * n,
    o = r[2][0] * e + r[2][1] * t + r[2][2] * n;
  return N(G(i), G(a), G(o));
}
function B(e) {
  return k([W(I(e)), W(L(e)), W(R(e))], A);
}
function ee(e) {
  var t = G(H(e));
  return N(t, t, t);
...
function V(e) {
  var t = B(e)[1];
  return 116 * q(t / 100) - 16;
}
function H(e) {
  return 100 * ie((e + 16) / 116);
}
function U(e) {
  return q(e / 100) * 116 - 16;
}
function W(e) {
  var t = e / 255;
  return t <= 0.040449936 ? (t / 12.92) * 100 : ((t + 0.055) / 1.055) ** 2.4 * 100;
}
function G(e) {
  var t = e / 100,
    n = 0;
  return (
    (n = t <= 0.0031308 ? t * 12.92 : 1.055 * t ** (1 / 2.4) - 0.055),
    E(0, 255, Math.round(n * 255))
  );
}
function te() {
  return M;
...
function ne(e) {
  return { r: I(e), g: L(e), b: R(e), a: F(e) };
}
function re(e) {
  var t = e.r,
    n = e.g,
    ...
    return e(
      ...
      [
        ...
        },
        {
          ...
          set: function (e) {
            this.setInternalState(Z.solveToInt(e, this.internalChroma, this.internalTone));
          },
        },
        {
          key: `chroma`,
          ...
          set: function (e) {
            this.setInternalState(Z.solveToInt(this.internalHue, e, this.internalTone));
          },
        },
        {
          key: `tone`,
          ...
          set: function (e) {
            this.setInternalState(Z.solveToInt(this.internalHue, this.internalChroma, e));
          },
        },
        {
        ...
        },
        {
          ...
          value: function (e) {
            var n = X.fromInt(this.toInt()).xyzInViewingConditions(e),
              r = X.fromXyzInViewingConditions(n[0], n[1], n[2], Q.make());
            return t.from(r.hue, r.chroma, U(n[1]));
          },
        },
      ],
      [
        {
          ...
          value: function (e, n, r) {
            return new t(Z.solveToInt(e, n, r));
          },
        },
        {
          key: `fromInt`,
      ...
      [
        {
          key: `distance`,
          value: function (e) {
            var t = this.jstar - e.jstar,
              n = this.astar - e.astar,
              r = this.bstar - e.bstar;
            return 1.41 * Math.sqrt(t * t + n * n + r * r) ** 0.63;
          },
        },
        {
          key: `toInt`,
          value: function () {
            return this.viewed(Q.DEFAULT);
          },
        },
        {
          key: `viewed`,
          value: function (e) {
            var t =
                ((this.chroma === 0 || this.j === 0 ? 0 : this.chroma / Math.sqrt(this.j / 100)) /
                  (1.64 - 0.29 ** e.n) ** 0.73) **
                (1 / 0.9),
              n = (this.hue * Math.PI) / 180,
              r = 0.25 * (Math.cos(n + 2) + 3.8),
              i = e.aw * (this.j / 100) ** (1 / e.c / e.z),
              a = (5e4 / 13) * r * e.nc * e.ncb,
              o = i / e.nbb,
              s = Math.sin(n),
              c = Math.cos(n),
              l = (23 * (o + 0.305) * t) / (23 * a + 11 * t * c + 108 * t * s),
              u = l * c,
              d = l * s,
              f = (460 * o + 451 * u + 288 * d) / 1403,
              p = (460 * o - 891 * u - 261 * d) / 1403,
              m = (460 * o - 220 * u - 6300 * d) / 1403,
              h = Math.max(0, (27.13 * Math.abs(f)) / (400 - Math.abs(f))),
              g = w(f) * (100 / e.fl) * h ** (1 / 0.42),
              _ = Math.max(0, (27.13 * Math.abs(p)) / (400 - Math.abs(p))),
              v = w(p) * (100 / e.fl) * _ ** (1 / 0.42),
              y = Math.max(0, (27.13 * Math.abs(m)) / (400 - Math.abs(m))),
              b = w(m) * (100 / e.fl) * y ** (1 / 0.42),
              x = g / e.rgbD[0],
              S = v / e.rgbD[1],
              C = b / e.rgbD[2];
            return z(
              1.86206786 * x - 1.01125463 * S + 0.14918677 * C,
              0.38752654 * x + 0.62144744 * S - 0.00897398 * C,
              -0.0158415 * x - 0.03412294 * S + 1.04996444 * C,
            );
          },
        },
        {
      ...
      [
        {
          key: `fromInt`,
          value: function (e) {
            return t.fromIntInViewingConditions(e, Q.DEFAULT);
          },
        },
        {
          ...
          value: function (e, n) {
            var r = (e & 16711680) >> 16,
              ...
              s = W(i),
              c = W(a),
              l = 0.41233895 * o + 0.35762064 * s + 0.18051042 * c,
              u = 0.2126 * o + 0.7152 * s + 0.0722 * c,
              d = 0.01932141 * o + 0.11916382 * s + 0.95034478 * c,
              f = 0.401288 * l + 0.650173 * u - 0.051461 * d,
              p = -0.250268 * l + 1.204414 * u + 0.045854 * d,
              m = -0.002079 * l + 0.048952 * u + 0.953127 * d,
              h = n.rgbD[0] * f,
              g = n.rgbD[1] * p,
              _ = n.rgbD[2] * m,
              v = ((n.fl * Math.abs(h)) / 100) ** 0.42,
              y = ((n.fl * Math.abs(g)) / 100) ** 0.42,
              b = ((n.fl * Math.abs(_)) / 100) ** 0.42,
              x = (w(h) * 400 * v) / (v + 27.13),
              S = (w(g) * 400 * y) / (y + 27.13),
              C = (w(_) * 400 * b) / (b + 27.13),
              T = (11 * x + -12 * S + C) / 11,
              ...
              D = (20 * x + 20 * S + 21 * C) / 20,
              O = (40 * x + 20 * S + C) / 20,
              k = (Math.atan2(E, T) * 180) / Math.PI,
              A = k < 0 ? k + 360 : k >= 360 ? k - 360 : k,
              j = (A * Math.PI) / 180,
              M = 100 * ((O * n.nbb) / n.aw) ** +(n.c * n.z),
              N = (4 / n.c) * Math.sqrt(M / 100) * (n.aw + 4) * n.fLRoot,
              P = A < 20.14 ? A + 360 : A,
              F =
                (((5e4 / 13) *
                  (0.25 * (Math.cos((P * Math.PI) / 180 + 2) + 3.8)) *
                  n.nc *
                  n.ncb *
                  Math.sqrt(T * T + E * E)) /
                  (D + 0.305)) **
              ...
              I = F * Math.sqrt(M / 100),
              L = I * n.fLRoot,
              R = 50 * Math.sqrt((F * n.c) / (n.aw + 4)),
              z = (1.7000000000000002 * M) / (1 + 0.007 * M),
              B = (1 / 0.0228) * Math.log(1 + 0.0228 * L);
        ...
        },
        {
          key: `fromJch`,
          value: function (e, n, r) {
            return t.fromJchInViewingConditions(e, n, r, Q.DEFAULT);
          },
        },
        {
          key: `fromJchInViewingConditions`,
          value: function (e, n, r, i) {
            var a = (4 / i.c) * Math.sqrt(e / 100) * (i.aw + 4) * i.fLRoot,
              o = n * i.fLRoot,
              s = n / Math.sqrt(e / 100),
              c = 50 * Math.sqrt((s * i.c) / (i.aw + 4)),
              l = (r * Math.PI) / 180,
              u = (1.7000000000000002 * e) / (1 + 0.007 * e),
              d = (1 / 0.0228) * Math.log(1 + 0.0228 * o);
        ...
        },
        {
          key: `fromUcs`,
          value: function (e, n, r) {
            return t.fromUcsInViewingConditions(e, n, r, Q.DEFAULT);
          },
        },
        {
        ...
        },
        {
          ...
          value: function (e, n, r, i) {
            var a = 0.401288 * e + 0.650173 * n - 0.051461 * r,
              o = -0.250268 * e + 1.204414 * n + 0.045854 * r,
              s = -0.002079 * e + 0.048952 * n + 0.953127 * r,
              c = i.rgbD[0] * a,
              l = i.rgbD[1] * o,
              u = i.rgbD[2] * s,
              d = ((i.fl * Math.abs(c)) / 100) ** 0.42,
              f = ((i.fl * Math.abs(l)) / 100) ** 0.42,
              p = ((i.fl * Math.abs(u)) / 100) ** 0.42,
              m = (w(c) * 400 * d) / (d + 27.13),
              h = (w(l) * 400 * f) / (f + 27.13),
              g = (w(u) * 400 * p) / (p + 27.13),
              _ = (11 * m + -12 * h + g) / 11,
              ...
              y = (20 * m + 20 * h + 21 * g) / 20,
              b = (40 * m + 20 * h + g) / 20,
              x = (Math.atan2(v, _) * 180) / Math.PI,
              S = x < 0 ? x + 360 : x >= 360 ? x - 360 : x,
              C = (S * Math.PI) / 180,
              T = 100 * ((b * i.nbb) / i.aw) ** +(i.c * i.z),
              E = (4 / i.c) * Math.sqrt(T / 100) * (i.aw + 4) * i.fLRoot,
              D = S < 20.14 ? S + 360 : S,
              O =
                (((5e4 / 13) *
                  ((1 / 4) * (Math.cos((D * Math.PI) / 180 + 2) + 3.8)) *
                  i.nc *
                  i.ncb *
                  Math.sqrt(_ * _ + v * v)) /
                  (y + 0.305)) **
              ...
              k = O * Math.sqrt(T / 100),
              A = k * i.fLRoot,
              j = 50 * Math.sqrt((O * i.c) / (i.aw + 4)),
              M = (1.7000000000000002 * T) / (1 + 0.007 * T),
              N = Math.log(1 + 0.0228 * A) / 0.0228;
            return new t(S, k, T, E, A, j, M, N * Math.cos(C), N * Math.sin(C));
          },
        },
      ],
    );
    ...
    return e(t, null, [
      ...
      },
      {
        ...
        value: function (e) {
          var t = e / 100,
            n = 0;
          return ((n = t <= 0.0031308 ? t * 12.92 : 1.055 * t ** (1 / 2.4) - 0.055), n * 255);
        },
      },
      {
        key: `chromaticAdaptation`,
        value: function (e) {
          var t = Math.abs(e) ** 0.42;
          return (w(e) * 400 * t) / (t + 27.13);
        },
      },
      {
        key: `hueOf`,
        value: function (e) {
          var n = k(e, t.SCALED_DISCOUNT_FROM_LINRGB),
            r = t.chromaticAdaptation(n[0]),
            i = t.chromaticAdaptation(n[1]),
            a = t.chromaticAdaptation(n[2]),
            o = (11 * r + -12 * i + a) / 11,
            s = (r + i - 2 * a) / 9;
        ...
        value: function (e, n) {
          ...
          if (n < 4) {
            var c = o,
              l = s,
              u = (e - c * i - l * a) / r;
            return t.isBounded(u) ? [u, c, l] : [-1, -1, -1];
          } else if (n < 8) {
            var d = o,
              f = s,
              p = (e - f * r - d * a) / i;
            return t.isBounded(p) ? [f, p, d] : [-1, -1, -1];
          } else {
            var m = o,
              h = s,
              g = (e - m * r - h * i) / a;
            return t.isBounded(g) ? [m, h, g] : [-1, -1, -1];
          }
        },
      },
      {
        key: `bisectToSegment`,
        value: function (e, n) {
          for (var r = [-1, -1, -1], i = r, a = 0, o = 0, s = !1, c = !0, l = 0; l < 12; l++) {
            var u = t.nthVertex(e, l);
            if (!(u[0] < 0)) {
              var d = t.hueOf(u);
              if (!s) {
                ((r = u), (i = u), (a = d), (o = d), (s = !0));
              ...
              (c || t.areInCyclicOrder(a, d, o)) &&
                ((c = !1), t.areInCyclicOrder(a, n, d) ? ((i = u), (o = d)) : ((r = u), (a = d)));
            }
          }
          return [r, i];
        },
      ...
      },
      {
        ...
        value: function (e, n) {
          for (
            var r = t.bisectToSegment(e, n), i = r[0], a = t.hueOf(i), o = r[1], s = 0;
            s < 3;
            s++
          )
            if (i[s] !== o[s]) {
              var c = -1,
                l = 255;
              i[s] < o[s]
                ? ((c = t.criticalPlaneBelow(t.trueDelinearized(i[s]))),
                  (l = t.criticalPlaneAbove(t.trueDelinearized(o[s]))))
                : ((c = t.criticalPlaneAbove(t.trueDelinearized(i[s]))),
                  (l = t.criticalPlaneBelow(t.trueDelinearized(o[s]))));
              for (var u = 0; u < 8 && !(Math.abs(l - c) <= 1); u++) {
                var d = Math.floor((c + l) / 2),
                  f = t.CRITICAL_PLANES[d],
                  p = t.setCoordinate(i, f, o, s),
                  m = t.hueOf(p);
                t.areInCyclicOrder(a, n, m) ? ((o = p), (l = d)) : ((i = p), (a = m), (c = d));
              }
            }
      ...
      },
      {
        ...
        value: function (e, n, r) {
          for (
            var i = Math.sqrt(r) * 11,
              a = Q.DEFAULT,
              o = 1 / (1.64 - 0.29 ** a.n) ** 0.73,
              s = 0.25 * (Math.cos(e + 2) + 3.8) * (5e4 / 13) * a.nc * a.ncb,
              c = Math.sin(e),
              l = Math.cos(e),
              u = 0;
            u < 5;
            ...
            var d = i / 100,
              f = ((n === 0 || i === 0 ? 0 : n / Math.sqrt(d)) * o) ** (1 / 0.9),
              p = (a.aw * d ** (1 / a.c / a.z)) / a.nbb,
              m = (23 * (p + 0.305) * f) / (23 * s + 11 * f * l + 108 * f * c),
              h = m * l,
              g = m * c,
              _ = (460 * p + 451 * h + 288 * g) / 1403,
              v = (460 * p - 891 * h - 261 * g) / 1403,
              y = (460 * p - 220 * h - 6300 * g) / 1403,
              b = k(
                [
                  t.inverseChromaticAdaptation(_),
            ...
            var x = t.Y_FROM_LINRGB[0],
              S = t.Y_FROM_LINRGB[1],
              C = t.Y_FROM_LINRGB[2],
              w = x * b[0] + S * b[1] + C * b[2];
            if (w <= 0) return 0;
            if (u === 4 || Math.abs(w - r) < 0.002)
              return b[0] > 100.01 || b[1] > 100.01 || b[2] > 100.01 ? 0 : P(b);
            i -= ((w - r) * i) / (2 * w);
          }
          return 0;
        },
      },
      {
        key: `solveToInt`,
        value: function (e, n, r) {
          if (n < 1e-4 || r < 1e-4 || r > 99.9999) return ee(r);
          e = O(e);
          var i = (e / 180) * Math.PI,
            a = H(r),
            o = t.findResultByJ(i, n, a);
          return o === 0 ? P(t.bisectToLimit(a, i)) : o;
        },
      },
      {
        key: `solveToCam`,
        value: function (e, n, r) {
          return X.fromInt(t.solveToInt(e, n, r));
        },
      },
    ]);
  })();
(a(Z, `SCALED_DISCOUNT_FROM_LINRGB`, [
  [0.001200833568784504, 0.002389694492170889, 0.0002795742885861124],
  [0.0005891086651375999, 0.0029785502573438758, 0.0003270666104008398],
  [0.00010146692491640572, 0.0005364214359186694, 0.0032979401770712076],
]),
  a(Z, `LINRGB_FROM_SCALED_DISCOUNT`, [
    [1373.2198709594231, -1100.4251190754821, -7.278681089101213],
    [-271.815969077903, 559.6580465940733, -32.46047482791194],
    [1.9622899599665666, -57.173814538844006, 308.7233197812385],
  ]),
  a(Z, `Y_FROM_LINRGB`, [0.2126, 0.7152, 0.0722]),
  a(
    Z,
    `CRITICAL_PLANES`,
    [
...
var Q = (function () {
  function t(e, n, r, i, a, o, s, c, l, u) {
    (_(this, t),
      (this.n = e),
      (this.aw = n),
      (this.nbb = r),
  ...
  return e(t, null, [
    {
      key: `make`,
      value: function () {
        var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : te(),
          n =
            arguments.length > 1 && arguments[1] !== void 0
              ? arguments[1]
              : ((200 / Math.PI) * H(50)) / 100,
          r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 50,
          i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 2,
          a = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !1,
          o = e,
          s = o[0] * 0.401288 + o[1] * 0.650173 + o[2] * -0.051461,
          c = o[0] * -0.250268 + o[1] * 1.204414 + o[2] * 0.045854,
          l = o[0] * -0.002079 + o[1] * 0.048952 + o[2] * 0.953127,
          u = 0.8 + i / 10,
          d = u >= 0.9 ? T(0.59, 0.69, (u - 0.9) * 10) : T(0.525, 0.59, (u - 0.8) * 10),
          f = a ? 1 : u * (1 - (1 / 3.6) * Math.exp((-n - 42) / 92));
        f = f > 1 ? 1 : f < 0 ? 0 : f;
        var p = u,
          m = [(100 / s) * f + 1 - f, (100 / c) * f + 1 - f, (100 / l) * f + 1 - f],
          h = 1 / (5 * n + 1),
          g = h * h * h * h,
          _ = 1 - g,
          v = g * n + 0.1 * _ * _ * Math.cbrt(5 * n),
          y = H(r) / e[1],
          b = 1.48 + Math.sqrt(y),
          x = 0.725 / y ** 0.2,
          S = x,
        ...
        return new t(y, (2 * w[0] + w[1] + 0.05 * w[2]) * x, x, S, d, p, m, v, v ** 0.25, b);
      },
    },
  ]);
})();
((J = Q), a(Q, `DEFAULT`, J.make()));
var ae = (function () {
  function t() {
    _(this, t);
  }
  return e(t, null, [
    {
      key: `ratioOfTones`,
      value: function (e, n) {
        return ((e = D(0, 100, e)), (n = D(0, 100, n)), t.ratioOfYs(H(e), H(n)));
      },
    },
    {
      key: `ratioOfYs`,
...
var ce = [1.12, 1.33, 2.03, 2.73, 3.33, 4.27, 5.2, 6.62, 12.46, 14.25],
  le = [1.08, 1.24, 1.55, 1.99, 2.45, 3.34, 4.64, 6.1, 10.19, 12.6],
  ue = function (e, r) {
    var i = 0,
      a = null;
    return (
  ...
  $ = function (e) {
    var t = m(e)[0],
      n = s(t, 100, 60),
      i = g(n[0], n[1], n[2]) < 0.4 ? ce : le,
      a = c(e),
      l = Y.fromInt(re({ r: a[0], g: a[1], b: a[2], a: a[3] })),
      u = i.map(function (e) {
        var t = ne(Y.from(l.hue, l.chroma, ae.darker(100, e) + 0.25).toInt());
        return r(t.r, t.g, t.b);
      }),
      d = ue(u, e),
      f = o(u);
    return ((f[d] = e), { ramp: f, replacedColor: u[d] });
  };
function de(e, t, n) {
  for (var r = [], i = 1; i <= t; i++)
...
var fe = function (e, t, n) {
    ...
    if (u >= 4.5) {
      var f = v(de(s, 2, o), 2),
        ...
        m = f[1],
        h = s;
      u < 5.4 && u >= 4.8 && s === 6 && (h = s + 1);
      var g = v(de(h, 1, o), 1)[0];
      c = {
        "color.text.brand": h,
        "color.icon.brand": s,
        ...
        "color.background.brand.bold": s,
        "color.background.brand.bold.hovered": p,
        "color.background.brand.bold.pressed": m,
        "color.background.brand.boldest": 9,
        "color.background.brand.boldest.hovered": 8,
        "color.background.brand.boldest.pressed": 7,
        "color.border.brand": s,
        "color.text.selected": h,
        "color.icon.selected": s,
        "color.background.selected.bold": s,
        "color.background.selected.bold.hovered": p,
        "color.background.selected.bold.pressed": m,
        "color.border.selected": s,
        "color.link": h,
        "color.link.pressed": g,
        "color.chart.brand": 5,
      ...
      (u < 4.5 && u >= 4 && s === 6 && (_ = a),
        (c = {
          ...
          "color.background.selected.bold": _,
    ...
    if (t === `light`) return { light: c };
    if (
      (Object.entries(c).forEach(function (e) {
        var t = v(e, 2),
          n = t[0],
          r = t[1];
        l[n] = 9 - (typeof r == `string` ? s : r);
      }),
      u < 4.5)
    ) {
      var b = y[`color.text.inverse`];
      d(b, e) >= 4.5 &&
        s >= 2 &&
        ((l[`color.background.brand.bold`] = s),
        (l[`color.background.brand.bold.hovered`] = s - 1),
        (l[`color.background.brand.bold.pressed`] = s - 2));
    }
    return t === `dark` ? { dark: l } : { light: c, dark: l };
  },
  pe = function (e, t, n) {
    var r = n || $(e).ramp,
      i = fe(e, t, r),
    ...
    return (
      Object.entries(i).forEach(function (e) {
        var t = v(e, 2),
          ...
          i = t[1];
        (n === `light` || n === `dark`) &&
          (a[n] = se(se({}, i), C({ customThemeTokenMap: i, mode: n, themeRamp: r })));
      }),
      a
    );
  },
...
function he(e) {
  var t,
    ...
    r = e?.colorMode || l.colorMode,
    a = p(JSON.stringify(e?.UNSAFE_themeOptions)),
    o = $(n).ramp,
    s = [],
    c = pe(n, r, o);
  return (
    (r === `light` || r === `auto`) &&
      ...
      s.push({
        id: `light`,
        attrs: { "data-theme": `light`, "data-custom-theme": a },
        css: `
html[${f}="${a}"][${i}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${u(c.light, o)}
}`,
      }),
    (r === `dark` || r === `auto`) &&
      ...
      s.push({
        id: `dark`,
        attrs: { "data-theme": `dark`, "data-custom-theme": a },
        css: `
html[${f}="${a}"][${i}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${u(c.dark, o)}
}`,
      }),
  ...
  (h(10),
    t.map(function (e) {
      ...
      (document.head.appendChild(t),
        (t.dataset.theme = e.attrs[`data-theme`]),
        (t.dataset.customTheme = e.attrs[`data-custom-theme`]),
        (t.textContent = e.css));
    }));
}
export {
  me as CUSTOM_STYLE_ELEMENTS_SIZE_THRESHOLD,
  he as getCustomThemeStyles,
  ge as loadAndAppendCustomThemeCss,
};
