                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        at(
                                          () => import(`./custom-theme-Di5WBmZw.js`),
                                          __vite__mapDeps([2, 3]),
                                          import.meta.url,
                                        )
                                      );
...
var qf = function (e) {
  ...
  Yf = function (e, t) {
    if (typeof e == `function`) return Jf(e, t);
    e != null && (e.current = t);
  },
  Xf = function (e) {
    return e.reduce(function (e, t) {
  ...
  op = `popper`,
  sp = `reference`,
  cp = np.reduce(function (e, t) {
    return e.concat([t + `-` + rp, t + `-end`]);
  }, []),
  lp = [].concat(np, [tp]).reduce(function (e, t) {
    return e.concat([t, t + `-` + rp, t + `-end`]);
  }, []),
  up = [
    `beforeRead`,
    `read`,
...
function hp(e) {
  return typeof ShadowRoot > `u` ? !1 : e instanceof fp(e).ShadowRoot || e instanceof ShadowRoot;
}
function gp(e) {
  var t = e.state;
...
function Tp(e, t, n) {
  ...
  t &&
    mp(e) &&
    ((i = (e.offsetWidth > 0 && Sp(r.width) / e.offsetWidth) || 1),
    (a = (e.offsetHeight > 0 && Sp(r.height) / e.offsetHeight) || 1));
  var o = (pp(e) ? fp(e) : window).visualViewport,
    s = !wp() && n,
...
function Ap(e) {
  return ((pp(e) ? e.ownerDocument : e.document) || window.document).documentElement;
}
function jp(e) {
  return dp(e) === `html` ? e : e.assignedSlot || e.parentNode || (hp(e) ? e.host : null) || Ap(e);
}
function Mp(e) {
  return !mp(e) || Op(e).position === `fixed` ? null : e.offsetParent;
}
function Np(e) {
  var t = /firefox/i.test(Cp());
  if (/Trident/i.test(Cp()) && mp(e) && Op(e).position === `fixed`) return null;
  var n = jp(e);
  for (hp(n) && (n = n.host); mp(n) && [`html`, `body`].indexOf(dp(n)) < 0; ) {
    var r = Op(n);
    if (
      r.transform !== `none` ||
      r.perspective !== `none` ||
...
function Pp(e) {
  for (var t = fp(e), n = Mp(e); n && kp(n) && Op(n).position === `static`; ) n = Mp(n);
  return n && (dp(n) === `html` || (dp(n) === `body` && Op(n).position === `static`))
    ? t
    : n || Np(e) || t;
}
function Fp(e) {
...
function Up(e) {
  ...
  r != null &&
    ((typeof r == `string` && ((r = t.elements.popper.querySelector(r)), !r)) ||
      (Dp(t.elements.popper, r) && (t.elements.arrow = r)));
}
var Wp = {
  name: `arrow`,
  enabled: !0,
...
function qp(e, t) {
  ...
  return { x: Sp(n * i) / i || 0, y: Sp(r * i) / i || 0 };
}
function Jp(e) {
  var t,
    n = e.popper,
  ...
  var D = Object.assign({ position: s }, l && Kp),
    O = u === !0 ? qp({ x: p, y: h }, fp(n)) : { x: p, y: h };
  if (((p = O.x), (h = O.y), c)) {
    var k;
...
var Xp = { name: `computeStyles`, enabled: !0, phase: `beforeWrite`, fn: Yp, data: {} },
  Zp = { passive: !0 };
function Qp(e) {
  var t = e.state,
    n = e.instance,
  ...
  return (
    ...
    s && c.addEventListener(`resize`, n.update, Zp),
    function () {
      (a &&
        l.forEach(function (e) {
          e.removeEventListener(`scroll`, n.update, Zp);
        }),
        s && c.removeEventListener(`resize`, n.update, Zp));
    }
  );
}
var $p = {
...
function am(e) {
  return Tp(Ap(e)).left + im(e).scrollLeft;
}
function om(e, t) {
  var n = fp(e),
    r = Ap(e),
  ...
  return { width: a, height: o, x: s + am(e), y: c };
}
function sm(e) {
  var t = Ap(e),
    n = im(e),
    r = e.ownerDocument?.body,
    i = bp(t.scrollWidth, t.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0),
    a = bp(t.scrollHeight, t.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0),
    o = -n.scrollLeft + am(e),
    s = -n.scrollTop;
  return (
    Op(r || t).direction === `rtl` && (o += bp(t.clientWidth, r ? r.clientWidth : 0) - i),
...
function um(e, t) {
  ...
  var n = lm(e),
    ...
    i = fp(n),
    a = r ? [i].concat(i.visualViewport || [], cm(n) ? n : []) : n,
    o = t.concat(a);
  return r ? o : o.concat(um(jp(a)));
}
function dm(e) {
...
function pm(e, t, n) {
  return t === `viewport` ? dm(om(e, n)) : pp(t) ? fm(t, n) : dm(sm(Ap(e)));
}
function mm(e) {
  var t = um(jp(e)),
    n = [`absolute`, `fixed`].indexOf(Op(e).position) >= 0 && mp(e) ? Pp(e) : e;
  return pp(n)
    ? t.filter(function (e) {
        return pp(e) && Dp(e, n) && dp(e) !== `body`;
      })
    : [];
}
function hm(e, t, n, r) {
  var i = t === `clippingParents` ? mm(e) : [].concat(t),
    ...
    s = a.reduce(
      function (t, n) {
        var i = pm(e, n, r);
        return (
          (t.top = bp(i.top, t.top)),
          (t.right = xp(i.right, t.right)),
          (t.bottom = xp(i.bottom, t.bottom)),
          (t.left = bp(i.left, t.left)),
          t
        );
      },
      pm(e, o, r),
...
function _m(e, t) {
  ...
  var n = t,
    ...
    h = n.padding,
    g = h === void 0 ? 0 : h,
    _ = zp(typeof g == `number` ? Bp(g, np) : g),
    v = f === `popper` ? sp : op,
    y = e.rects.popper,
    b = e.elements[m ? v : f],
    x = hm(pp(b) ? b : b.contextElement || Ap(e.elements.popper), c, u, o),
    S = Tp(e.elements.reference),
    C = gm({ reference: S, element: y, strategy: `absolute`, placement: i }),
...
function vm(e, t) {
  ...
  var p = f.reduce(function (t, n) {
    return ((t[n] = _m(e, { placement: n, boundary: i, rootBoundary: a, padding: o })[yp(n)]), t);
  }, {});
  ...
  if (!t.modifiersData[r]._skip) {
    for (
      ...
      var E = y[T],
        D = yp(E),
        O = Gp(E) === rp,
        k = [`top`, Qf].indexOf(D) >= 0,
        A = k ? `width` : `height`,
        j = _m(t, { placement: E, boundary: u, rootBoundary: d, altBoundary: f, padding: l }),
        M = k ? (O ? $f : ep) : O ? Qf : `top`;
      b[A] > x[A] && (M = tm(M));
      var N = tm(M),
        P = [];
...
function Cm(e) {
  return [`top`, $f, Qf, ep].some(function (t) {
    return e[t] >= 0;
  });
}
function wm(e) {
  var t = e.state,
    ...
    o = _m(t, { elementContext: `reference` }),
    s = _m(t, { altBoundary: !0 }),
    c = Sm(o, r),
    l = Sm(s, i, a),
    u = Cm(c),
    d = Cm(l);
...
function Dm(e) {
  var t = e.state,
    ...
    i = n.offset,
    a = i === void 0 ? [0, 0] : i,
    o = lp.reduce(function (e, n) {
      return ((e[n] = Em(n, t.rects, a)), e);
    }, {}),
    s = o[t.placement],
    c = s.x,
    l = s.y;
...
var Om = { name: `offset`, enabled: !0, phase: `main`, requires: [`popperOffsets`], fn: Dm };
function km(e) {
  var t = e.state,
    n = e.name;
...
var Am = { name: `popperOffsets`, enabled: !0, phase: `read`, fn: km, data: {} };
function jm(e) {
  return e === `x` ? `y` : `x`;
}
function Mm(e) {
  var t = e.state,
    ...
    m = n.tetherOffset,
    h = m === void 0 ? 0 : m,
    g = _m(t, { boundary: c, rootBoundary: l, padding: d, altBoundary: u }),
    _ = yp(t.placement),
    v = Gp(t.placement),
    y = !v,
    b = Fp(_),
  ...
  if (S) {
    if (a) {
      var k = b === `y` ? `top` : ep,
        ...
        ne = v === `start` ? -w[j] : -C[j],
        re = t.elements.arrow,
        ie = p && re ? Ep(re) : { width: 0, height: 0 },
        ...
        ue = t.elements.arrow && Pp(t.elements.arrow),
        de = ue ? (b === `y` ? ue.clientTop || 0 : ue.clientLeft || 0) : 0,
        fe = D?.[b] ?? 0,
        pe = M + ce - fe - de,
        me = M + le - fe,
        he = Ip(p ? xp(N, pe) : N, M, p ? bp(P, me) : P);
      ((S[b] = he), (O[b] = he - M));
    }
    if (s) {
      var ge = b === `x` ? `top` : ep,
...
function Fm(e) {
  return e === fp(e) || !mp(e) ? im(e) : Pm(e);
}
function Im(e) {
  var t = e.getBoundingClientRect(),
    n = Sp(t.width) / e.offsetWidth || 1,
    r = Sp(t.height) / e.offsetHeight || 1;
  return n !== 1 || r !== 1;
}
function Lm(e, t, n) {
  n === void 0 && (n = !1);
  ...
  return (
    (r || (!r && !n)) &&
      ((dp(t) !== `body` || cm(a)) && (s = Fm(t)),
      mp(t) ? ((c = Tp(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : a && (c.x = am(a))),
    {
...
var Hm = { placement: `bottom`, modifiers: [], strategy: `absolute` };
function Um() {
      ...
      c = {
        ...
        setOptions: function (n) {
          ...
          (u(),
            ...
            (i.scrollParents = {
              reference: pp(e) ? um(e) : e.contextElement ? um(e.contextElement) : [],
              popper: um(t),
            }));
          var s = zm(Vm([].concat(r, i.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!s) {
            ...
            if (Um(t, n)) {
              ((i.rects = {
                reference: Lm(t, Pp(n), i.options.strategy === `fixed`),
                popper: Ep(n),
              }),
                (i.reset = !1),
...
var Gm = Wm({ defaultModifiers: [$p, Am, Xp, vp, Om, xm, Nm, Wp, Tm] }),
  Km = i((e, t) => {
    ...
    var r = T.useRef(null),
      ...
      l = T.useMemo(
        function () {
          ...
          return (0, Jm.default)(r.current, e) ? r.current || e : ((r.current = e), e);
        },
...
function oh(e) {
  var t = e.children,
    ...
    y = (0, T.useMemo)(
      function () {
        var e = {
            name: `preventOverflow`,
            options: { padding: nh, rootBoundary: h ? `viewport` : `document` },
          },
          t = { name: `offset`, options: { offset: [_, v] } },
          n = h ? th({ viewportPadding: nh }) : [];
        return [].concat(rh, [e, t], l(n));
      },
      [_, v, h],
    ),
    b = (0, T.useMemo)(
  ...
  return T.createElement(eh, { modifiers: b, placement: o, strategy: p, referenceElement: c }, n);
}
var sh = `atlaskit-portal-container`,
  ch = `body > .atlaskit-portal-container`,
  lh = `atlaskit-portal`,
  uh = function () {
    return document.body;
  },
  dh = function () {
    var e = document.querySelector(ch);
    if (!e) {
      var t,
  ...
  fh = function (e) {
    e.parentElement || dh().appendChild(e);
  },
  ph = function (e) {
    var t = document.createElement(`div`);
    return ((t.className = lh), (t.style.zIndex = `${e}`), t);
  },
  mh = function () {
    var e = document.querySelector(ch);
    if (!e) {
...
function gh(e) {
  ...
  return (
    ...
    (0, T.useEffect)(
      function () {
        J(`import_into_jsm_in_template_gallery_killswitch`) && i && hh(a);
      },
      [i, a],
    ),
    (0, T.useEffect)(
    ...
    (0, qm.createPortal)(o ? T.createElement(Rd, { defaultColorMode: o }, n) : n, a)
  );
}
var _h = typeof window < `u` ? T.useLayoutEffect : T.useEffect,
  vh = function () {
        ...
        if (J(`import_into_jsm_in_template_gallery_killswitch`)) {
          if (!r) {
            ...
            return !e || !n
              ...
              : (n.appendChild(e),
                function () {
                  (n && (n.removeChild(e), !n.hasChildNodes() && Ch(n)), o(null));
                });
          }
        } else {
          var i = yh(t);
...
var Th = function (e) {
    var t = f((0, T.useState)(!1), 2),
      ...
      i = f(
        (0, T.useState)(function () {
          return e === `layoutEffect` ? _h : T.useEffect;
        }),
        1,
      )[0];
    return (
  ...
  kh = function (e) {
    return Oh.hasOwnProperty(e) ? Oh[e] : null;
  },
  Ah = function (e, t) {
    var n = { layer: kh(Number(t)), zIndex: t };
...
function Nh(e) {
  ...
  return (
    ...
    J(`platform_design_system_team_portal_logic_r18_fix`)
      ? T.createElement(wh, { zIndex: n, isClosed: s }, r)
      : c
        ? T.createElement(gh, { zIndex: n, isClosed: s }, r)
        : null
  );
}
var Ph = new Set(),
...
function Ih() {
  Fh ||
    ((Fh = (0, Zu.bindAll)(window, [
      { type: `dragend`, listener: Lh },
      { type: `pointerdown`, listener: Lh },
      {
        type: `pointermove`,
        listener: (function () {
          var e = 0;
    ...
    Array.from(Ph).forEach(function (e) {
      e.onDragStart();
    }));
}
function Lh() {
...
function Rh() {
  return (0, Zu.bindAll)(window, [
    { type: `dragstart`, listener: Ih },
    { type: `dragenter`, listener: Ih },
  ]);
}
var zh = null;
function Bh(e) {
  return (
    (zh ||= Rh()),
    Ph.add(e),
    e.onRegister({ isDragging: Fh !== null }),
    function () {
      if ((Ph.delete(e), Ph.size === 0)) {
        var t;
        ((t = zh) == null || t(), (zh = null));
      }
    }
...
var Uh = null;
function Wh() {
  Uh != null && (window.clearTimeout(Uh), (Uh = null));
}
function Gh(e, t) {
  (Wh(),
    (Uh = window.setTimeout(function () {
      ((Uh = null), e());
    }, t)));
}
var Kh = null;
function qh(e) {
  ...
  function o() {
    if (n()) {
      ...
      if (t === `hide-animating`) {
        ((t = `shown`), Wh(), e.show({ isImmediate: !1 }));
        return;
      }
    }
  }
  ...
  function d() {
    var n = J(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? e.shouldAlwaysFadeIn : !1,
      r = !!(Kh && Kh.isVisible()) && !n;
    ((Kh &&= (Wh(), Kh.entry.hide({ isImmediate: !0 }), Kh.entry.done(), null)),
      (Kh = { entry: e, isVisible: l }));
    function i() {
    ...
    ((t = `waiting-to-show`), Gh(i, e.delay));
  }
  return (
    d(),
    {
...
var Xh = {
  ...
  Zh = function (e) {
    ...
    return T.createElement(
      `div`,
      { className: Y([Xh.shortcutSegmentsContainer]) },
      t.map(function (e, t) {
        return T.createElement(`kbd`, { key: `${e}-${t}`, className: Y([Xh.shortcutSegment]) }, e);
      }),
    );
  };
X();
var Qh = (0, T.forwardRef)(function (e, t) {
  var n = e.style,
    r = e.className,
    i = e.children,
    a = e.placement,
  ...
  return T.createElement(
    ...
    T.createElement(
      ...
      i,
      u && T.createElement(Zh, { shortcut: u }),
    ),
  );
});
((Qh.displayName = `TooltipPrimitive`), X());
var $h = {
  ...
  eg = (0, T.forwardRef)(function (e, t) {
    var n = e.style,
      r = e.className,
      i = e.children,
      a = e.truncate,
    ...
    return T.createElement(
      Qh,
      {
        ref: t,
        style: n,
        className: Y([$h.base, a && $h.truncate, r]),
        placement: o,
        testId: s,
        id: u,
        onMouseOut: c,
...
eg.displayName = `TooltipContainer`;
function tg(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var r = Object.getOwnPropertySymbols(e);
...
var rg = Rs.tooltip(),
  ig = { componentName: `tooltip`, packageName: `@atlaskit/tooltip`, packageVersion: `21.1.6` },
  ag = { top: `bottom`, bottom: `top`, left: `right`, right: `left` },
  og = function (e) {
    return e.split(`-`)[0];
  };
function sg(e) {
  var t = e.children,
    ...
    ae = ie ? a : r,
    oe = Ao(ng({ fn: v, action: `displayed`, analyticsData: D }, ig)),
    se = Ao(ng({ fn: b, action: `hidden`, analyticsData: D }, ig)),
    F = (0, T.useRef)(null),
            ...
            ie
              ? {
                  ...
                  mouse: J(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
                    ? void 0
                    : Vh({ left: e.clientX, top: e.clientY }),
                  clientX: e.clientX,
                  clientY: e.clientY,
                }
              : { type: `keyboard` },
      ...
      ? function (e) {
          ...
          (t = F.current) != null &&
            ...
            (J(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ||
              (F.current.mousePosition = Vh({ left: e.clientX, top: e.clientY })),
  ...
  var Re = function () {
      ...
      return ie &&
        ...
        de.current &&
        J(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
        ? Hh(F.current.mousePos, { targetElement: de.current, tooltipPosition: r })
        : ie &&
            (t = F.current) != null &&
            t.mousePosition &&
            !J(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
  ...
  var He = Fe
      ...
      : null,
    Ue = re && J(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? T.Fragment : cg;
  return T.createElement(
    T.Fragment,
    null,
    typeof t == `function`
      ? T.createElement(
          T.Fragment,
          null,
          t(ng(ng({}, Be), {}, { "aria-describedby": ze, ref: me })),
          He,
        )
    ...
    Pe
      ? T.createElement(
          Ue,
          null,
          T.createElement(oh, { placement: ae, referenceElement: Re(), strategy: k }, function (e) {
            var t = e.ref,
              n = e.style,
              r = e.update,
              i = e.placement,
                  ...
                  function (e) {
                    ...
                    return T.createElement(
                      u,
                      {
                        ref: t,
                        className: `Tooltip ${i}`,
                        style: ng(ng({}, n), j && { pointerEvents: `none` }),
                        truncate: c,
                        placement: ae,
...
var cg = function (e) {
  var t = e.children;
  return T.createElement(Nh, { zIndex: rg }, t);
};
X();
var lg = [
  `width`,
...
var fg = `--local-dynamic-table-text-color`,
  pg = (0, T.forwardRef)(function (e, t) {
    ...
    var s = e.style,
      ...
      l = d(e, lg),
      u = dg(
        dg(dg({}, s), n && lc({ width: n })),
        {},
        x({}, fg, `var(--ds-text-subtlest, #6B6E76)`),
      ),
      f = i === `ASC`,
      p = i === Hs,
      m = function () {
...
var mg = e(gf()),
  ...
  yg = function (e) {
    ...
    var i = e.innerRef,
      ...
      P = T.createElement(
        ll,
        { xcss: vg.headCellContainer, onMouseEnter: M, onMouseLeave: N, onFocus: A, onBlur: j },
        T.createElement(
          sg,
          { content: o === `ASC` ? p : h },
          T.createElement(
            ...
            T.createElement(
              ...
              T.createElement(`span`, { className: Y([vg.text]) }, t),
            ),
            k &&
              T.createElement(
                wl,
...
var Cg = mf(
    (function (e) {
      function t() {
        return (h(this, t), xg(this, t, arguments));
      }
      return (
        _(t, e),
        u(t, [
          {
            ...
            value: function () {
              ...
              var n = e.refWidth,
                r = d(e, bg),
                i = hf(t, n);
              return T.createElement(yg, z({ inlineStyles: i }, r));
            },
          },
        ])
      );
...
function Eg(e, t, n) {
  return ((t = b(t)), m(e, Dg() ? Reflect.construct(t, n || [], b(e).constructor) : t.apply(e, n)));
}
function Dg() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
...
var Og = (function (e) {
  function t(e) {
    var n;
    return (h(this, t), (n = Eg(this, t, [e])), (n.state = { activeSortButtonId: null }), n);
  }
  return (
    _(t, e),
    u(t, [
...
var jg = function (e) {
  ...
  Mg = (0, T.lazy)(function () {
    return at(
      () => import(`./body-DASESyRe.js`),
      __vite__mapDeps([4, 1, 3, 5, 6]),
      import.meta.url,
    );
  }),
  Ng = (0, T.forwardRef)(function (e, t) {
    var n = e.isRankable,
      r = n === void 0 ? !1 : n,
      i = e.isRanking,
      a = e.onRankStart,
...
var Bg = {
  ...
  Jg = { default: `_11c81d4k _1tn2fhey`, monospace: `_11c81d4k _ect4zzfg _1tn2fhey _14md1vhz` },
  Yg = {
  ...
  Zg = (0, T.forwardRef)(function (e, t) {
      ...
      z(
        ...
        M,
        {
          ...
          style: zg(
            ...
            {
              maxHeight: E,
              "--_19uzta9": Xo(`background-color ${Gg} ease-in-out,
               border-color ${Gg} ease-in-out`),
              "--_dqsusn": Xo(`${Hg * x + Ug * 2 + N * 2}px`),
              "--_n9nqvh": Xo(`${Vg * x + Wg * 2 + N * 2}px`),
            },
          ),
        },
      ),
  ...
  Qg = (0, T.memo)(
    (0, T.forwardRef)(function (e, t) {
      return T.createElement(Zg, z({ ref: t }, e));
    }),
  );
((Qg.displayName = `TextArea`), X());
var $g = [
  `appearance`,
  `className`,
  `elemAfterInput`,
...
var n_ = { invalid: `_msj6gir2`, disabled: `_6up518qt` },
  ...
  c_ = { xsmall: 80, small: 160, medium: 240, large: 320, xlarge: 480 },
  l_ = function (e) {
    return e ? (e in c_ ? `${c_[e]}px` : `${+e}px`) : `100%`;
  },
  u_ = {
  ...
  d_ = (0, T.forwardRef)(function (e, t) {
    var n = e.appearance,
...
var p_ = (0, T.createContext)(null),
  m_ = (0, T.createContext)(null);
X();
function h_(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var __ = {
  ...
  y_ = function (e) {
    ...
    var y = Do(
      ...
      b = n
        ? v_({ tabPanel: _[m], index: m, isSelected: !0, tabsId: o })
        : Array.from(v.current).map(function (e) {
            return v_({ tabPanel: _[e], index: e, isSelected: e === m, tabsId: o });
          });
    return T.createElement(
      `div`,
      {
      ...
      T.createElement(p_.Provider, { value: { selected: m, onChange: y, tabsId: o } }, g),
...
var w_ = (0, T.forwardRef)(function (e, t) {
  var n = e.children,
    r = e.testId,
    i = C_(),
    a = i.onClick,
...
var O_ = (0, T.createContext)(void 0),
  k_ = function () {
      ...
      children: [
        ...
        (0, $.jsxs)(y_, {
          ...
          children: [
            (0, $.jsxs)(E_, {
              children: [
                (0, $.jsx)(w_, { children: `Add documents` }),
                (0, $.jsx)(w_, { children: `AI(Vector) search` }),
              ],
            }),
            (0, $.jsx)(x_, {
              children: (0, $.jsx)(Uv, {
        ...
        (0, $.jsxs)(Uv, {
          ...
          children: [
            ...
            c.length > 0
              ? (0, $.jsx)(Ig, { head: O, rows: k, rowsPerPage: 10, defaultPage: 1 })
              : null,
            u.length > 0
              ? (0, $.jsx)(Ig, { head: A, rows: j, rowsPerPage: 10, defaultPage: 1 })
              : null,
          ],
        }),
      ],
