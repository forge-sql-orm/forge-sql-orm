import { a as e, c as t, f as n, l as r, s as i } from "./wrapNativeSuper-C8aTj56-.js";
import {
  a,
  c as o,
  d as s,
    ...
    return (
      x.forEach(function (e) {
        var s = e.backgroundLight,
          ...
          m = t[f];
        o(
          a.includes(l) ? (typeof p == `string` ? p : r[p]) : S(l, n),
    ...
    return t(
      ...
      [
        ...
        },
        {
          ...
          value: function (t) {
            var n = X.fromInt(this.toInt()).xyzInViewingConditions(t),
              r = X.fromXyzInViewingConditions(n[0], n[1], n[2], Q.make());
            return e.from(r.hue, r.chroma, U(n[1]));
          },
        },
      ],
      [
        {
          ...
          value: function (t, n, r) {
            return new e(Z.solveToInt(t, n, r));
          },
        },
        {
          key: `fromInt`,
      ...
      [
        {
          key: `fromInt`,
          value: function (t) {
            return e.fromIntInViewingConditions(t, Q.DEFAULT);
          },
        },
        {
          ...
          value: function (t, n) {
            ...
            return new e(A, I, M, N, L, R, z, B * Math.cos(j), B * Math.sin(j));
          },
        },
        {
          key: `fromJch`,
          value: function (t, n, r) {
            return e.fromJchInViewingConditions(t, n, r, Q.DEFAULT);
          },
        },
        {
          key: `fromJchInViewingConditions`,
          value: function (t, n, r, i) {
            var a = (4 / i.c) * Math.sqrt(t / 100) * (i.aw + 4) * i.fLRoot,
              o = n * i.fLRoot,
              s = n / Math.sqrt(t / 100),
              c = 50 * Math.sqrt((s * i.c) / (i.aw + 4)),
              l = (r * Math.PI) / 180,
              u = (1.7000000000000002 * t) / (1 + 0.007 * t),
        ...
        },
        {
          key: `fromUcs`,
          value: function (t, n, r) {
            return e.fromUcsInViewingConditions(t, n, r, Q.DEFAULT);
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t, n, r, i) {
            var a = 0.401288 * t + 0.650173 * n - 0.051461 * r,
              o = -0.250268 * t + 1.204414 * n + 0.045854 * r,
            ...
            return new e(S, k, T, E, A, j, M, N * Math.cos(C), N * Math.sin(C));
          },
        },
      ],
    );
  ...
  Z = (function () {
    ...
    return t(e, null, [
      ...
      },
      {
        key: `hueOf`,
        value: function (t) {
          var n = k(t, e.SCALED_DISCOUNT_FROM_LINRGB),
            r = e.chromaticAdaptation(n[0]),
            i = e.chromaticAdaptation(n[1]),
            a = e.chromaticAdaptation(n[2]),
            o = (11 * r + -12 * i + a) / 11,
            s = (r + i - 2 * a) / 9;
        ...
        value: function (t, n) {
          ...
          if (n < 4) {
            var c = o,
              l = s,
              u = (t - c * i - l * a) / r;
            return e.isBounded(u) ? [u, c, l] : [-1, -1, -1];
          } else if (n < 8) {
            var d = o,
              f = s,
              p = (t - f * r - d * a) / i;
            return e.isBounded(p) ? [f, p, d] : [-1, -1, -1];
          } else {
            var m = o,
              h = s,
              g = (t - m * r - h * i) / a;
            return e.isBounded(g) ? [m, h, g] : [-1, -1, -1];
          }
        },
      },
      {
        ...
        value: function (t, n) {
          for (var r = [-1, -1, -1], i = r, a = 0, o = 0, s = !1, c = !0, l = 0; l < 12; l++) {
            ...
            if (!(u[0] < 0)) {
              ...
              (c || e.areInCyclicOrder(a, d, o)) &&
                ((c = !1), e.areInCyclicOrder(a, n, d) ? ((i = u), (o = d)) : ((r = u), (a = d)));
            }
          }
          return [r, i];
        },
      ...
      },
      {
        ...
        value: function (t, n) {
          for (
            var r = e.bisectToSegment(t, n), i = r[0], a = e.hueOf(i), o = r[1], s = 0;
            s < 3;
            s++
          )
            if (i[s] !== o[s]) {
              var c = -1,
                l = 255;
              i[s] < o[s]
                ? ((c = e.criticalPlaneBelow(e.trueDelinearized(i[s]))),
                  (l = e.criticalPlaneAbove(e.trueDelinearized(o[s]))))
                : ((c = e.criticalPlaneAbove(e.trueDelinearized(i[s]))),
                  (l = e.criticalPlaneBelow(e.trueDelinearized(o[s]))));
              for (var u = 0; u < 8 && !(Math.abs(l - c) <= 1); u++) {
                var d = Math.floor((c + l) / 2),
                  f = e.CRITICAL_PLANES[d],
                  p = e.setCoordinate(i, f, o, s),
                  m = e.hueOf(p);
                e.areInCyclicOrder(a, n, m) ? ((o = p), (l = d)) : ((i = p), (a = m), (c = d));
              }
            }
        ...
        value: function (t, n, r) {
          for (
            var i = Math.sqrt(r) * 11,
              ...
              s = 0.25 * (Math.cos(t + 2) + 3.8) * (5e4 / 13) * a.nc * a.ncb,
              c = Math.sin(t),
              l = Math.cos(t),
              u = 0;
            u < 5;
      ...
      },
      {
        ...
        value: function (t, n, r) {
          ...
          var i = (t / 180) * Math.PI,
            a = H(r),
            o = e.findResultByJ(i, n, a);
          return o === 0 ? P(e.bisectToLimit(a, i)) : o;
        },
      },
      {
        key: `solveToCam`,
        value: function (t, n, r) {
          return X.fromInt(e.solveToInt(t, n, r));
        },
      },
    ]);
  })();
(i(Z, `SCALED_DISCOUNT_FROM_LINRGB`, [
  [0.001200833568784504, 0.002389694492170889, 0.0002795742885861124],
  [0.0005891086651375999, 0.0029785502573438758, 0.0003270666104008398],
  [0.00010146692491640572, 0.0005364214359186694, 0.0032979401770712076],
]),
  i(Z, `LINRGB_FROM_SCALED_DISCOUNT`, [
    [1373.2198709594231, -1100.4251190754821, -7.278681089101213],
    [-271.815969077903, 559.6580465940733, -32.46047482791194],
    [1.9622899599665666, -57.173814538844006, 308.7233197812385],
  ]),
  i(Z, `Y_FROM_LINRGB`, [0.2126, 0.7152, 0.0722]),
  i(
    Z,
    `CRITICAL_PLANES`,
    [
...
var Q = (function () {
  function e(t, n, i, a, o, s, c, l, u, d) {
    (r(this, e),
      (this.n = t),
      (this.aw = n),
      (this.nbb = i),
  ...
  return t(e, null, [
    {
      key: `make`,
      value: function () {
        var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : te(),
          n =
        ...
        return new e(y, (2 * w[0] + w[1] + 0.05 * w[2]) * x, x, S, d, p, m, v, v ** 0.25, b);
      },
    },
  ]);
})();
((J = Q), i(Q, `DEFAULT`, J.make()));
var ae = (function () {
  function e() {
    r(this, e);
  }
  return t(e, null, [
    {
      key: `ratioOfTones`,
      value: function (t, n) {
        return ((t = D(0, 100, t)), (n = D(0, 100, n)), e.ratioOfYs(H(t), H(n)));
      },
    },
    {
      key: `ratioOfYs`,
...
var ce = [1.12, 1.33, 2.03, 2.73, 3.33, 4.27, 5.2, 6.62, 12.46, 14.25],
  ...
  $ = function (t) {
    var n = f(t)[0],
      r = m(n, 100, 60),
      i = c(r[0], r[1], r[2]) < 0.4 ? ce : le,
      a = s(t),
      o = Y.fromInt(re({ r: a[0], g: a[1], b: a[2], a: a[3] })),
      l = i.map(function (e) {
        var t = ne(Y.from(o.hue, o.chroma, ae.darker(100, e) + 0.25).toInt());
        return h(t.r, t.g, t.b);
      }),
      u = ue(l, t),
      d = e(l);
    return ((d[u] = t), { ramp: d, replacedColor: l[u] });
  };
function de(e, t, n) {
  for (var r = [], i = 1; i <= t; i++)
...
var fe = function (e, t, r) {
    ...
    if (f >= 4.5) {
      var p = n(de(l, 2, c), 2),
        ...
        h = p[1],
        g = l;
      f < 5.4 && f >= 4.8 && l === 6 && (g = l + 1);
      var _ = n(de(g, 1, c), 1)[0];
      u = {
        "color.text.brand": g,
        "color.icon.brand": l,
        ...
        "color.background.brand.bold": l,
        "color.background.brand.bold.hovered": m,
        "color.background.brand.bold.pressed": h,
        "color.background.brand.boldest": 9,
        "color.background.brand.boldest.hovered": 8,
        "color.background.brand.boldest.pressed": 7,
        "color.border.brand": l,
        "color.text.selected": g,
        "color.icon.selected": l,
        "color.background.selected.bold": l,
        "color.background.selected.bold.hovered": m,
        "color.background.selected.bold.pressed": h,
        "color.border.selected": l,
        "color.link": g,
        "color.link.pressed": _,
        "color.chart.brand": 5,
      ...
      (f < 4.5 && f >= 4 && l === 6 && (v = s),
        (u = {
          ...
          "color.background.selected.bold": v,
    ...
    if (t === `light`) return { light: u };
    if (
      (Object.entries(u).forEach(function (e) {
        var t = n(e, 2),
          r = t[0],
          i = t[1];
        d[r] = 9 - (typeof i == `string` ? l : i);
      }),
      f < 4.5)
    ) {
      ...
      o(b, e) >= 4.5 &&
        l >= 2 &&
        ((d[`color.background.brand.bold`] = l),
        (d[`color.background.brand.bold.hovered`] = l - 1),
        (d[`color.background.brand.bold.pressed`] = l - 2));
    }
    return t === `dark` ? { dark: d } : { light: u, dark: d };
  },
  pe = function (e, t, r) {
    var i = r || $(e).ramp,
      a = fe(e, t, i),
    ...
    return (
      Object.entries(a).forEach(function (e) {
        var t = n(e, 2),
          ...
          a = t[1];
        (r === `light` || r === `dark`) &&
          (o[r] = se(se({}, a), C({ customThemeTokenMap: a, mode: r, themeRamp: i })));
      }),
      o
    );
  },
  ...
  return (
    (r === `light` || r === `auto`) &&
      ...
      s.push({
        ...
        css: `
html[${u}="${i}"][${p}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${d(c.light, o)}
}`,
      }),
    (r === `dark` || r === `auto`) &&
      ...
      s.push({
        ...
        css: `
html[${u}="${i}"][${p}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${d(c.dark, o)}
}`,
      }),
