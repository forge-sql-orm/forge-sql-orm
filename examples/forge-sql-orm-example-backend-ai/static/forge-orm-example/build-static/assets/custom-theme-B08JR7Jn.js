...
var Y,
  X = (function () {
    function e(t, r, i, a, o, s, c, l, u, d) {
      (n(this, e),
        (this.n = t),
        (this.aw = r),
        (this.nbb = i),
...
var ce = (function () {
    function e(t) {
      (n(this, e), (this.argb = t));
      var r = Z.fromInt(t);
      ((this.internalHue = r.hue), (this.internalChroma = r.chroma), (this.internalTone = W(t)));
    }
    return u(
      e,
      [
...
function _e(e) {
  var t,
    ...
    r = e?.colorMode || s.colorMode,
    o = c(JSON.stringify(e?.UNSAFE_themeOptions)),
    u = $(n).ramp,
    d = [],
    f = ge(n, r, u);
  return (
    (r === `light` || r === `auto`) &&
      ...
      d.push({
        ...
        css: `
html[${i}="${o}"][${l}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${a(f.light, u)}
}`,
      }),
    (r === `dark` || r === `auto`) &&
      ...
      d.push({
        ...
        css: `
html[${i}="${o}"][${l}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${a(f.dark, u)}
}`,
      }),
