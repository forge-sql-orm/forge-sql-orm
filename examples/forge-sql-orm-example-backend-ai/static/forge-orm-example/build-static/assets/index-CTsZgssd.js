...
var Zc = [
  ...
  al = (0, T.forwardRef)(function (e, t) {
    var n = e.as,
      r = n === void 0 ? `div` : n,
      i = e.children,
      a = e.backgroundColor,
...
var fl = [
  ...
  gl = { column: `_2lx21bp4`, row: `_2lx2vrvc` },
  _l = { wrap: `_1n261g80`, nowrap: `_1n261q9c` },
  vl = {
    start: `_4cvrv2br`,
    center: `_4cvr1h6o`,
    baseline: `_4cvr1q9y`,
...
var xl = [
  ...
  Cl = function (e) {
    var t = e.children;
    return T.createElement(`span`, { className: Y([Sl.separator]) }, t);
  },
  wl = (0, T.memo)(
    (0, T.forwardRef)(function (e, t) {
      var n = e.as,
        ...
        _ = e.children,
        v = d(e, xl),
        y = typeof p == `string` ? T.createElement(Cl, null, p) : p,
        b = y
      ...
      return T.createElement(
        ...
        z({}, v, {
          ...
          rowGap: f,
          wrap: s ? `wrap` : void 0,
          xcss: dl(l === `hug` && Sl.hug, l === `fill` && Sl.fill, m),
          testId: h,
          ref: t,
        }),
        b,
...
var Tl = [
  ...
  El = { hug: `_16jlidpf`, fill: `_1bsb1osq _16jlkb7n` },
  Dl = (0, T.memo)(
    (0, T.forwardRef)(function (e, t) {
      var n = e.as,
        r = e.alignInline,
      ...
      return T.createElement(
        ...
        z({}, m, {
          ...
          alignItems: r,
          justifyContent: o || a,
          xcss: dl(s === `hug` && El.hug, s === `fill` && El.fill, f),
          testId: u,
          ref: t,
        }),
        l,
...
Dl.displayName = `Stack`;
var Ol = !0,
  kl = `Invariant failed`;
function Al(e, t) {
  if (!e) {
    if (Ol) throw Error(kl);
    var n = typeof t == `function` ? t() : t,
      r = n ? `${kl}: ${n}` : kl;
    throw Error(r);
  }
}
var jl = (0, T.createContext)(!1),
  Ml = function () {
    return (0, T.useContext)(jl);
  },
  Nl = jl.Provider;
X();
var Pl = [`span`, `p`, `strong`, `em`],
  ...
  Vl = (0, T.forwardRef)(function (e, t) {
    var n = e.as,
      ...
      d = e.xcss,
      f = e.children;
    Al(Pl.includes(r), `@atlaskit/primitives: Text received an invalid "as" value of "${r}"`);
    var p = Ml(),
      m = Fl(i, p);
    !c && !p && (c = `medium`);
    ...
    return p ? h : T.createElement(Nl, { value: !0 }, h);
  });
function Hl() {
  ...
  Yl = (0, T.forwardRef)(function (e, t) {
    ...
    return T.createElement(
      ...
      z({ as: `button`, tabIndex: h ?? (Hl() && !r ? 0 : void 0), style: f }, y, {
        ...
        onClick: v,
        disabled: r,
        xcss: cl(Jl.root, r && Jl.disabled, m),
        testId: p,
        ref: t,
      }),
      n,
                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        at(
                                          () => import(`./custom-theme-akz70DvA.js`),
                                          __vite__mapDeps([2, 3]),
                                          import.meta.url,
                                        )
                                      );
