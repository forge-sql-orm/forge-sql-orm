...
var Y,
  X = (function () {
    function t(e, n, r, i, a, o, s, c, u, d) {
      (l(this, t),
        (this.n = e),
        (this.aw = n),
        (this.nbb = r),
...
var ce = (function () {
    function t(e) {
      (l(this, t), (this.argb = e));
      var n = Z.fromInt(e);
      ((this.internalHue = n.hue), (this.internalChroma = n.chroma), (this.internalTone = W(e)));
    }
    return e(
      t,
      [
    ...
    return (
      Object.entries(a).forEach(function (e) {
        var t = i(e, 2),
          ...
          a = t[1];
        (n === `light` || n === `dark`) &&
          (o[n] = de(de({}, a), E({ customThemeTokenMap: a, mode: n, themeRamp: r })));
      }),
      o
    );
  };
  ...
  return (
    (c === `light` || c === `auto`) &&
      ...
      d.push({
        ...
        css: `
html[${s}="${l}"][${r}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${a(f.light, u)}
}`,
      }),
    (c === `dark` || c === `auto`) &&
      ...
      d.push({
        ...
        css: `
html[${s}="${l}"][${r}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${a(f.dark, u)}
}`,
      }),
