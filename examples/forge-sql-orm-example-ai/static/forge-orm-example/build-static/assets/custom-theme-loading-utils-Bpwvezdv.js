...
import { t as p } from "./client-core-vendor-Ct6Dtvhp.js";
function m(e, t) {
...
var w = `@all-features`,
  _e = (function () {
    function e() {
      (s(this, e), u(this, `eventToValue`, new Map()), (this.emitter = new he.default()));
    }
    return r(e, [
      {
        key: `onGateUpdated`,
...
function N(e) {
  ...
  var r = t.shift();
  if (r == null) return N.apply(void 0, [e].concat(n(t)));
  ...
  return N.apply(void 0, [e].concat(n(t)));
}
var Ce = function (e) {
    var t = e.api,
  ...
  F = `0.0.0-development`;
function Oe(e, t, n) {
  return ((t = l(t)), o(e, ke() ? Reflect.construct(t, n || [], l(e).constructor) : t.apply(e, n)));
}
function ke() {
  try {
...
function Ke(e, t, n, r) {
  var i = h(l(1 & r ? e.prototype : e), t, n);
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 5:
                        return (
                          ...
                          (l = I.fetchExperimentValues(t, n, r)),
                          (e.next = 10),
                          Promise.all([c, l])
                        );
                      case 10:
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 20:
                        return (
                          ...
                          (this.statsigClient = new E.StatsigClient(rt, this.user, f)),
...
if (typeof window < `u`)
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = G;
    ...
    if (st !== `0.0.0-development`) {
      ...
      The currently bound version is ${st} when module version ${F} was loading.`;
      console.warn(ct);
    }
  }
var lt = K,
