...
var t = e((e) => {
        ...
        return n(this, void 0, void 0, function* () {
          ...
          try {
            ...
            ((t = `event_sender_pre_logs_flushed_emitter_exception`),
              ...
              (t = r ? `event_sender_unexpected_exception` : `event_sender_post_exception`));
            let i = r ? this._sendEventsViaBeacon(e, n) : yield this._sendEventsViaPost(e, n);
            return i.success
          ...
          return r === -1
            ? Object.assign(
                Object.assign(
                  ...
                  t.diagnosticBucket ? { failureDiagnosticBucket: t.diagnosticBucket } : {},
                ),
                t.diagnosticMetadata ? { failureDiagnosticMetadata: t.diagnosticMetadata } : {},
              )
      ...
      _getRequestData(e) {
        return {
          ...
          headers: {
            ...
            "statsig-sdk-type": a.SDKType._get(this._sdkKey),
  ...
  C = e((e) => {
    ...
    ((0, o._subscribeToVisiblityChanged)((e) => {
      e === `background` && Object.values(d).forEach((e) => v(e));
    }),
    ...
    function f(e, t) {
      let n = Date.now();
      return (p(e) ? v(e) : t && ((e.data.lastUpdate = n), b(e)), e);
    }
    function p(e) {
      var t;
      let n = e.data,
    ...
    function b(e) {
      Date.now() - e.lastPersistedAt > u && v(e);
    }
    function x(e) {
  ...
  w = e((e) => {
    ...
    e.StableID = {
      ...
      get: (e) => {
        ...
        return (
          (t = h(e)),
          t == null
            ? ((t = m(e)), (t ??= (0, o.getUUID)()), f(t, e), g(t, e), (s[e] = t), t)
            : ((s[e] = t), f(t, e), t)
        );
      },
      setOverride: (e, t) => {
    ...
    function h(e) {
      ...
      for (let n of t) {
        ...
        if (t === _(e)) return decodeURIComponent(r);
      }
      return null;
    }
    function g(e, t) {
      ...
      (n.setFullYear(n.getFullYear() + 1),
        (document.cookie = `${_(t)}=${encodeURIComponent(e)}; expires=${n.toUTCString()}; path=/`));
    }
    function _(e) {
      return `statsig.stable_id.${(0, n._getStorageKey)(e)}`;
    }
  ...
  D = e((e) => {
    ...
    ((e.RETRYABLE_CODES = new Set([408, 500, 502, 503, 504, 522, 524, 599])),
      (e.NetworkCore = class {
        ...
        beacon(e, t) {
          if (!I(e)) return (t && (t.path = `beacon_invalid_sdk_key`), !1);
        ...
        _sendRequest(t, n) {
          return i(this, void 0, void 0, function* () {
            var r, i;
            if (!I(t)) return (n && (n.path = `network_invalid_sdk_key`), null);
            if (this._netConfig.preventAllNetworkTraffic)
              return (n && (n.path = `network_prevent_all_network_traffic`), null);
            let { method: a, body: o, retries: c, attempt: l } = t,
              u = t.urlConfig.endpoint;
            if (this._isRateLimited(u))
              return (
                s.Log.warn(
                  `Request to ${u} was blocked because you are making requests too frequently.`,
                ),
                n && (n.path = `network_rate_limited`),
                null
              );
            let d = l ?? 1,
              f = !1,
              p = this._getPopulatedURL(t),
              m = Date.now(),
              h = null,
              g = (0, k._isUnloading)();
            try {
              ...
              G(t, d);
              let n = this._leakyBucket[u];
              n && ((n.lastRequestTime = Date.now()), (this._leakyBucket[u] = n));
              let r = this._netConfig.networkOverrideFunc ?? fetch,
                i;
              if (
                ((h = yield Promise.race([
                ...
                let e = yield h.text().catch(() => `No Text`),
              ...
              if (
                ...
                !c || d > c || !e.RETRYABLE_CODES.has(h?.status ?? 500))
              ) {
                (r = this._emitter) == null ||
                  r.call(this, {
                    name: `error`,
                    error: o,
                    tag: S.ErrorTag.NetworkError,
                    requestArgs: t,
                  });
                let e = `A networking error occurred during ${a} request to ${p}.`;
                if (
                  (s.Log.error(e, l, o),
                  (i = this._errorBoundary) == null || i.attachErrorIfNoneExists(e),
                  t.preserveFailedStatusCode && h != null)
                )
                  return { body: null, code: h.status };
                if (h == null && n) {
                  ((n.path = u
                    ...
                    l && (n.errorMessage = l));
                  try {
                    let e = V(t, p, u, Date.now() - m);
                    ((n.diagnosticBucket = e.bucket), (n.diagnosticMetadata = e.metadata));
                  } catch {}
                }
                return null;
              }
              return (
                yield q(d),
                this._sendRequest(
                  Object.assign(Object.assign({}, t), { retries: c, attempt: d + 1 }),
                  n,
                )
              );
            }
          ...
          let n = Object.assign(
              {
                ...
                [c.NetworkParam.SdkType]: g.SDKType._get(e.sdkKey),
                [c.NetworkParam.SdkVersion]: D.SDK_VERSION,
                [c.NetworkParam.Time]: String(Date.now()),
                [c.NetworkParam.SessionID]: v.SessionID.get(e.sdkKey),
              },
              e.params,
            ),
            r = Object.keys(n)
    ...
    function R(e, t) {
      ...
      let n = e.urlConfig.customUrl != null || e.urlConfig.fallbackUrls != null,
        r = h.SDKFlags.get(e.sdkKey, `enable_log_event_compression`) === !0;
    ...
    function V(e, t, n, r) {
      let i = (0, _._getWindowSafe)(),
        ...
        d = H(t, i?.location?.origin),
        f = e.urlConfig.customUrl != null,
        p = e.fallbackUrl != null,
        m = W(r, [250, 1e3, 5e3, 1e4]),
        h = W(U(e.body), [16384, 65536, 262144, 1048576]),
        g = `unknown_no_response`;
      return (
        n
          ? (g = `timeout`)
          : c === `false`
            ...
            : s
              ...
              : l === `hidden`
                ? (g = `page_hidden`)
                : d && u
                  ? (g = `cross_origin_custom_headers_preflight_risk`)
                  : f || p
                    ? (g = `custom_url_no_response`)
                    : r < 250 && (g = `immediate_network_rejection`),
        {
          bucket: g,
          metadata: {
            elapsedMsBucket: m,
    ...
    e.FlushCoordinator = class {
      ...
      _scheduleNextFlush() {
        ...
        this._cooldownTimer = setTimeout(() => {
          ((this._cooldownTimer = null),
            m.StatsigSession.checkForIdleSession(this._sdkKey),
      ...
      _processOneBatch(e, t) {
        return n(this, void 0, void 0, function* () {
          if (this._loggingEnabled !== v.LoggingEnabledOption.always && (0, f._isServerEnv)())
          ...
          return n.success
            ...
            : (this._flushInterval.adjustForFailure(),
              this._handleFailure(
                ...
                n.statusCode,
                n.failurePath,
                n.failureErrorMessage,
                n.failureDiagnosticBucket,
                n.failureDiagnosticMetadata,
              ),
              !1);
        });
      }
      ...
      _handleFailure(e, t, n, i, a, o, c) {
        ...
        e.incrementAttempts();
        let l = this._batchQueue.requeueBatch(e);
        l > 0 &&
          (u.Log.warn(`Failed to requeue batch : dropped ${l} events due to full queue`),
          this._errorBoundary.logDroppedEvents(l, `Batch queue limit reached during requeue`, {
            loggingInterval: this._flushInterval.getCurrentIntervalMs(),
            batchSize: this._batchQueue.batchSize(),
            maxPendingBatches: r.EventRetryConstants.MAX_PENDING_BATCHES,
            flushType: t,
  ...
  M = e((e) => {
    ...
    e.EventLogger = class e {
      ...
      _shouldLogEvent(e) {
        if (this._options?.loggingEnabled !== `always` && (0, v._isServerEnv)()) return !1;
      ...
      _getCurrentPageUrl() {
        if (this._options?.includeCurrentPageUrlWithEvents !== !1)
          return (0, v._getCurrentPageUrlSafe)();
      }
      _getStorageKey() {
        return (
          (this._storageKey ||= `statsig.pending_events.${(0, f._DJB2)(this._sdkKey)}`),
          this._storageKey
        );
      }
      _initFlushCoordinator() {
        ...
        return (
          (this._pendingEvents = new _.PendingEvents(e)),
          (this._batchQueue = new r.BatchQueue(e)),
          (this._flushCoordinator = new d.FlushCoordinator(
            this._batchQueue,
            this._pendingEvents,
        ...
        try {
          (r.Log.warn(`Caught error in ${t}`, { error: l }),
            n(this, void 0, void 0, function* () {
              ...
              let _ = i.SDKType._get(this._sdkKey),
                v = a.StatsigMetadataProvider.get(),
                y = m ? p.stack : c(p),
                b = Object.assign(
                  Object.assign(
                    { tag: t, exception: h, info: y, statsigOptions: u(this._options) },
                    Object.assign(Object.assign({}, v), { sdkType: _ }),
                  ),
                  f ?? {},
                ),
                x = this._options?.networkConfig;
              (yield (x?.networkOverrideFunc ?? fetch)(x?.sdkExceptionUrl ?? e.EXCEPTION_ENDPOINT, {
                method: `POST`,
                headers: {
    ...
    e.StatsigClientBase = class {
      constructor(e, t, n, r) {
        ...
        (r?.logLevel != null && (s.Log.level = r.logLevel),
          ...
          r != null && r.enableCookies && d.StableID._setCookiesEnabled(e, r.enableCookies),
          r != null && r.disableStableID && d.StableID._setDisabled(e, !0),
          (this._sdkKey = e),
          (this._options = r ?? {}),
          (this._memoCache = {}),
  ...
  Q = e((e) => {
    ...
    (Object.defineProperty(e, `Storage`, {
      ...
      a(Z(), e),
      a(x(), e),
      Object.assign((0, o._getStatsigGlobal)(), { Log: _.Log, SDK_VERSION: v.SDK_VERSION }));
  });
export { Q as t };
