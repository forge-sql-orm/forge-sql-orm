...
var oi = (0, j.memo)(
    (0, j.forwardRef)(function (e, t) {
      ...
      return j.createElement(`div`, h({ ref: t, style: o }, a));
    }),
  ),
  Q = {
    vertical: {
...
function gi(e) {
  ...
  var z = D.type !== `idle` && m === `standard`,
    oe = (0, j.useRef)(null);
  Ur({ elementRef: z ? oe : y, data: k, direction: u, contextId: _, isDropDisabled: ne, type: p });
  var se = (0, j.useRef)(!0);
...
var Li = d({}, L.dropIndicator, ``),
  Ri = function (e) {
    ...
    var _ = Q[t].mainAxis,
      ...
      y = n === `virtual`;
    return S(`div`, h({ ref: s, css: [Mi, Fi[t], y && Ni, f && Pi], style: v }, Li));
  };
function zi(e, t) {
  var n = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var qi = [`isRanking`, `innerRef`],
  Ji = function (e) {
    var t = e.isRanking,
      n = e.innerRef,
      r = a(e, qi);
    return j.createElement(_, h({}, r, { innerRef: n, className: w([t && `_vchhusvi`]) }));
  },
  Yi = [`content`, `testId`];
function Xi(e, t, n) {
          ...
          value: function () {
            ...
            return j.createElement(
              ...
              function (t, n) {
                return j.createElement(
                  Ki,
                  h({}, _, t.dragHandleProps, t.draggableProps, {
                    role: void 0,
...
var sa = function (e, t) {
  ...
  la = m(
    j.forwardRef(function (e, t) {
      return j.createElement(ca, h({}, e, { forwardedRef: t }));
    }),
  );
