import { a as e, c as t, f as n, l as r, s as i } from "./wrapNativeSuper-BmCJ3c35.js";
import {
  C as a,
  _ as o,
  a as s,
  ...
  s as _,
  u as v,
} from "./custom-theme-loading-utils-DJl_NuEd.js";
var y = {
...
var ce = [1.12, 1.33, 2.03, 2.73, 3.33, 4.27, 5.2, 6.62, 12.46, 14.25],
  ...
  $ = function (t) {
    var n = c(t)[0],
      ...
      d = ue(u, t),
      f = e(u);
    return ((f[d] = t), { ramp: f, replacedColor: u[d] });
  };
function de(e, t, n) {
  for (var r = [], i = 1; i <= t; i++)
...
function he(e) {
  var t,
    ...
    r = e?.colorMode || a.colorMode,
    i = u(JSON.stringify(e?.UNSAFE_themeOptions)),
    s = $(n).ramp,
    c = [],
    l = pe(n, r, s);
  return (
    (r === `light` || r === `auto`) &&
      ...
      c.push({
        ...
        css: `
html[${o}="${i}"][${f}="light"][data-theme~="light:light"] {
  /* Branded tokens */
    ${g(l.light, s)}
}`,
      }),
    (r === `dark` || r === `auto`) &&
      ...
      c.push({
        ...
        css: `
html[${o}="${i}"][${f}="dark"][data-theme~="dark:dark"] {
  /* Branded tokens */
    ${g(l.dark, s)}
}`,
      }),
