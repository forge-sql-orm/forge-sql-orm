...
function de(e, t, n) {
  return ((t = d(t)), a(e, fe() ? Reflect.construct(t, n || [], d(e).constructor) : t.apply(e, n)));
}
function fe() {
  try {
...
function he(e) {
  var t = (function (t) {
    function n() {
      ...
      o(this, n);
      var t = [...arguments];
      return ((e = de(this, n, [].concat(t))), i(e, `state`, { pageRows: [] }), e);
    }
    return (
      l(n, t),
      c(
...
function Qt(e, t, n) {
  return ((t = d(t)), a(e, $t() ? Reflect.construct(t, n || [], d(e).constructor) : t.apply(e, n)));
}
function $t() {
  try {
    var e = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));
  ...
  return (function (t) {
    function n() {
      ...
      return (
        ...
        i(e, `state`, { refWidth: 0, refHeight: 0 }),
        i(e, `innerRef`, function (t) {
          t && !e.props.isRanking && (e.ref = t);
        }),
        i(e, `updateDimensions`, function () {
          if (e.ref) {
