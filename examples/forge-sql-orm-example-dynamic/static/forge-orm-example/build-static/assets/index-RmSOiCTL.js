          ...
          function (e) {
            for (;;)
              switch ((e.prev = e.next)) {
                                  ...
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      return (
                                        (e.next = 2),
                                        at(
                                          () => import(`./custom-theme-DPNlwXP1.js`),
                                          __vite__mapDeps([2, 3]),
                                          import.meta.url,
                                        )
                                      );
                ...
                case 29:
                  return ((te = lc(S)), e.abrupt(`return`, te));
                case 31:
                case `end`:
                  return e.stop();
              }
    ...
    return (
      ...
      Iu(
        ...
        Iu(
          ...
          m ? Iu(`span`, { css: [j, rd({ spacing: ee }), ud(c, cd)] }, m) : null,
          dd(c, [j, td({ spacing: ee })]),
          p ? Iu(`span`, { css: [j, rd({ spacing: ee }), ud(c, ld)] }, p) : null,
          O ? Iu(`span`, { css: [ad, pe] }, O) : null,
        ),
      )
    );
  });
  ...
  if (S) {
    if (a) {
      var k = b === `y` ? `top` : Xf,
        ...
        oe = v === `start` ? -w[A] : -C[A],
        se = t.elements.arrow,
        ce = p && se ? Sp(se) : { width: 0, height: 0 },
        ...
        me = t.elements.arrow && Ap(t.elements.arrow),
        he = me ? (b === `y` ? me.clientTop || 0 : me.clientLeft || 0) : 0,
        ge = D?.[b] ?? 0,
        _e = te + fe - ge - he,
        ve = te + pe - ge,
        ye = Mp(p ? _p(ne, _e) : ne, te, p ? gp(re, ve) : re);
      ((S[b] = ye), (O[b] = ye - te));
    }
    if (s) {
      var be = b === `x` ? `top` : Xf,
...
function ig(e) {
  var t = e.children,
    ...
    le = ce ? a : r,
    ue = Fi($h({ fn: v, action: `displayed`, analyticsData: D }, tg)),
    de = Fi($h({ fn: b, action: `hidden`, analyticsData: D }, tg)),
    j = (0, x.useRef)(null),
      ...
      ? function (e) {
          ...
          (t = j.current) != null &&
            ...
            (B(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ||
              (j.current.mousePosition = Rh({ left: e.clientX, top: e.clientY })),
  ...
  var He = function () {
      ...
      return ce &&
        ...
        he.current &&
        B(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
        ? zh(j.current.mousePos, { targetElement: he.current, tooltipPosition: r })
        : ce &&
            (t = j.current) != null &&
            t.mousePosition &&
            !B(`platform_dst_nav4_side_nav_resize_tooltip_feedback`)
  ...
  var Ke = ze
      ...
      : null,
    qe = se && B(`platform_dst_nav4_side_nav_resize_tooltip_feedback`) ? x.Fragment : ag;
  return x.createElement(
    x.Fragment,
    null,
    typeof t == `function`
      ? x.createElement(
          x.Fragment,
          null,
          t($h($h({}, We), {}, { "aria-describedby": Ue, ref: ve })),
          Ke,
        )
    ...
    Re
      ? x.createElement(
          qe,
          null,
          x.createElement(nh, { placement: le, referenceElement: He(), strategy: k }, function (e) {
            var t = e.ref,
              n = e.style,
              r = e.update,
              i = e.placement,
...
var Og = function (e) {
    ...
    var fe = function (e) {
      ...
      ge = function () {
        return ie || (Vi(i || [], T, v).length > 2 ? zi : Ri);
      },
      _e = function () {
    ...
    return x.createElement(
      ...
      !Se &&
        we &&
        x.createElement(Ra, { isLoading: m, spinnerSize: `large`, testId: l, loadingLabel: s }, we),
    );
  },
  kg = (0, x.lazy)(function () {
    return at(
      () => import(`./body-BNoNhSUN.js`),
