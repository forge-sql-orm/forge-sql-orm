...
function gm(e, t) {
  var r = y.useState(function () {
    ...
    n = y.useRef(!0),
    a = y.useRef(r),
    o = n.current || !!(t && a.current.inputs && hm(t, a.current.inputs)),
    ...
    p = y.useCallback(
      function (v) {
        var g = u({
          ...
          f = _m({ componentName: n, packageName: o, packageVersion: i }, l.current);
        g.context.push(f);
        var h = g.clone();
    ...
    d = y.useCallback(
      function () {
        var p = c({
          ...
          v = mm({ componentName: n, packageName: a, packageVersion: o }, u.current);
        p.context.push(v);
        var g = p.clone();
...
function P(e) {
  ...
  for (const n of e) {
    ...
    const a = n.split(" ");
    for (const o of a) {
      const i = o.startsWith("_") ? o.slice(0, wm) : o;
      t[i] = o;
    }
  }
  let r = "";
...
var km = ["isFixedSize", "hasDataRow", "children", "testId", "isLoading"],
  ...
  Pm = ["rows", "head", "sortKey", "sortOrder", "rowsPerPage", "page", "forwardedRef"];
function sd(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var n = Object.getOwnPropertySymbols(e);
...
function Im(e) {
  var t = (function (r) {
    function n() {
      ...
      return ((a = Rm(this, n, [].concat(i))), S(a, "state", { pageRows: [] }), a);
    }
    return (
      We(n, r),
      ge(
        ...
        [
          {
            ...
            value: function (o, i) {
              ...
              var g, f;
              return (
                v ? ((g = s), (f = s)) : ((g = Am(c, s, u, l) || []), (f = Ip(g, d, p))),
                cd(cd({}, i), {}, { pageRows: f })
              );
            },
          },
...
var jm = "--local-dynamic-table-width",
  Lp = function (t) {
    var r = t.width;
    return typeof r < "u" ? S({}, jm, "".concat(r, "%")) : void 0;
  },
  Dm = ["width", "isFixedSize", "shouldTruncate", "innerRef"],
  Mm = function (t) {
    var r = t.width,
      n = t.isFixedSize,
      a = t.shouldTruncate,
  ...
  Tm = ["isHighlighted", "children", "style", "testId", "className"],
...
var qm = (function (e) {
    function t() {
      return (he(this, t), Nm(this, t, arguments));
    }
    return (
      We(t, e),
      ge(t, [
  ...
  $m = Im(
    E.forwardRef(function (e, t) {
      return E.createElement(qm, ne({}, e, { forwardedRef: t }));
    }),
  );
function zm(e, t, r) {
  return (
...
var Vm = (function (e) {
  function t(r) {
    var n;
    return (he(this, t), (n = zm(this, t, [r])), (n.state = { hasError: !1 }), n);
  }
  return (
    We(t, e),
    ge(
...
var Gm = "#FFFFFF",
  Hs = "#42526E",
  Hm = { xsmall: 12, small: 16, medium: 24, large: 48, xlarge: 96 };
function Wm(e) {
  return e === "inherit"
    ? "var(--ds-icon-subtle, ".concat(Hs, ")")
    : "var(--ds-icon-inverse, ".concat(Gm, ")");
}
var vo = {
      ...
      return (
        ...
        E.createElement(
          "span",
          {
            ...
            className: P([vo.wrapperStyles, vo.rotateStyles]),
          },
          E.createElement(
            "svg",
            {
  ...
  Ym = function (t) {
    ...
    return y.createElement(
      "div",
      {
        ...
        style: dd(dd({}, S({}, fd, n)), {}, { "--_cnddr8": Tp("var(".concat(fd, ")")) }),
      },
      r,
    );
  },
...
var $p = (function (e) {
  function t() {
    return (he(this, t), Zm(this, t, arguments));
  }
  return (
    We(t, e),
    ge(t, [
      {
        ...
        value: function () {
          ...
          return E.createElement(
            Jm,
            { testId: c },
            o ? E.createElement(Ym, { contentsOpacity: s, testId: c }, a) : a,
            o &&
              E.createElement(
                Xm,
                { testId: c },
    ...
    return y.createElement(
      ...
      y.createElement("svg", {
        ...
        className: P([
          ...
          c ? "_1bsb1kw7 _4t3i1kw7" : v === "small" ? iy[l] : oy[l],
        ]),
      }),
    );
  });
const cy = Object.freeze(
    Object.defineProperty({ __proto__: null, Icon: vd, default: vd }, Symbol.toStringTag, {
      value: "Module",
    }),
  ),
  si = qv(cy);
...
function uy() {
  if (pd) return da;
  ((pd = 1), Object.defineProperty(da, "__esModule", { value: !0 }), (da.default = void 0));
  var e = r(wr()),
    t = r(si);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
function fy() {
  if (hd) return fa;
  ((hd = 1), Object.defineProperty(fa, "__esModule", { value: !0 }), (fa.default = void 0));
  var e = r(wr()),
    t = r(si);
  function r(a) {
    return a && a.__esModule ? a : { default: a };
...
var Sy = Ey(),
  ...
  Ry = { column: "_2lx21bp4", row: "_2lx2vrvc" },
...
var Dy = [
  ...
  My = function (t) {
    var r = t.children;
    return y.createElement("span", { className: P([Ws.separator]) }, r);
  },
  xo = y.memo(
    y.forwardRef(function (e, t) {
      var r = e.as,
        ...
        h = e.children,
        b = se(e, Dy),
        _ = typeof p == "string" ? y.createElement(My, null, p) : p,
        m = _
      ...
      return y.createElement(
        ...
        ne({}, b, {
          ...
          rowGap: d,
          wrap: s ? "wrap" : void 0,
          xcss: xy(u === "hug" && Ws.hug, u === "fill" && Ws.fill, v),
          testId: g,
          ref: t,
        }),
        m,
...
var Ty = "Invariant failed";
function Fy(e, t) {
  if (!e) throw new Error(Ty);
}
var Wp = y.createContext(!1),
  Ly = function () {
  ...
  qy = { medium: "_11c8fhey", UNSAFE_small: "_11c8rymc", large: "_11c81d4k", small: "_11c8wadc" },
  $y = { bold: "_k48pwu06", medium: "_k48p1wq8", regular: "_k48pi7a9", semibold: "_k48p1pd9" },
  zy = {
  ...
  Vy = y.forwardRef(function (e, t) {
    ...
    return v ? f : y.createElement(Uy, { value: !0 }, f);
  });
function Gy() {
...
var Hy = ["as", "children", "isInset", "testId", "style", "xcss"],
  Wy = ["className"],
  ...
  Xy = y.forwardRef(function (e, t) {
    ...
    return y.createElement(
      Ky,
      ne({ as: "button", tabIndex: g ?? (Gy() && !n ? 0 : void 0), style: d }, m, {
        type: o,
        onClick: _,
        disabled: n,
        xcss: Hp(md.root, n && md.disabled, v),
        testId: p,
        ref: t,
      }),
      r,
  ...
  Zy = y.createContext(!1),
  Qy = function () {
    return y.useContext(Zy);
  };
                ...
                (function (O, x, I) {
                  var R,
                    ...
                    $ = {
                      ...
                      f: H.bind(n, 4),
                      d: function (U, B) {
                        return ((R = U), (C = 0), (j = n), ($.n = B), u);
                      },
                    };
                  function H(K, U) {
                    for (C = K, j = U, a = 0; !W && L && !B && a < q.length; a++) {
                      var B,
                        V = q[a],
                        ae = $.p,
                        ie = V[2];
                      K > 3
                        ...
                        : V[0] <= ae &&
                          ((B = K < 2 && ae < V[1])
                            ...
                            : ae < ie &&
                              (B = K < 3 || V[0] > U || U > ie) &&
                              ((V[4] = K), (V[5] = U), ($.n = ie), (C = 0)));
                    }
                    if (B || K > 1) return u;
                    throw ((W = !0), U);
                  }
                  return function (K, U, B) {
                    if (L > 1) throw TypeError("Generator is already running");
                    for (W && U === 1 && H(U, B), C = U, j = B; (a = C < 2 ? n : j) || !W; ) {
...
function Qp() {
  if (jd) return va;
  ((jd = 1), Object.defineProperty(va, "__esModule", { value: !0 }), (va.bind = void 0));
  function e(t, r) {
    var n = r.type,
      a = r.listener,
      o = r.options;
...
function d0() {
  if (Ld) return po;
  ((Ld = 1), Object.defineProperty(po, "__esModule", { value: !0 }));
  const e = Pt(),
    t = u0(),
    r = l0();
  let n = class {
...
function h0() {
  ...
  const t = Pt(),
    ...
    a = v0(),
    o = p0();
  let i = class Ks extends t.StatsigClientBase {
    static instance(c) {
      const u = (0, t._getStatsigGlobal)().instance(c);
      return u instanceof Ks
        ? u
        : (t.Log.warn(
            (0, t._isServerEnv)()
              ? "StatsigClient.instance is not supported in server environments"
...
var ho = "@all-features",
  y0 = (function () {
    function e() {
      (he(this, e), S(this, "eventToValue", new Map()), (this.emitter = new m0()));
    }
    return ge(e, [
      {
        key: "onGateUpdated",
...
var go = function (t) {
    return Js({ perimeter: k0() ? Na.FEDRAMP_MODERATE : Na.COMMERCIAL }, t);
  },
  _a = function (t, r) {
    if (!t && !r) return !0;
    if (!t || !r) return !1;
  ...
  S0 = Object.entries(Pc).map(function (e) {
    var t = G(e, 2),
      r = t[0],
      n = t[1];
...
function Xs(e) {
  ...
  return (
    (Xs = function (n) {
      ...
      function a() {
        return C0(n, arguments, Q(this).constructor);
      }
      return (
...
var A0 = 5e3,
  I0 = "https://api.atlassian.com/flags",
  j0 = "https://api.stg.atlassian.com/flags",
  D0 = "https://api.dev.atlassian.com/flags",
  M0 = "https://api.stg.atlassian-us-gov-mod.com/flags",
  T0 = "https://api.atlassian-us-gov-mod.com/flags",
  F0 = "https://atlassian-statsig-proxy-archetype.atl-paas.%s.atl-ic.net",
  L0 = "oasis-stg.com/flags",
  U0 = "atlassian-isolated.net/flags",
  B0 = "/gateway/api/flags",
  Ss = (function () {
    function e() {
      he(this, e);
    }
    return ge(e, null, [
      ...
      },
      {
        ...
        value: function (r) {
          ...
          if (i) return "".concat(a, "//api.").concat(i[1], ".").concat(L0);
          var s = o.match(/([^.]+)\.atlassian-isolated\.net$/);
          return s ? "".concat(a, "//api.").concat(s[1], ".").concat(U0) : null;
        },
      },
      {
...
function N0(e, t, r) {
  return (
    (t = Q(t)),
    He(e, ah() ? Reflect.construct(t, r || [], Q(e).constructor) : t.apply(e, r))
  );
}
function ah() {
  try {
...
var $0 = (function (e) {
  function t() {
    ...
    return (
      he(this, t),
      (r = N0(this, t, ["NoFetchDataAdapter", "nofetch"])),
    ...
    ge(t, [
      ...
      },
      {
        ...
        value: function (n) {
          return (
            this.bootstrapResult &&
            ma(ma({}, this.bootstrapResult), {}, { fullUserHash: st._getFullUserHash(n) })
          );
        },
      },
      {
    ...
    return ge(e, [
      ...
      },
      {
        ...
        value: function (r, n) {
          ...
          return o == null
            ? null
            : De(De({}, r), {}, { value: o, details: De(De({}, r.details), {}, { reason: xs }) });
        },
      },
      {
          ...
          return o == null
            ...
            : De(
                ...
                {},
                {
                  ...
                  details: De(De({}, r.details), {}, { reason: xs }),
                },
              );
        },
      },
  ...
  J0 = (function () {
    function e() {
      ...
      (he(this, e),
        ...
        S(this, "subscriptions", new y0()),
        S(this, "dataAdapter", new $0()),
        S(this, "statsigValuesUpdated", function () {
          (t.user && t.statsigClient.updateUserSync(t.user, { disableBackgroundCacheRefresh: !0 }),
            t.subscriptions.anyUpdated());
        }),
        (this.overrideAdapter = o || new H0(a)));
    }
    return ge(e, [
      {
        key: "initialize",
        ...
        value: function (r) {
          ...
          try {
            ...
            return (
              ...
              new Kd(r, {}, "", { time: Date.now(), reason: Pc.Error })
            );
          }
        },
      },
                    ...
                    switch ((h.prev = h.next)) {
                      ...
                      case 19:
                        return (
                          ...
                          (this.statsigClient = new st.StatsigClient(nf, this.user, v)),
...
if (typeof window < "u")
  if (window.__FEATUREGATES_JS__ === void 0) window.__FEATUREGATES_JS__ = J;
    ...
    var af =
      ((bo = Zs) === null || bo === void 0 || (Cs = bo.getPackageVersion) === null || Cs === void 0
        ? void 0
        : Cs.call(bo)) || "4.10.0 or earlier";
    if (af !== Hr) {
      var Y0 = `Multiple versions of FeatureGateClients found on the current page.
...
var Lr,
  ...
  Q0 = function () {
    var t;
    Z0 && (t = console).debug.apply(t, arguments);
  },
  Rc = {},
  ew = "@atlaskit/platform-feature-flags",
  Ra = "__PLATFORM_FEATURE_FLAGS__",
  oh = typeof process < "u" && typeof Rc < "u",
  tw = oh ? Rc.ENABLE_PLATFORM_FF === "true" : !1,
  rw = oh ? Rc.STORYBOOK_ENABLE_PLATFORM_FF === "true" : !1,
  nw = tw || rw,
  aw = { booleanResolver: void 0 },
...
var pw = function (t) {
  ...
  Ac = function () {
    ...
    var t = document.documentElement,
      r = t.getAttribute(ui) || "",
      n = t.getAttribute(Or) || "";
    return sf(sf({}, fw(n)), pw(r) && { colorMode: r });
  },
  lh = function (t) {
...
var gw = "light",
  ...
  fh = function () {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      ...
      _ = vw({ dark: o, light: s, shape: d, spacing: v, typography: f }),
      m = S(S({}, Or, _), ui, n === "auto" ? gw : n);
    if (
      (de("platform_increased-contrast-themes") &&
        (m = ff(ff({}, m), {}, S({}, ih, u === "auto" ? bw : u))),
      b && lh(b.brandColor))
    ) {
...
var Br = kw && window.matchMedia(yw),
  Ew = (function () {
    function e() {
      ...
      },
      {
        ...
        value: function () {
          Br &&
            ...
            (this.unbindThemeChangeListener = kr.bind(Br, { type: "change", listener: Ow }));
        },
      },
      {
        key: "unbind",
...
var Nr = Sw && window.matchMedia(ww),
  Cw = (function () {
    function e() {
      ...
      },
      {
        ...
        value: function () {
          Nr &&
            ...
            (this.unbindContrastChangeListener = kr.bind(Nr, { type: "change", listener: xw }));
        },
      },
      {
        key: "unbind",
          ...
          function (U) {
            for (;;)
              switch ((U.prev = U.next)) {
                                  ...
                                  switch ((ue.prev = ue.next)) {
                                    case 0:
                                      return (
                                        (ue.next = 2),
                                        Xe(
                                          () => import("./custom-theme-DAowAdUq.js"),
                ...
                case 11:
                  ((j = Iw()), (L = jw(j)), (U.prev = 13), L.s());
                case 15:
                  if ((q = L.n()).done) {
                    U.next = 21;
                    break;
                  }
                  return ((W = q.value), (U.next = 19), x(W));
                case 19:
                  U.next = 15;
                  break;
                case 21:
...
var zw = { dark: "dark", light: "light", spacing: "spacing", typography: "typography" },
  ...
  Ia = Vw ? window.matchMedia("(prefers-color-scheme: dark)") : void 0;
function _f(e) {
...
function _h(e) {
                  ...
                  for (;;)
                    switch (($.prev = $.next)) {
                      case 0:
                        return (($.next = 2), R());
                      case 2:
                        ((q = Mw(bt(bt({}, f), {}, { colorMode: d }))), (m.current = q));
                      case 4:
                      case "end":
                        return $.stop();
                    }
  ...
  var I = bt(bt({}, fh(bt(bt({}, f), {}, { colorMode: d }))), {}, S({}, lw, !0));
  return E.createElement(
    hh.Provider,
    { value: !0 },
    E.createElement(
        ...
        E.createElement(
          ...
          E.createElement(
            ...
            !x && de("platform_dst_subtree_theming")
              ? E.createElement("div", ne({}, I, { className: P([Gw.body]) }), t)
              : t,
          ),
        ),
      ),
...
function ya(e, t) {
  return v1(vi("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function b1() {
  return me;
}
function _1() {
  return ((me = Le > 0 ? ke(rn, --Le) : 0), Jr--, me === 10 && ((Jr = 1), fi--), me);
}
function Ve() {
  return ((me = Le < Sh ? ke(rn, Le++) : 0), Jr++, me === 10 && ((Jr = 1), fi++), me);
}
function Ot() {
  return ke(rn, Le);
}
      ...
      default:
        ...
        switch (((x += di(_)), _ * f)) {
          ...
          case 44:
            ...
            break;
          case 64:
            (Ot() === 45 && (x += Ro(Ve())), (p = Ot()), (l = d = mt((m = x += k1(Po())))), _++);
            break;
          case 45:
            g === 45 && mt(x) == 2 && (f = 0);
        }
...
function mf(e, t, r, n, a, o, i, s, c, u, l) {
  for (var d = a - 1, p = a === 0 ? o : [""], v = Tc(p), g = 0, f = 0, h = 0; g < n; ++g)
    for (var b = 0, _ = $a(e, d + 1, (d = f1((f = i[g])))), m = e; b < v; ++b)
      (m = Eh(f > 0 ? p[b] + " " + _ : te(_, /&\f/g, p[b]))) && (c[h++] = m);
  return vi(e, t, r, a === 0 ? Dc : s, c, u, l);
}
function E1(e, t, r) {
  return vi(e, t, r, kh, di(b1()), $a(e, 2, -2), 0);
}
function yf(e, t, r, n) {
...
var R1 = function (t, r, n) {
  ...
  A1 = function (t, r) {
    ...
    do
      switch (za(a)) {
        case 0:
          (a === 38 && Ot() === 12 && (r[n] = 1), (t[n] += R1(Le - 1, r, n)));
          break;
        case 2:
          t[n] += Ro(a);
          break;
...
var Of;
function U1() {
  return (Of || ((Of = 1), (Rs.exports = L1())), Rs.exports);
}
var As, Ef;
function B1() {
  if (Ef) return As;
...
var Fc = function (t, r, n) {
    var a = t.key + "-" + r.name;
    (n === !1 || N1 === !1) && t.registered[a] === void 0 && (t.registered[a] = r.styles);
  },
  Ah = function (t, r, n) {
    Fc(t, r, n);
    var a = t.key + "-" + r.name;
...
var $1 = {
  ...
  Is = P1(function (e) {
    return Ih(e) ? e : e.replace(z1, "-$&").toLowerCase();
  }),
  xf = function (t, r) {
    switch (t) {
      case "animation":
    ...
    return $1[t] !== 1 && !Ih(t) && typeof r == "number" && r !== 0 ? r + "px" : r;
  };
function Va(e, t, r) {
  if (r == null) return "";
  var n = r;
...
var H1 = function (t) {
  ...
  W1 = lu.useInsertionEffect ? lu.useInsertionEffect : !1,
  jh = W1 || H1,
  Dh = y.createContext(typeof HTMLElement < "u" ? F1({ key: "css" }) : null);
Dh.Provider;
var Mh = function (t) {
  ...
  Y1 = Mh(function (e, t, r) {
    ...
    return (
      ...
      y.createElement(
        y.Fragment,
        null,
        y.createElement(J1, { cache: t, serialized: s, isStringTag: typeof a == "string" }),
        y.createElement(a, c),
      )
    );
  }),
...
var Jt = 8,
  ...
  uk = { default: oc.default, compact: oc.compact, none: "inherit" },
  lk = {
            ...
            Me(
              Me(
                Me(
                  Me(
                    Me(
                      Me(Me({}, t === "default" && vk), t === "primary" && pk),
                      t === "link" && hk,
                    ),
                    t === "subtle" && gk,
                  ),
    ...
    return (
      ...
      Lt(
        ...
        Lt(
          ...
          f ? Lt("span", { css: [Be, Af({ spacing: q }), If(u, Pk)] }, f) : null,
          Ak(u, [Be, Ok({ spacing: q })]),
          g ? Lt("span", { css: [Be, Af({ spacing: q }), If(u, Rk)] }, g) : null,
          j ? Lt("span", { css: [Sk, Re] }, j) : null,
        ),
      )
    );
  });
  ...
  Nc = E.memo(
    E.forwardRef(function (t, r) {
      var n = t.appearance,
        ...
        m = i1(),
        k = m.mode,
        w = jk({ children: o, iconBefore: i, iconAfter: s }),
        O = y.useState(!1),
        x = G(O, 2),
        I = x[0],
        R = x[1],
...
function zk(e, t) {
  var r = e.components,
    ...
    K = function (B, V, ae) {
      ...
      return E.createElement(
        xo,
        { as: "li", xcss: ic.paginationMenuItem, key: "page-".concat(O ? O(B, V) : V) },
        E.createElement(
          Mk,
          {
            component: n.Page,
  ...
  return E.createElement(
    ...
    E.createElement(
      ...
      E.createElement(
        ...
        Nk(w, W, { max: _, ellipsis: I, transform: K }, C),
      ),
      E.createElement(Df, {
        key: "right-navigator",
        component: n.Next,
    ...
    return y.createElement(
      ...
      ne({ "aria-sort": v(), onClick: void 0, ref: t, "data-testid": c }, u, {
        ...
        style: wa(
          wa({}, l),
          {},
          { "--_17ckjys": Tp("var(--ds-text-subtle, ".concat("var(".concat(Bf, ")"), ")")) },
        ),
      }),
      n,
    );
...
var Ca = { none: 0, small: 100, medium: 350, large: 700 },
  Ds = 0.5,
  dO = { none: Ca.none, small: Ca.small * Ds, medium: Ca.medium * Ds, large: Ca.large * Ds },
  fO = function () {
...
function eo(e) {
  for (var t = Ge(e), r = Wf(e); r && GO(r) && zt(r).position === "static"; ) r = Wf(r);
...
function Kf(e) {
  ...
  var j = Object.assign({ position: s }, u && ZO),
    L = l === !0 ? QO({ x: v, y: f }, Ge(r)) : { x: v, y: f };
  if (((v = L.x), (f = L.y), c)) {
    var q;
...
function Yf(e, t, r) {
  return t === Gh ? cc(iE(e, r)) : gr(t) ? cE(t, r) : cc(sE(er(e)));
}
function uE(e) {
  var t = Da(pi(e)),
...
function Ha(e, t) {
  ...
  var r = t,
    ...
    m = e.rects.popper,
    k = e.elements[g ? _ : p],
    w = lE(gr(k) ? k : k.contextElement || er(e.elements.popper), c, l, i),
  ...
  if (!t.modifiersData[n]._skip) {
    for (
      ...
      var j = k[C],
        ...
        W = [Te, nt].indexOf(L) >= 0,
        $ = W ? "width" : "height",
        H = Ha(t, { placement: j, boundary: l, rootBoundary: d, altBoundary: p, padding: u }),
        K = W ? (q ? at : Fe) : q ? nt : Te;
      w[$] > O[$] && (K = Io(K));
      var U = Io(K),
        B = [];
  ...
  if (O) {
    if (o) {
      var q,
        ...
        vt = K + Re - Pr - cn,
        Ae = K + pe - Pr,
        pt = ja(v ? Vo(U, vt) : U, K, v ? vr(B, Ae) : B);
      ((O[k] = pt), (L[k] = pt - K));
    }
    if (s) {
      var Gt,
        ...
        uo = v && gt ? WO(so, qe, co) : ja(v ? so : Ce, qe, v ? co : je);
      ((O[w] = uo), (L[w] = uo - qe));
    }
    t.modifiersData[n] = L;
  }
      ...
      v = {
        ...
        forceUpdate: function () {
          if (!p) {
            ...
            if (ev(_, m)) {
              ((l.rects = {
                reference: PE(_, eo(m), l.options.strategy === "fixed"),
                popper: zc(m),
              }),
                (l.reset = !1),
...
function JE(e) {
  ...
  return E.createElement(VE, { modifiers: _, placement: i, strategy: d, referenceElement: c }, r);
}
...
function mS(e) {
  var t = e.children,
    ...
    ie = ae ? o : n,
    ue = id($r({ fn: b, action: "displayed", analyticsData: R }, lv)),
    we = id($r({ fn: m, action: "hidden", analyticsData: R }, lv)),
    T = y.useRef(null),
    ye = y.useState("hide"),
    Be = G(ye, 2),
    ve = Be[0],
  ...
  (iO({ onClose: so, isDisabled: ve === "hide" || ve === "fade-out" }),
    y.useEffect(
      function () {
          ...
          var oe = ae
            ? {
                ...
                mouse: de("platform_dst_nav4_side_nav_resize_tooltip_feedback")
                  ? void 0
                  : cv({ left: F.clientX, top: F.clientY }),
                clientX: F.clientX,
                clientY: F.clientY,
              }
            : { type: "keyboard" };
      ...
      ? function (F) {
          ...
          (oe = T.current) !== null &&
            ...
            (de("platform_dst_nav4_side_nav_resize_tooltip_feedback") ||
              (T.current.mousePosition = cv({ left: F.clientX, top: F.clientY })),
  ...
  var ou = function () {
      ...
      if (
        ...
        return hS(T.current.mousePos, { targetElement: pe.current, tooltipPosition: n });
      if (
        ae &&
        (Dt = T.current) !== null &&
        Dt !== void 0 &&
  ...
  var su = nu
      ...
      : null,
    bb = V && de("platform_dst_nav4_side_nav_resize_tooltip_feedback") ? y.Fragment : yS;
  return E.createElement(
    E.Fragment,
    null,
    typeof t == "function"
    ...
    Ii
      ? E.createElement(
          bb,
          null,
          E.createElement(JE, { placement: ie, referenceElement: ou(), strategy: j }, function (F) {
            var oe = F.ref,
              Dt = F.style,
              nr = F.update,
              Di = F.placement,
              Rr = ae ? void 0 : bS[_S(Di)];
            return E.createElement(
              Vh,
              { appear: !0 },
              au &&
...
var yS = function (t) {
  ...
  ug = function (t) {
    ...
    var o = t.innerRef,
      ...
      B = E.createElement(
        ci,
        { xcss: dv.headCellContainer, onMouseEnter: K, onMouseLeave: U, onFocus: $, onBlur: H },
        E.createElement(
          mS,
          { content: s === hr ? p : g },
          E.createElement(
            ...
            W &&
              E.createElement(
                $o,
                { xcss: L ? Sa.sortIconVisibleWrapper : Sa.sortIconHiddenWrapper },
                s === hr
                  ? E.createElement(aO, {
                      label: "",
                      color: "var(--ds-text-subtle, #505258)",
...
var ES = (function (e) {
    function t() {
      return (he(this, t), OS(this, t, arguments));
    }
    return (
      We(t, e),
      ge(t, [
...
var RS = (function (e) {
    function t(r) {
      var n;
      return (he(this, t), (n = PS(this, t, [r])), (n.state = { activeSortButtonId: null }), n);
    }
    return (
      We(t, e),
      ge(t, [
...
var jS = function (t) {
    ...
    var ve = function (Ce) {
      ...
      cn = function () {
        return U || (Ip(o || [], I, _).length > 2 ? qo : ym);
      },
      Pr = function () {
        return g ? E.createElement(xm, { testId: l }) : R && E.createElement(Cm, { testId: l }, R);
      },
      vt = o && o.length,
      Ae,
      pt = !1;
    ...
    return E.createElement(
      ...
      !ot &&
        qe &&
        E.createElement($p, { isLoading: g, spinnerSize: qo, testId: l, loadingLabel: c }, qe),
    );
  },
  DS = y.lazy(function () {
    return Xe(
      () => import("./body-CtFNti4B.js"),
  ...
  MS = y.forwardRef(function (t, r) {
    ...
    var f = E.createElement($m, ne({ ref: r }, u));
    return l && v
      ? E.createElement(
          Vm,
          { fallback: f },
...
function Zt(e) {
  ...
  return typeof r == "function" && r.toString() === BS;
}
function _g(e) {
  var t = e?.constructor;
...
function to(e, t, r) {
  (qt(e, kt) || _i(e, kt, _r({}, e[kt])), QS(r) || (e[kt][t] = r));
}
function WS(e) {
...
function Og(e, t, r) {
  ...
  var n = new tr(e);
  return (t !== Vr && aC(n, t), r !== Vr && Vg(n, r), n);
}
function KS(e, t) {
  return rb(e, t);
}
...
var Ho = { structural: KS, default: JS };
function mr(e, t, r) {
  return Kg(e)
    ? e
    : Array.isArray(e)
...
function Eg(e, t, r, n, a) {
  var o, i, s, c, u, l, d;
  (a === void 0 && (a = A.safeDescriptors), nx(e, t, r, n));
  var p = n.value;
...
function xg(e, t, r, n, a, o) {
  (o === void 0 && (o = A.safeDescriptors), sx(e, t, r, n));
  var i = n.value;
  if ((Ja(i) || (i = tn(i)), a)) {
    var s;
...
var fc = wi(wx),
  Sx = wi(kx, { enhancer: yi }),
  xx = wi(Ox, { enhancer: YS }),
  Cx = wi(Ex, { enhancer: XS }),
  Rg = xt(fc);
function Eo(e) {
  return e.deep === !0 ? mr : e.deep === !1 ? yi : Rx(e.defaultDecorator);
}
function Px(e) {
  var t;
...
var Ax = {
    ...
    array: function (t, r) {
      var n = Oo(r);
      return (A.useProxies === !1 || n.proxy === !1 ? PC : _C)(t, Eo(n), n.name);
    },
    map: function (t, r) {
      var n = Oo(r);
    ...
    object: function (t, r, n) {
      return Cr(function () {
        return cC(A.useProxies === !1 || n?.proxy === !1 ? on({}, n) : hC({}, n), t, r);
      });
    },
    ref: xt(Sx),
    shallow: xt(xx),
...
function jg(e, t, r) {
  ...
  return (A.inBatch--, (A.trackingDerivation = a), Bx(e), Fa(n), o);
}
function Bx(e) {
  for (
    var t = e.observing_,
...
function Nx() {
  if (((A.pendingReactions.length || A.inBatch || A.isRunningReactions) && Y(36), (Tg = !0), Mo)) {
    var e = hi();
    (--e.__mobxInstanceCount === 0 && (e.__mobxGlobals = void 0), (A = new Do()));
  }
}
function qx(e, t) {
  (e.observers_.add(t),
...
function Ug(e) {
  ...
  return t !== null
    ? (t.runId_ !== e.lastAccessedBy_ &&
      ...
      e.isBeingObserved)
    : (e.observers_.size === 0 && A.inBatch > 0 && Lg(e), !1);
}
function Bg(e) {
...
var At = (function () {
  ...
  return (
    ...
    (t.schedule_ = function () {
      this.isScheduled || ((this.isScheduled = !0), A.pendingReactions.push(this), Ng());
    }),
    (t.runReaction_ = function () {
      if (!this.isDisposed) {
        (et(), (this.isScheduled = !1));
        var n = A.trackingContext;
        if (((A.trackingContext = this), pc(this))) {
...
function Ng() {
  A.inBatch > 0 || A.isRunningReactions || gc(Gx);
}
function Gx() {
...
function sC(e) {
  ...
  var t = e.useProxies,
    r = e.enforceActions;
  if (
    (t !== void 0 && (A.useProxies = t === So ? !0 : t === oC ? !1 : typeof Proxy < "u"),
    t === "ifavailable" && (A.verifyProxies = !0),
    r !== void 0)
  ) {
    var n = r === So ? So : r === iC;
    ((A.enforceActions = n), (A.allowStateChanges = !(n === !0 || n === So)));
  }
  ([
...
function Hg(e) {
  var t = { name: e.name_ };
  return (
    e.observing_ && e.observing_.length > 0 && (t.dependencies = lC(e.observing_).map(Hg)),
    t
  );
}
function lC(e) {
...
var mC = Er("ObservableArrayAdministration", Zc);
function Ci(e) {
  return bi(e) && mC(e[z]);
}
var yC = {},
    ...
    return (
      ...
      (t.replace = function (n) {
        ...
        return (
          Bt(function () {
            for (
              var o = wC(n), i = new Map(), s = !1, c = Gr(a.data_.keys()), u;
              !(u = c()).done;
            ) {
              var l = u.value;
              if (!o.has(l)) {
...
function on(e, t) {
  ...
  var n = (r = t?.name) != null ? r : "ObservableObject",
    a = new Zg(e, new Map(), String(n), Px(t));
  return (_i(e, z, a), e);
}
var OC = Er("ObservableObjectAdministration", Zg);
function kv(e) {
  return (
    yv[e] ||
    (yv[e] = {
    ...
    return (
      ...
      Cr(function () {
        ...
        ((c.proxy_ = s),
          ...
          SC && Object.defineProperty(s, "0", EC));
      }),
      s
    );
  }
...
var xv,
  AC = ((xv = hi().Iterator) == null ? void 0 : xv.prototype) || {};
function eu(e) {
...
typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ == "object" &&
  __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: Wx, extras: { getDebugName: mc }, $mobx: z });
...
var Pv;
function NC() {
  return (Pv || ((Pv = 1), (Us.exports = BC())), Us.exports);
}
var qC = NC();
function Rv(e) {
...
function XC(e) {
  var t = e.bind(this),
    r = wc(this);
  function n() {
    r.reaction || ((r.reaction = ZC(r)), r.mounted || Ya.register(this, r, this));
    var a = void 0,
      o = void 0;
    if (
...
var sP = Object.defineProperty,
  ...
  sb = (e, t, r, n) => {
    for (var a = n > 1 ? void 0 : n ? cP(t, r) : t, o = e.length - 1, i; o >= 0; o--)
      (i = e[o]) && (a = (n ? i(t, r, a) : i(a)) || a);
    return (n && a && sP(t, r, a), a);
  };
class tu {
  constructor() {
...
class lP {
  constructor() {
    ((this.usersStore = nP), (this.usersMetadata = iP), (this.stateStore = uP));
  }
}
const cb = new lP(),
  dP = y.createContext(cb),
  Ai = () => y.useContext(dP),
  fP = Ri(() => {
...
const gP = Ri(hP),
  ...
  _P = mb.createRoot(bP),
  Nv = () => {
    _P.render(N.jsx(ib, { ...cb, children: N.jsx(gP, {}) }));
  };
Nt.view.theme
  .enable()
  .then(() => {
